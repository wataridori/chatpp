...
function utf8_encode(b) {
    ...
    for (var f = b.length, g = 0; g < f; g++) {
        var i = b.charCodeAt(g),
            j = null;
        i < 128 ? d++ : j = i > 127 && i < 2048 ? String.fromCharCode(i >> 6 | 192) + String.fromCharCode(i & 63 | 128) : String.fromCharCode(i >> 12 | 224) + String.fromCharCode(i >> 6 & 63 | 128) + String.fromCharCode(i & 63 | 128);
        j !== null && (d > e && (a += b.slice(e, d)), a += j, e = d = g + 1)
    }
    d > e && (a += b.slice(e, f));
    return a
}
...
(function(b) {
    ...
    function e(b, f, d, e, g, i) {
        b = a(a(f, b), a(e, i));
        return a(b << g | b >>> 32 - g, d)
    }

    function d(a, b, f, d, g, i, h) {
        return e(b & f | ~b & d, a, b, g, i, h)
    }

    function f(a, b, f, d, g, i, h) {
        return e(b & d | f & ~d, a, b, g, i, h)
    }

    function g(a, b, f, d, g, i, h) {
        return e(f ^ (b | ~d), a, b, g, i, h)
    }

    function i(b, i) {
        b[i >> 5] |= 128 << i % 32;
        b[(i + 64 >>> 9 << 4) + 14] = i;
        var n, h, j, o, l, r = 1732584193,
            p = -271733879,
            s = -1732584194,
            v = 271733878;
        for (n = 0; n < b.length; n += 16) h = r, j = p, o = s, l = v, r = d(r,
            p, s, v, b[n], 7, -680876936), v = d(v, r, p, s, b[n + 1], 12, -389564586), s = d(s, v, r, p, b[n + 2], 17, 606105819), p = d(p, s, v, r, b[n + 3], 22, -1044525330), r = d(r, p, s, v, b[n + 4], 7, -176418897), v = d(v, r, p, s, b[n + 5], 12, 1200080426), s = d(s, v, r, p, b[n + 6], 17, -1473231341), p = d(p, s, v, r, b[n + 7], 22, -45705983), r = d(r, p, s, v, b[n + 8], 7, 1770035416), v = d(v, r, p, s, b[n + 9], 12, -1958414417), s = d(s, v, r, p, b[n + 10], 17, -42063), p = d(p, s, v, r, b[n + 11], 22, -1990404162), r = d(r, p, s, v, b[n + 12], 7, 1804603682), v = d(v, r, p, s, b[n + 13], 12, -40341101), s = d(s, v, r, p, b[n + 14], 17, -1502002290),
            p = d(p, s, v, r, b[n + 15], 22, 1236535329), r = f(r, p, s, v, b[n + 1], 5, -165796510), v = f(v, r, p, s, b[n + 6], 9, -1069501632), s = f(s, v, r, p, b[n + 11], 14, 643717713), p = f(p, s, v, r, b[n], 20, -373897302), r = f(r, p, s, v, b[n + 5], 5, -701558691), v = f(v, r, p, s, b[n + 10], 9, 38016083), s = f(s, v, r, p, b[n + 15], 14, -660478335), p = f(p, s, v, r, b[n + 4], 20, -405537848), r = f(r, p, s, v, b[n + 9], 5, 568446438), v = f(v, r, p, s, b[n + 14], 9, -1019803690), s = f(s, v, r, p, b[n + 3], 14, -187363961), p = f(p, s, v, r, b[n + 8], 20, 1163531501), r = f(r, p, s, v, b[n + 13], 5, -1444681467), v = f(v, r, p, s, b[n + 2], 9, -51403784),
            s = f(s, v, r, p, b[n + 7], 14, 1735328473), p = f(p, s, v, r, b[n + 12], 20, -1926607734), r = e(p ^ s ^ v, r, p, b[n + 5], 4, -378558), v = e(r ^ p ^ s, v, r, b[n + 8], 11, -2022574463), s = e(v ^ r ^ p, s, v, b[n + 11], 16, 1839030562), p = e(s ^ v ^ r, p, s, b[n + 14], 23, -35309556), r = e(p ^ s ^ v, r, p, b[n + 1], 4, -1530992060), v = e(r ^ p ^ s, v, r, b[n + 4], 11, 1272893353), s = e(v ^ r ^ p, s, v, b[n + 7], 16, -155497632), p = e(s ^ v ^ r, p, s, b[n + 10], 23, -1094730640), r = e(p ^ s ^ v, r, p, b[n + 13], 4, 681279174), v = e(r ^ p ^ s, v, r, b[n], 11, -358537222), s = e(v ^ r ^ p, s, v, b[n + 3], 16, -722521979), p = e(s ^ v ^ r, p, s, b[n + 6], 23, 76029189), r = e(p ^
            s ^ v, r, p, b[n + 9], 4, -640364487), v = e(r ^ p ^ s, v, r, b[n + 12], 11, -421815835), s = e(v ^ r ^ p, s, v, b[n + 15], 16, 530742520), p = e(s ^ v ^ r, p, s, b[n + 2], 23, -995338651), r = g(r, p, s, v, b[n], 6, -198630844), v = g(v, r, p, s, b[n + 7], 10, 1126891415), s = g(s, v, r, p, b[n + 14], 15, -1416354905), p = g(p, s, v, r, b[n + 5], 21, -57434055), r = g(r, p, s, v, b[n + 12], 6, 1700485571), v = g(v, r, p, s, b[n + 3], 10, -1894986606), s = g(s, v, r, p, b[n + 10], 15, -1051523), p = g(p, s, v, r, b[n + 1], 21, -2054922799), r = g(r, p, s, v, b[n + 8], 6, 1873313359), v = g(v, r, p, s, b[n + 15], 10, -30611744), s = g(s, v, r, p, b[n + 6], 15, -1560198380),
            p = g(p, s, v, r, b[n + 13], 21, 1309151649), r = g(r, p, s, v, b[n + 4], 6, -145523070), v = g(v, r, p, s, b[n + 11], 10, -1120210379), s = g(s, v, r, p, b[n + 2], 15, 718787259), p = g(p, s, v, r, b[n + 9], 21, -343485551), r = a(r, h), p = a(p, j), s = a(s, o), v = a(v, l);
        return [r, p, s, v]
    }
    ...
    function l(a, b) {
        var f = unescape(encodeURIComponent(a)),
            ...
            h = [];
        g[15] = h[15] = void 0;
        e.length > 16 && (e = i(e, f.length * 8));
        for (f = 0; f < 16; f += 1) g[f] = e[f] ^ 909522486, h[f] = e[f] ^ 1549556828;
        d = i(g.concat(k(d)), 512 + d.length * 8);
        return j(i(h.concat(d), 640))
    }

    function o(a, b, f) {
        if (!b) {
            if (!f) return m(h(unescape(encodeURIComponent(a))));
...
function ChatWork(b) {
        ...
        if (a.isLogin() && (d = f == void 0 ? RM : RL.rooms[f]) && d.read_lock != !0) {
            ...
            if (e > 0) {
                var g = RL.rooms[d.id],
                    h = g.getViewStat();
                g.reading = !0;
                i[d.id] = setTimeout(function() {
                    RM && RM.id == g.id ? h = RM.getViewStat() : e = g.getUnreadNum();
                    e > h.noview_num && CW.get("gateway.php", {
                            cmd: "read",
                            room_id: g.id,
                            mid: g.mid,
                            last_chat_id: h.last_read_id
                        },
                        function(a) {
                            if (a.read_num) {
                                var b = g.getUnreadNum();
                                g.read_num = a.read_num;
    ...
    a.watch = function(b) {
        if (!h && (h = setTimeout(function() {
            ...
            if (a.last_id == 0) {
                        ...
                        switch (g) {
                                    ...
                                    if (i[h].cd)
                                        for (var n in i[h].cd)
                                            if (RL.rooms[h].timeline &&
                                                (RL.rooms[h].timeline.deleteChat(n), RL.setUpdate(!0)), RM && h == RM.id) e.RM = !0;
                                    if (i[h].ce)
                                        for (n in i[h].ce)
                                            if (!i[h].cd || !i[h].cd[n])
                                                if (RL.rooms[h].timeline && (RL.rooms[h].timeline.refreshChat(n), RL.setUpdate(!0)), RM && h == RM.id) e.RM = !0;
                                    if (i[h].fe)
                                        for (var j in i[h].fe)(!i[h].fd || !i[h].fd[j]) && FL.refreshFile(j);
                                    if (i[h].fd)
                                        for (j in i[h].fd)
                                            if (FL.deleteFileStat(j), RM && h == RM.id) e.RM = !0;
                                    if (i[h].tc) {
                                        for (var o in i[h].tc)(!i[h].td || !i[h].td[o]) && TK.checkTask(o, i[h].tc[o], !0);
                                        TK.reflashTaskList(h)
                                    }
                                    if (i[h].te)
                                        for (o in i[h].te)(!i[h].td ||
                                        !i[h].td[o]) && TK.refreshTask(o);
                                    if (i[h].td) {
                                        for (o in i[h].td) TK.deleteTaskStat(o);
                                        TK.reflashTaskList(h)
                                    }
                                    if (i[h].s != void 0) RL.rooms[h].sticky = i[h].s, RL.setUpdate(!0);
                                    i[h].lvc != void 0 && CW.openLiveNotification(i[h].lvc, h);
                            ...
                            case "account":
                                if (i.a) {
                                    var l = [],
                                        q;
                                    for (q in i.a) l.push(parseInt(q, 10));
                                    AC.refreshAccount(l, !0)
                                }
                                i.s && ST.getSetting();
                                if (i.r)
                                    for (h in l = i.r, AC.account_dat[l] && AC.refreshContactList(), RL.rooms) RL.rooms[h].member_dat[l] && RL.setMemberUpdate(h);
                                i.n && ST.getAnnounce();
                                break;
                            case "contact":
                                ...
                                if (i.m) {
                                    l = [];
                                    for (q in i.m) l.push(parseInt(q, 10));
                                    AC.refreshMentionInfo(l)
                                }
                                i.a && i.a.length > 0 && AC.client_addContact(i.a);
                ...
                f.update != void 0 && (k || (d = f.update.replace("a", ""),
                f.update.indexOf("a") == -1 && a.view.alertUpdated(d), a.view.showUpdated(d)), k = !0)
            });
            a.watching = !1
        }
    };
                ...
                if (CW.isLogin()) {
                    ...
                    if (typeof b.success != "function") b.success = function() {
                        ...
                        b.success = function(f) {
                            if (f && f.status.success == !0) a.ajax_lasttime = microtime(!0),
                                g(f.result);
                            else {
                                var d = "";
        ...
        if (m === !1) {
            ...
            setTimeout(function() {
                a.request.checkOnline(function() {
                    ...
                    a == "NO LOGIN" || a == "INVALID USER" || a == "NO TOKEN" || a == "INVALID TOKEN" || a == "BAD LOGIN INFO" || a == "UUID ERROR" || a == "IP ERROR" || a == "LOCK" ? CW.view.showLoginDialog(d, e, a) : a == "OFFLINE" ? CW.view.showOfflineDialog(d, e) : a == "TIMEOUT" ? CW.view.showTimeoutDialog(d, e) : e()
                })
            }, 1E3)
        }
    };
    ...
    a.getCoverPanel = function(b, f) {
        ...
        if (b) {
            if (f == void 0) f = d;
                ...
                for (var e in d) f[e] == void 0 && (f[e] = d[e]);
    ...
    a.getSkypeLink = function(b, f) {
        return a.view.getSkypeLink(b, f)
    };
    ...
    a.getFilePanel = function(b, f) {
        if (f == void 0) f = x;
            ...
            for (var d in x) f[d] == void 0 && (f[d] = x[d]);
    ...
    a.getTaskPanel = function(b, f) {
        ...
        return a.view.getTaskPanel(TK.task_id2task_dat[b] == void 0 ?
            !1 : TK.task_id2task_dat[b], f)
    };
...
function Account(b) {
    ...
    a.setRequestMessage = function(b, d) {
        a.setParam(b, "requestMessage", d)
    };
    a.setDeleted =
        function(b, d) {
            a.setParam(b, "is_deleted", d)
        };
    ...
    a.getCoverId = function(b) {
        var d = ["block_pattern", "check_blue", "flower_blue", "flower_pink", "leaf", "light", "mizutama", "party", "retro", "square", "zebra"],
            e = a.getParam(b, "cv", "0/.");
        e == "0/." && (e = a.isDeleted(b) ? "not_found.jpg" : d[b % d.length] +
        ".jpg");
        return e
    };
    ...
    a.client_addContact = function(b) {
    ...
    a.getRequestMessage = function(b) {
        return a.getParam(b, "requestMessage", null)
    };
    a.isDeleted = function(b) {
        var d = a.getParam(b, "is_deleted", null);
        return d !== null ? d : (b = a.getParam(b, "nm", !1) == "" ? !0 : !1, b)
    };
    ...
    a.getUnknown = function(b) {
        var e = [],
            i;
        for (i in a.unknown_flag) a.isUnknown(i) ? d[i] == void 0 && (e.push(parseInt(i, 10)), d[i] = !0) : delete a.unknown_flag[i];
    ...
    a.refreshAccount = function(b, d, e) {
        if (b.length > 0) {
            var d = d ? 1 : 0,
                ...
                h = function(m) {
                    var l = m.splice(0, 5E3);
                    CW.post("gateway.php", {
                        cmd: "get_account_info",
                        aid: l,
                        get_private_data: d
                    }, function(d) {
                        for (var g in d.account_dat) a.setAccountDat(g, d.account_dat[g]), j[g] = d.account_dat[g];
                        if (m.length) return h(m);
                        a.unknown_flag = {};
    ...
    (function() {
        var b = {},
            d = {
                ...
                mtel: a.setMobileTel,
                ud: a.setUndisclosed,
                mg: a.setRequestMessage,
                is_deleted: a.setDeleted
            };
        a.setAccountDat = function(e, j, k) {
            var h = "",
                m;
            for (m in d) j[m] != void 0 && (d[m](e, j[m]), h = m + "_priv", j[h] != void 0 && a.setParam(e, h, j[h]));
            b[e] = k ? !0 : !1
        };
    ...
    a.updateContactList = function(b, d, e, j) {
        for (var k = {}, h = {}, m = [], l = 0; l < a.contact_list.length; l++) k[a.contact_list[l]] = !0, h[a.contact_list[l]] = !0;
        a.contact_list = [];
        a.contact_flag = {};
        a.setName(0, "ChatWork");
        for (var o in a.account_dat) a.setRoomId(o, 0);
        for (o in b) o = parseInt(o, 10), a.contact_flag[o] = !0, CW.registerAvatar(o), a.contact_list.push(o), a.setAccountDat(o, b[o]), delete k[o], h[o] || m.push(o);
        m && (a.view.updateAvatar(m), a.view.updateName(m));
        for (o in d) a.setNickName(o, d[o].nn), a.setMentionNum(o, d[o].mn);
        for (o in e) a.setAccountDat(o, e[o]);
        a.myrequest_dat = e;
        d = [];
        for (o in j) a.setAccountDat(o, j[o]), CW.init_loaded && !a.request_dat[o] && d.push(o);
        d && (a.view.updateAvatar(d), a.view.updateName(d));
        if (CW.init_loaded) {
            d = [];
            for (o in a.request_dat) !j[o] && !b[o] && (a.account_dat[o] = void 0, d.push(o));
            for (o in k) a.account_dat[o] = void 0, d.push(o);
...
function Setting() {
    ...
    b.updateSetting = function(a, e) {
        ...
        b.data.notifier_duration == void 0 ? b.data.notifier_duration = 10 : (f = parseInt(b.data.notifier_duration, 10), b.data.notifier_duration = f == 0 || f == 30 ? 20 : f);
        ...
        b.data.notify_term = b.data.notify_term ==
        void 0 ? 1 : parseInt(b.data.notify_term, 10);
        ...
        b.data.show_stepguide = b.data.show_stepguide ==
        void 0 ? 1 : parseInt(b.data.show_stepguide, 10);
...
function RoomList() {
    ...
    b.load = function() {
        var a = [],
            ...
            h = !1,
            m;
        for (m in b.update_flag) RL.rooms[m] && (h = !0, b.update_flag[m].info != void 0 && a.push(m), b.update_flag[m].personal != void 0 && d.push(m), b.update_flag[m].member != void 0 && e.push(m), b.update_flag[m].task != void 0 && (RL.rooms[m].tasklist ? (k[m] = RL.rooms[m].tasklist.getTaskList(), k[m].length == 0 && (k[m] = 1)) : k[m] = 1), b.update_flag[m].desc != void 0 && j.push(m));
        if (RM && b.update_flag[RM.id] != void 0)
            for (var l in b.update_flag[RM.id])
                if (l != "personal") {
                    b.rebuild_room = !0;
                    break
                }
        ...
        if (h) {
            ...
            if (a.length) {
                l = 0;
                for (var o = a.length; l < o; l++) {
                    m = a[l];
                    h[m] = {};
                    if (b.rooms[m]) {
                        var q = b.rooms[m];
                        h[m].c = q.chat_num;
                        h[m].u = q.getUnreadNum();
                        h[m].l = q.timeline ? b.rooms[m].timeline.getLastChatId() : 0;
                        if (q.filelist) {
                            var u = q.filelist.getFileNum();
                            h[m].f = $.isNumeric(u) ? u : q.filelist.getFileList().length;
                            h[m].lf = q.filelist.getLastFileId()
                        }
                    } else h[m].c = 0, h[m].u = 0, h[m].l = 0;
                    h[m].t = b.last_update_time_dat[m] ? b.last_update_time_dat[m] : 0
                }
            }
            CW.post("gateway.php", {
                cmd: "get_room_info",
                ...
                if (a.room_dat)
                    for (var d in a.room_dat)
                        if (a.room_dat.hasOwnProperty(d)) {
                            var e = a.room_dat[d];
                            if (e.chat_list) e.chat_list = e.chat_list.map(function(a) {
                                a.id = parseInt(a.id, 10);
                                return a
                            })
                        }
    ...
    b.updateRoomData = function(a) {
        ...
        for (k in a) {
            ...
            var h = RL.rooms[k],
                m = h.getUnreadNum();
            h.mid = rval.mid;
            if (rval.c != void 0) h.chat_num = parseInt(rval.c,
                10), h.name = "", h.allow_see_member = 1, h.allow_upload_file = 1, h.allow_add_task = 1, h.allow_send_message = 1, h.join_need_accept = 1, h["public"] = 0, h.link_name = "", h.header = "", h.icon = b.preset_typemap[1], h.icon_preset = !0;
            ...
            if (rval.mt != void 0) h.mytask_num = parseInt(rval.mt,
                10);
            ...
            if (rval.ic != void 0) b.preset_typemap[rval.ic] ? (h.icon =
                b.preset_typemap[rval.ic], h.icon_preset = !0) : (h.icon = rval.ic, h.icon_preset = !1);
            ...
            if (rval.m != void 0) {
                for (var l in rval.m) rval.m[l] = b.role_map[rval.m[l]], j[l] = !0;
                h.setMember(rval.m)
            }
            if (rval.mr != void 0)
                for (var o in h.member_request = rval.mr, h.member_request) {
                    var q = h.member_request[o];
                    AC.isUnknown(q.id) && AC.setAccountDat(q.id, q)
                }
            if (rval.tp != void 0) h.type =
                b.room_type_map[rval.tp];
            rval.lt != void 0 && RL.setLastUpdateTime(k, rval.lt);
            !m && m < h.getUnreadNum() && (i = !0);
            if (rval.task_dat) {
                if (!h.tasklist) h.tasklist = new TaskList(h);
                var m = [],
                    u;
                for (u in rval.task_dat) TK.setTask(rval.task_dat[u]), m.push(u);
                if (m.length > 0) TK.buildByTaskId(m), h.tasklist.loaded = !0
            }
            if (rval.file_list) {
                if (!h.filelist) h.filelist = new FileList(h);
                o = 0;
                for (m = rval.file_list.length; o < m; o++) h.filelist.insertFile(rval.file_list[o]);
                h.filelist.setFileNum(rval.file_num);
                FL.myfile_load_flag.loaded && FL.buildAllMyFile()
            }
            if (rval.chat_list &&
                rval.chat_list.length > 0) {
                if (!h.timeline) h.timeline = new TimeLine(h);
                if (CW.enable_popup && !CW.is_first_load) {
                    o = 0;
                    for (m = rval.chat_list; o < m; o++) j[rval.chat_list[o].aid] = !0
                }
                var n = "";
                o = 0;
                for (m = rval.chat_list.length; o < m; o++)
                    if (g = !0, h.timeline.addChat(rval.chat_list[o]), CW.enable_popup && !CW.is_first_load && (q = rval.chat_list[o], e[q.id] == void 0)) {
                        e[q.id] = !0;
                        var x = ST.data.notifier_message == "1" ? CW.renderMessage(q.msg, {
                                text: !0
                            }) : L.notifier_newmessage,
                            n = x.length > 0 && AC.myid != q.aid ? {
                                id: q.id,
                                aid: q.aid,
                                room_id: h.id,
                                msg: x
        ...
        a = function() {
            n && (!ST.data.notifier_onlyto || b.rooms[n.room_id].timeline.chat_id2chat_dat[n.id].mn) && CW.popup(CW.getAvatarPanel(n.aid, {
                src: !0
            }), RL.rooms[n.room_id].getName(), AC.getName(n.aid) + ":" + n.msg, n.room_id);
            !wfocus && g && !d && !CW.is_first_load && ST.data.popup_sound == 1 && audioObjSupport && (d = !0, ST.view.isMultiSound(ST.data.sound_type) ? i ? CW.playSound(ST.data.sound_type) : CW.playSound(ST.data.sound_type + "2") : CW.playSound(ST.data.sound_type), setTimeout(function() {
                d = !1
            }, 1E3));
            if (CW.is_first_load) CW.is_first_load = !1;
            b.build()
        };
        for (l in j) AC.getName(l);
    ...
    b.build = function(a) {
        ...
        if (b.has_update) return b.load();
            ...
            var d = b.getSortedRoomList();
            b.filtered_room_list = [];
            var e = null,
                j = !1,
                k = {};
            if (b.filter_category && !b.category_defaults[b.filter_category])
                for (var j = !0, e = 0, h = b.category_dat[b.filter_category].list.length; e < h; e++) k[b.category_dat[b.filter_category].list[e]] = !0;
            b.unread_room_sum = 0;
            b.mention_room_sum =
                0;
            b.mytask_room_sum = 0;
            ...
            b.mytask_total = 0;
            h = [];
            b.filter_word && (h = CW.splitWithSpace(b.filter_word));
            for (var m = 0; m < d.length; m++)
                if (d[m] != void 0) {
                    var e = b.rooms[d[m]],
                        l = e.getUnreadNum(),
                        o = 0;
                    l > 0 && (b.unread_total += l, b.unread_room_sum++, o = e.getMentionNum(), o > 0 && b.mention_room_sum++);
                    e.mytask_num > 0 && (b.mytask_total += e.mytask_num, b.mytask_room_sum++);
                    if (h.length > 0) {
                        l = e.getName();
                        if (!l) continue;
                        if (e.type == "contact") {
                            if (!AC.isMatchedWithKeyList(h, e.getAccountId())) continue
                        } else if (!CW.isMatchedWithKeyList(h,
                                l)) continue
    ...
    b.showJoinPublicChatDialog = function(a) {
        b.rooms[a] != void 0 ? b.selectRoom(a) :
            CW.get("gateway.php", {
...
(function() {
    Room.prototype = {
        getUnreadNum: function() {
            ...
            if (b > 0 && this.timeline !== null)
                for (var a = this.timeline.chat_list.length, a = b < a ? a - b : 0, e = this.timeline.chat_list.length - 1; e >= a; e--)
                    if (this.timeline.chat_list[e].msg === "[deleted]" && (b--, b <= 0)) break;
            b < 0 && (b = 0);
            return b
        },
        ...
        getJoinLink: function() {
            return this["public"] ?
            "./g/" + (this.link_name != "" ? this.link_name : this.id) : !1
        },
        ...
        load: function(b, a) {
            ...
            if (!this.tasklist.loaded) this.task_num == 0 ? this.tasklist.loaded = !0 : d.task =
                1;
            if (this.description === !1) d.desc = 1;
            var f = this;
            CW.get("gateway.php", d, function(b) {
                var d, j;
                if (b.chat_list) b.chat_list = b.chat_list.map(function(a) {
                    a.id = parseInt(a.id, 10);
                    return a
                });
                if (b.task_dat)
                ...
                if (b.file_list) {
                    d = 0;
                    for (j = b.file_list.length; d < j; d++) f.filelist.insertFile(b.file_list[d])
                }
                ...
                if (b.description !=
                    void 0) f.description = b.description;
        ...
        free: function() {
            for (var b in this) b != "id" && b != "del" && (this[b] && typeof this[b] == "object" && typeof this[b].free ==
            "function" && this[b].free(), delete this[b])
        }
    }
})();
...
TimeLine.prototype = {
    ...
    loadOld: function(b) {
        ...
        CW.get("gateway.php", {
            ...
            d.chat_list.map(function(a) {
                a.id = parseInt(a.id, 10);
                return a
            });
            for (var f = {}, g = 0, i = d.chat_list.length; g < i; g++) a.insertChat(d.chat_list[g]), f[d.chat_list[g].aid] = !0;
...
function ChatSend() {
    ...
    b.convertMessageIdToInt = function(a) {
        return a.map(function(a) {
            a.id = parseInt(a.id, 10);
            return a
        })
    };
    b.sendMessage = function(a, e, d, f, g) {
        var i,
            j;
        d == void 0 && (d = {});
        i = d.read == void 0 || d.read ? 1 : 0;
        j = d.edit_id ? d.edit_id : 0;
        var k = RL.rooms[a],
            d = k.timeline.getLastChatId();
        CW.post("gateway.php", {
            cmd: "send_chat",
            text: e,
            room_id: a,
            ...
            if (d.chat_list) {
                d.chat_list = b.convertMessageIdToInt(d.chat_list);
                for (var e = 0, g = d.chat_list.length; e < g; e++) k.timeline.addChat(d.chat_list[e]), RL.rooms[a].read_num++, RL.rooms[a].chat_num++
            }
            d.storage != void 0 && d.storage_limit != void 0 && FL.updateStorageInfo(d.storage, d.storage_limit, d.storage_limit_time,
                d.is_storage_limit);
            j && CW.watch();
            typeof f == "function" && f(d)
        }, function(a, d) {
            if (d && d.is_storage_limit) CW.showStorageLimitDialog("message");
            else {
                if (d.chat_list) d.chat_list = b.convertMessageIdToInt(d.chat_list);
                typeof g == "function" && g(a, d)
            }
        })
    };
    b.sendChat = function(a, e, d, f, g, i) {
        return b.sendMessage(a, e, f, g, i)
    };
    b.deleteChat = function(a, b, d, f) {
        CW.get("gateway.php", {
            cmd: "delete_chat",
            chat_id: a,
            room_id: b
    ...
    b.sendTask = function(a, b, d, f, g, i) {
    ...
    b.editTask = function(a, b, d, f, g, i) {
    ...
    b.convertToSend = function(a) {
        ...
        return a = a.replace(RegExp("\\[" + L.chatsend_reply + " aid=", "g"), "[rp aid=")
    };
    ...
    b.getDraftMessageKey = function(a) {
        return "draft_message_" + AC.myid + "_" +
            a
    };
...
function RoomSub() {
    ...
    b.addTask = function(a, b, d, f, g, i) {
        d ? d.toString().match(/^[0-9]+$/) || (d = strtotime_format(d, ST.data.dateformat)) : d = 0;
        CW.post("gateway.php", {
            cmd: "add_task",
            task: b,
...
function InviteMailAccountModel() {
    ...
    b.setEmails = function(d) {
        if ($.isArray(d)) a = d;
        else throw new TypeError("Expected Array");
        return b
    };
    b.message = function() {
        return e
    ...
    b.setMessage = function(a) {
        ...
        else throw new TypeError("Expected String");
        return b
    };
    b.parseBulkEmails = function(d) {
        if (typeof d === "string") a = b._parseEmails(d);
        else throw new TypeError("Expected String");
    };
    b.clear = function() {
        a = [];
    ...
    b.validate = function() {
        ...
        d = f === !1 ? L.contact_invite_mail_type_email_addresses : "";
        return f
    };
    b.is_valid = function() {
        return f
    };
    b.validateMessage = function() {
        return d
    };
    b.hasMessage = function() {
        return !!e
    };
    b._parseEmails = function(a) {
        return a.split("\n").filter(function(a) {
            return a.trim() !== ""
        })
    }
...
function ChatWorkView(b) {
    ...
    a.prepareLive = function() {
        ...
        var a = function(a) {
            if (m.data.live_id) var b = CW.getLiveUrlById(m.data.live_id, a);
            else m.data.account_id && (b = CW.getLiveUrl(AC.getRoomId(m.data.account_id), [AC.myid, m.data.account_id], a));
            window.open(b, "cwlive", "menubar=0,toolbar=0,titlebar=0,status=0,scrollbars=0,resizable=1");
            m.close()
        };
        m.$el.on("click", "._joinLiveByVideo", function() {
            a("video")
    ...
    a.prepareHiddenIframe = function() {
        for (var b = [{
            ...
            var g = b[e];
            d += '<iframe id="' +
                g.id + '" name="' + g.name + '" src="" style="display: none"></iframe>'
        }
        setTimeout(function() {
            $("#_hiddenIframe").html(d);
            for (var a = 0, b = o.length; a < b; a++) o[a]();
            o = [];
            l = !0
        }, 3E3);
    ...
    a.openLiveNotification = function(a, b) {
        var d = RL.rooms[b],
            e = d.getAccountId(),
            f = "",
            f = e ? L.live_call_direct.replace(/%%name%%/, AC.getName(e)) : L.live_call_chat.replace(/%%name%%/, AC.getName(e)).replace(/%%chat_name%%/,
                d.getName());
    ...
    a.alert = function(a, b, d) {
        var e = "_alertDialogBody" + q,
            f = $('<div id="_alertDialog' + q + '" class="dialog dialogPadding"><pre id="' + e + '" class="alertDialogBody"></pre></div>');
        $C("body").append(f);
    ...
    a.confirm = function(a, b, d, e) {
        var f = "_confirmDialogBody" + q,
            g = $('<div id="_confirmDialog' + q + '" class="dialog dialogPadding"><pre id="' + f + '" class="confirmDialogBody"></pre></div>');
        $C("body").append(g);
    ...
    a.confirmDelete = function(a, b, d, e, f) {
        var g = "_confirmDialogBody" + q,
            h = $('<div id="_confirmDialog' + q + '" class="dialog dialogPadding"><pre id="' + g + '" class="confirmDialogBody"></pre></div>');
        $C("body").append(h);
        g = $("#" + g);
    ...
    a.changeFavicon = function(a) {
        t != a && (t = a, $("#_favicon").remove(), $("head").append($('<link rel="shortcut icon" id="_favicon" href="' + a + '?1"  type="image/vnd.microsoft.icon" />')))
    };
    ...
    a.renderMessage = function(b, d) {
        ...
        if (h)
            for (g = 0; g < h.length; g++) var p = h[g].match(/\[pname:(\d+)\]/),
                p = p[1],
                n = e.text ? AC.getName(p) : CW.getName(p),
                b = b.replace("[pname:" + p + "]", n);
        if (h = b.match(/\[dtext:\w+\]/g))
            for (g = 0; g < h.length; g++) p = h[g].match(/\[dtext:(\w+)\]/), p = p[1], L.hasOwnProperty(p) && "string" === typeof L[p] && (b = b.replace("[dtext:" + p + "]", L[p]));
        if (h = b.match(/\[picon:\d+\]/g))
            for (g = 0; g < h.length; g++) p = h[g].match(/\[picon:(\d+)\]/), p = p[1], b = b.replace("[picon:" + p + "]", CW.getAvatarPanel(p, {
                size: "tiny"
            }));
        if (h = b.match(/\[date:\d+\]/g))
            for (g = 0; g < h.length; g++) p = h[g].match(/\[date:(\d+)\]/), p = p[1], b = b.replace("[date:" + p + "]", a.model.getDate(p));
        if (h = b.match(/\[task aid=[0-9,]+ st=[^\s]+ lt=-?[0-9]*\]/g))
            for (g = 0; g < h.length; g++) p = h[g].match(/\[task aid=([0-9,]+) st=([^\s]+) lt=(-?[0-9]*)\]/), e.text ? b = b.replace(p[0], "[") : (n = {
                aid: p[1],
                st: p[2],
                lt: parseInt(p[3], 10)
        ...
        if (h = b.match(/\[live id=[^\ ]+ rid=\d+]/g))
            for (g = 0; g <
            h.length; g++)
                if (p = h[g].match(/\[live id=([^\ ]+) rid=(\d+)\]/), e.text) b = b.replace(p[0], "[ChatWork Live]");
                else {
                    var n = "",
                        i = p[1],
                        o = p[2];
                    n += MOBILE === "ipad" ? '<div class="button btnDisable"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>" : RL.rooms[o] ? '<div class="_joinLive button btnSuccess" data-live-id="' + i + '"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>" : '<div class="button btnDisable"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>";
                    b = b.replace(p[0], n)
                }
...
if (h = b.match(/<link_title>https?:\/\/[-_.!~*\'()a-zA-Z0-9;?:\@&=+\$,%#\{\}]+[-_.!~*\'\(\)a-zA-Z0-9;\/?:\@&=+\$,%#\{\}]+<\/link_title>/g))
    for (g = 0; g < h.length; g++) {
        var p = h[g].match(/(<link_title>(https?:\/\/([^\/]+)[-_.!~*\'\(\)a-zA-Z0-9;\/?:\@&=+\$,%#\{\}]+)<\/link_title>)/),
            n = p[1],
            i = p[2],
            l = p[3],
            o = "";
        i.match(/\.([^\.]+)$/);
        p = 70;
        if (i.indexOf("chatwork.com") != -1 || i.indexOf("www.chatwork.com") != -1 || i.indexOf("kcw.kddi.ne.jp") != -1) {
            var j = i.match(/(#!rid(\d+)\-?(\d+)?)$/),
                l = "chatwork.com";
            j ? (o = j[2], o = (j = j[3]) ? '</a> <a class="_messageLink timelineLinkAppend" data-rid="' + o + '" data-mid="' + j + '">' + L.message_link + "</a>" : '</a> <a class="_roomLink timelineLinkAppend" data-rid="' + o + '">' + L.message_open_chat + "</a>") : (j = i.match(/\/g\/([-\w]+)$/)) && (o = '</a> <a class="_groupchatLink timelineLinkAppend" data-linkCode="' + j[1] + '">' + L.message_join_groupchat +
                "</a>")
        }
        if ((l == "secure.mindjet.com" || l == "www.mindjet.com") && i.indexOf("openlink") != -1) p = 40, o = '</a><a class="timelineLinkAppend" href="mj-link:' + i + '">' + L.message_open_mindmanager + "</a>";
        if ((l == "vision.mindjet.com" || l == "connect.mindjet.com") && i.indexOf("/link") != -1) p = 40, o = '</a><a class="timelineLinkAppend" href="mj-connect:' + i + '">' + L.message_open_mindmanager + "</a>";
        l.indexOf(".sharepoint.com") != -1 && (l = "sharepoint.com");
        if (_has_sandbox) {
            var q = j = "",
                r = "";
            switch (l) {
                case "teachme.jp":
                    if (l = i.match(/^https?:\/\/teachme\.jp\/contents\/([0-9]+)/)) j =
                        "teachme", r = l[1];
                    break;
                case "speakerdeck.com":
                    if (l = i.match(/^https?:\/\/speakerdeck\.com\/([^\/]+)\/([^\/]+)$/)) j = "speakerdeck", q = l[1], r = l[2];
                    break;
                case "www.slideshare.net":
                    if (l = i.match(/^https?:\/\/www\.slideshare\.net\/([^\/]+)\/([^\/]+)$/)) j = "slideshare", q = l[1], r = l[2];
                    break;
                case "prezi.com":
                    if (l = i.match(/^https?:\/\/prezi\.com\/([^\/]+)\//)) j = "prezi", r = l[1];
                    break;
                case "www.youtube.com":
                    if (l = i.match(/^https?:\/\/www\.youtube\.com\/watch\?v=([^\/&]+)/)) j = "youtube", r = l[1];
                    break;
                case "youtu.be":
                    if (l =
                            i.match(/^https?:\/\/youtu\.be\/([^\/&]+)/)) j = "youtube", r = l[1];
                    break;
                case "vimeo.com":
                    if (l = i.match(/^https?:\/\/vimeo\.com\/(?:channels\/staffpicks\/)?([^\/]+)/)) j = "vimeo", r = l[1];
                    break;
                case "slides.com":
                    if (l = i.match(/^https?:\/\/slides\.com\/([^\/]+\/[^\/]+)$/)) j = "slid.es", r = l[1];
                    break;
                case "slid.es":
                    if (l = i.match(/^https?:\/\/slid\.es\/([^\/]+\/[^\/]+)$/)) j = "slid.es", r = l[1];
                    break;
                case "corabbit.com":
                    if (l = i.match(/^https:\/\/corabbit\.com\/#\/file\/([^\/]+)$/)) j = "corabbit", r = l[1];
                    break;
                case "docs.google.com":
                    if (l =
                            i.match(/^https:\/\/docs.google\.com\//)) j = "googledocs", r = "-";
                    break;
                case "drive.google.com":
                    if (l = i.match(/^https:\/\/drive.google\.com\//)) j = "googledocs", r = "-";
                    break;
                case "cacoo.com":
                    if (l = i.match(/^https:\/\/cacoo\.com\/diagrams\/([^\/]+)(?:\/edit)?$/)) j = "cacoo", r = l[1];
                    break;
                case "sharepoint.com":
                    if (l = i.match(/^https:\/\/([\w\-\.\/]+?)\?.*(sourcedoc=[\{\}\w\-]+?|guestaccesstoken=[\%\w]+&(?:amp;?)docid=\w+)(?:&|$)/)) j = "sharepoint", r = l[1] + "?" + l[2]
            }
            j && (o = '</a> <a class="_previewLink timelineLinkAppend" data-url="' +
                urlencode(i) + '" data-type="' + j + '" data-user-id="' + q + '" data-content-id="' + r + '">' + L.preview + "</a>")
        }
        e.trimLink && (i = trim_width(i, 0, p));
        b = b.replace(n, i + o)
    }
if (!e.text && f.length) var v = $("<div></div>"),
    b = b.replace(/\[code\]\[\/code\]/gi, function() {
        return '<code class="chatCode">' + v.text(f.shift()).html() + "</code>"
    });
...
a.getCoverPanel = function(a, b) {
    ...
    return '<img class="' +
        e + " _coverAid" + a + '" data-aid="' + a + '" src="' + d + '">'
};
...
a.getFullName = function(a) {
    return '<span class="cw_fnm' + a + '">' + escape_html(AC.getFullName(a)) +
        "</span>"
};
...
a.showContactLimitErrorDialog = function() {
    var b = L.contact_error_cantadd,
        ...
        d = d.replace(/%%plan_name%%/, PLAN_NAME).replace(/%%limit_num%%/,
            CW.contact_limit_num);
...
a.prepareStorageLimitDialog = function() {
    j = $("#_storageLimitDialog").cwDialog({
        width: 550,
        buttonLabels: [L.button_close],
        buttonCancel: 0,
        open: function(b) {
...
a.endInitLoad = function() {
    w = !0;
    for (var a = 0, b = r.length; a < b; a++) r[a]();
    r = []
};
a.buildLayout = function() {
...
var p = $("#_globalHeader").outerHeight(!0),
    s = parseInt($("#_content").css("margin-top"), 10),
    v = $C("#_mainContent").outerHeight(!0) - $C("#_mainContent").innerHeight(),
    ...
    F = $("#_chatFilterMenu").outerHeight(!0),
...
a.resizeLayout = function() {
    ...
    d < 540 ? ($C("#_search").removeClass("inputLong"), $C("#_adminNavi").hide(), $C("#_myStatusButton").addClass("headerNameShort"), $C("#_myStatusName").hide(), $C("#_logo").hide(), $C("#_headerSearch").addClass("headerSearchShort")) : (d < 730 ? ($C("#_search").removeClass("inputLong"), $C("#_adminNavi").hide(), $C("#_myStatusButton").addClass("headerNameShort"), $C("#_myStatusName").hide()) : d < 912 ? ($C("#_search").removeClass("inputLong"),
        $C("#_adminNavi").show(), $C("#_myStatusButton").addClass("headerNameShort"), $C("#_myStatusName").hide()) : (d < 1124 ? $C("#_search").removeClass("inputLong") : $C("#_search").addClass("inputLong"), $C("#_adminNavi").show(), $C("#_myStatusButton").removeClass("headerNameShort"), $C("#_myStatusName").show()), $C("#_logo").show(), $C("#_headerSearch").removeClass("headerSearchShort"));
        ...
        open: function(d, e, f, g) {
            if (d) {
                var h = {
                    ...
                    p = "",
                    i = TM.dialog_header_height + TM.dialog_footer_height,
                    n = !0,
                    l = !1,
                    o = !1,
                    j = "auto",
                ...
                switch (d) {
                    case "teachme":
                        l = !0;
                        p = "//teachme.jp/contents/" + g + "/embed?mb=0";
                        h.title = "Teachme";
                        break;
                    case "speakerdeck":
                        o =
                        ...
                        I = $.ajax({
                            ...
                            success: function(a) {
                                $("#_previewLinkContent").html(q(a, B, s))
                            },
                            error: function() {
                    ...
                    case "slideshare":
                        o = l = !0;
                        p = "//www.slideshare.net/slideshow/embed_code/%%slideshow_id%%";
                        h.title = "slideshare";
                        I = $.jsonp({
                            ...
                            success: function(a) {
                                $("#_previewLinkContent").html(q(p.replace("%%slideshow_id%%", a.slideshow_id), B, s))
                            },
                            error: function() {
                                $("#_previewLinkContent").html(L.raise_error)
                            }
                    ...
                    case "prezi":
                        l = !0;
                        n = !1;
                        p = "//prezi.com/embed/" + g + "/?bgcolor=ffffff&amp;lock_to_path=0&amp;autoplay=0&amp;autohide_ctrls=0&amp;features=undefined&amp;disabled_features=undefined";
                        h.title = "Prezi";
                        break;
                    case "youtube":
                        l = !0;
                        n = !1;
                        p = "//www.youtube.com/embed/" + g + "";
                        h.title = "YouTube";
                        break;
                    case "vimeo":
                        l = !0;
                        n = !1;
                        p = "//player.vimeo.com/video/" + g + "";
                        h.title = "vimeo";
                        break;
                    case "slid.es":
                        l = !0;
                        ...
                        break;
                    case "corabbit":
                        p = "//corabbit.com/embed/" + g;
                        h.title = "Corabbit";
                        break;
                    case "googledocs":
                        n = !1;
                        p = e.replace(/(\/file\/.+)\/(edit|view)$/, "$1/preview");
                    ...
                    case "cacoo":
                        p = function() {
                            var a = g.split("#"),
                                b = a.shift(),
                                a = a.shift();
                            return "//cacoo.com/diagrams/" + b + "/view?w=" + (B - 2) + "&h=" + (s - 30) + (a ? "#" + a : "")
                        };
                        j = "no";
                        h.title = "Cacoo";
                        break;
                    case "sharepoint":
                        p = "https://" + g + "&action=interactivepreview&wdSmallView=1";
                        h.title = "Office 365";
                        break;
                    case "chatworkFilePreview":
                        ...
                        var r = a.filePreview.getPreviewType(g.split(".").pop()),
                            v = function(a, b, d) {
                                ...
                                $(window).on("message.previewLinkContent", function(b) {
                                    if (b.originalEvent.origin === "https://d2cxqj2w0ktore.cloudfront.net") {
                                        ...
                                        f.type === "fixWindowSize" && (b = Math.min(f.width + TM.preview_dialog_width_padding, h.width), f = Math.min(f.height + TM.preview_dialog_height_padding + 82, h.height), H.setOption({
                                            width: b,
                                            height: f
                                        }), H.open(), a.attr({
                                            width: b,
                        ...
                        if (r === "iframe") p = e;
                        else if (r === "source") o = !0, I = $.ajax({
                            type: "GET",
                            url: e,
                            dataType: "text",
                            success: function(a) {
                                n = !1;
                                $("#_previewLinkContent").html(q("https://d2cxqj2w0ktore.cloudfront.net/preview/iframe/index.html",
                                    B, s, j));
                        ...
                        else if (r === "video") p = "https://d2cxqj2w0ktore.cloudfront.net/preview/iframe/index.html", $("#_previewLinkDialog").parent().hide(), setTimeout(function() {
                            $("#_previewLinkContent iframe").on("load", function() {
                                var a = JSON.stringify({
                                    type: r,
                                    url: location.protocol + "//" + location.hostname + (location.port ? ":" +
                                    location.port : "") + location.pathname + e,
                                    fileName: g
                                });
                                v($(this), a, function() {
                ...
                if (l) {
                    ...
                    i += TM.preview_dialog_height_padding;
                    B = 1120;
                    for (s = 840; B > 160 && (f < B + 40 || m < s + i + 40);) B -= 160, s -= 120;
                    h.width = B + TM.preview_dialog_width_padding
                } else this.$el.addClass("previewFullDialog"), B = f - 40, s = m - i - 40, h.width = B;
                h.height = s + i;
                d && g && (o ? $("#_previewLinkContent").html('<div style="margin:auto"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' +
                    L.loading + "</div>") : $("#_previewLinkContent").html(q(p, B, s, j)));
                this.setOption(h)
            }
        },
        close: function() {
    ...
    function() {
        ...
        var a = g.$el.find("._navlist"),
            b = function(d) {
                ...
                var d = [],
                    h = [];
                f > 0 && (d.push(L.pager_prev), h.push(function() {
                    b(-1)
                }));
                f < a.length - 1 ? (d.push(L.pager_next), h.push(function() {
                    b(1)
                })) : f == a.length - 1 &&
                (d.push(L.button_close), h.push(function() {
                    g.close()
                }));
                g.setOption({
                    buttonLabels: d,
...
function AccountView(b) {
    ...
    for (d in e);
    a.model = b;
    a.tab_type = "invitemail";
    a.contact_dialog_shown = !1;
    a.checked_email_dat = {};
    a.noexist_email_dat = {};
    a.inviteEmailView = new InviteMailAccountView;
    a.prepare = function() {
        function b(a) {
        ...
        CW.view.registerKeyboardShortcut(67, !1, !1, !1, !1,
            function() {
                a.openContactWindow()
            });
        $("#_openContactWindow").click(function() {
            a.openContactWindow();
            AL.trackEvent("contact_list", "click", "contact_list_navigation")
        });
        var e = $("#_nameTip").cwToolTip({
            theme: "black",
            noAnimation: !0
        });
        a.inviteEmailView.prepare();
            ...
            function() {
                if (!b($(this))) {
                    ...
                    if (f = RL.rooms[f]) {
                        var g = [],
                            h;
                        for (h in f.member_dat) AC.isContact(h) || g.push(h);
    ...
    a.checkCWID = function(b) {
        var d = trim(b);
        if (d != g) g = d, i && (clearTimeout(i), i = null), AC.getChatWorkId(AC.myid) == d ? ($("#_profileCWIDLoading").hide(), $("#_profileCWIDStatus").text(""), a.is_valid_cwid = !0) : d ? d.length > 50 ? ($("#_profileCWIDLoading").hide(), $("#_profileCWIDStatus").text(L.error_maxlength.replace("%%length%%", 50)).css("color", "red"), a.is_valid_cwid = !1) : d.match(/^[-_a-zA-Z0-9]+$/) ? ($("#_profileCWIDLoading").show(), $("#_profileCWIDStatus").text(""), i = setTimeout(function() {
        ...
        $("#_profileEditContent").cwDialog({
                    ...
                    case 0:
                        ...
                        if (b.length) CW.alert(b.join("\n"));
                            ...
                            CW.post("gateway.php", e, function(b) {
                                ...
                                b.allow_search != void 0 &&
                                (ST.data.allow_search = parseInt(b.allow_search, 10));
                                CW.watch()
                            }, function() {
                                CW.alert(L.raise_error)
                            });
            ...
            open: function() {
                ...
                CW.is_business ? (CW.is_admin && $("#_profileCommonOrgNameLink").show(), $("#_profileEditOrgNameLoading").show(), CW.post("gateway.php", {
                    ...
                    a.onm !== "" ? ($("#_profileEditOrgName ._profileSelectOrgNameType").show(), $("#_profileSelectOrgnameTypeCommonLabel").text(a.onm)) :
                        $("#_profileEditOrgName ._profileSelectOrgNameType").hide();
                ...
                a.setPrivacySettingIcon("Facebook",
                    AC.getFacebookPriv(AC.myid));
    ...
    var h = null,
        ...
        l = 0,
        o = 0,
        q = TM.contactwindow_pager_view_num,
        u = null,
        n = {};
    a.prepareContactWindow = function() {
        ...
        $("#_contactWindowTab").on("click", "li", function() {
            ...
            this.id === "_contactWindowTabInviteEmail" ? AL.trackEvent("contact_list", "open", "mail_invitation") : this.id === "_contactWindowTabContact" ? AL.trackEvent("contact_list", "open", "new_contact") : this.id === "_contactWindowTabMyContact" ? AL.trackEvent("contact_list", "open", "contact_list") :
                this.id === "_contactWindowTabMyRequest" ? AL.trackEvent("contact_list", "open", "request_contact_list") : this.id === "_contactWindowTabRequest" ? AL.trackEvent("contact_list", "open", "unapproval_contact_list") : this.id === "_contactWindowTabNoRequest" && AL.trackEvent("contact_list", "open", "unconnected_contact_list")
        });
        ...
        var d = $("#_contactWindowCheckActionArea").find("._button").cwButton();
        $C("#_contactWindowList").on("click", "._contactList", function() {
            ...
            AL.trackEvent("contact_list", "click", "contact_list_user")
        }).on("cwCheckBox_update", function(a, b, e) {
            b ? n[e] = b : n[e] && delete n[e];
            a = $C("#_contactWindowList").find("._contactList").length;
            (b = count(n)) ? (b == a ? m.check() : m.partialCheck(), d.enable()) : (m.unCheck(), d.disable())
        }).on("click",
            "._inviteContact",
            function() {
                var b = w.inviteMailList;
        ...
        m = $C("#_contactWindowCheckAll").cwCheckBox();
        ...
        $("#_contactDetailClose").click(function() {
            $C("#_contactWindowList").find("._contactList").removeClass("adminDetailSelected");
            $C("#_contactDetailArea").attr("data-aid",
                "").hide();
        ...
        $("#_contactWindowDelete").cwButton({
            click: function() {
                ...
                CW.view.confirmDelete(L.contact_multi_delete_confirm.replace(/%%num%%/, a.length), function() {
                    a.length >
                    0 && (CW.showProgress(L.deleting), CW.post("gateway.php", {
                        cmd: "delete_contact",
                        a: a
                    }, function() {
                        CW.hideProgress();
        ...
        if (!(w.lastType == b && w.lastQuery == d)) {
            ...
            switch (b) {
                case "word":
                    d ? t = setTimeout(function() {
                        ...
                        x = CW.post("r/gateway.php", {
                            ...
                            if (b.error != void 0) {
                                ...
                                for (d in b.account_dat) AC.myid != d && w.accountIdList.push(d), AC.isUnknown(d) && AC.setAccountDat(d, b.account_dat[d]);
                                if (b.error_dat && b.error_dat.noexist) {
                                    b = b.error_dat.noexist;
                                    d = 0;
                                    for (e = b.length; d < e; d++) w.inviteMailList.push(b[d])
                                }
                            }
                            w.isSearched = !0;
                            w.isLoading = !1;
                    ...
                    }, 1E3) : (w.isSearched = !1, w.isLoading = !1, a.buildContactWindow());
                    break;
                case "mail":
                    var e = d.split("\n");
                    x = CW.post("gateway.php", {
                        cmd: "check_address",
                        a: e
                    }, function(b) {
                        if (b.error != void 0) {
                            ...
                            if (b.error_dat != void 0) {
                                ...
                                for (d in b.error_dat) {
                                    ...
                                    if (d == "noexist")
                                        for (var h = 0; h < g; h++) w.inviteMailList.push(b.error_dat[d][h]);
                                    else {
                                        ...
                                        g = "";
                                        for (h = 0; h < n; h++) g && (g += ","), g += b.error_dat[d][h];
                                        f += g;
    ...
    a.selectDefaultTabInContactWindow = function() {
        var b = a.inviteEmailView.tabId;
        $C("#" + b).length === 0 && (b = "_contactWindowTabContact");
    ...
    a.buildContactWindow = function(b) {
        ...
        if (h && h.isOpen()) {
            ...
            if (a.tab_type === "invitemail" && $C("#" + a.inviteEmailView.tabId).length === 0) a.tab_type = "addcontact";
            contact_window_allcheck_button.disable();
            $C("#_contactWindowNavigation ._contactWindowNavigationItem").hide();
            a.tab_type == "invitemail" ? (a.inviteEmailView.show(), $C("#_contactWindowNavigation").hide(), $C("#_contactDetailAreaWrapper").hide(), $C("#_contactWindowBox").hide()) : ($C("#_contactWindowNavigation").show(),
                $C("#_contactDetailAreaWrapper").show(), $C("#_contactWindowBox").show(), a.inviteEmailView.hide());
            switch (a.tab_type) {
                case "addcontact":
                    ...
                    for (var i = [], k = 0, r = f.length; k < r; k++) {
                        var t = f[k];
                        !AC.isContact(t) && !AC.request_dat[t] && !AC.myrequest_dat[t] && i.push(t)
                    }
                    f = i;
                    break;
                case "contact":
                    ...
                    w.isSearched = !1;
                    if (f) i = CW.splitWithSpace(f), w.isSearched = !0;
                    for (var f = [], k = 0, x = a.model.contact_list.length; k < x; k++) t = a.model.contact_list[k], r(t, i) && f.push(t);
                ...
                case "myrequest":
                    ...
                    if (f) i = CW.splitWithSpace(f), w.isSearched = !0;
                    f = [];
                    for (t in a.model.myrequest_dat) r(t,
                        i) && f.push(t);
                ...
                case "request":
                    ...
                    if (f) i = CW.splitWithSpace(f), w.isSearched = !0;
                    f = [];
                    for (t in a.model.request_dat) r(t, i) && f.push(t);
                ...
                case "norequest":
                    ...
                    f = [];
                    e = a.getNoRequestDat();
                    for (t in e) r(t, i) && f.push(t);
                    b += '<div class="contactAddAllHint">' + L.contact_add_all_hint + "</div>";
                    $C("#_contactWindowAdd").show().cwButton().disable()
            }
            w.isLoading ? b += '<div class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.loading + "</div>" : f.length == 0 && g.length == 0 && (b += w.isSearched ? '<div class="emptyAdminContent"><img src="./imagenew/common/empty/img_contact_empty.png" alt="" /><p>' +
            L.contact_error_search_user_not_found + "</p></div>" : '<div class="emptyAdminContent"><img src="./imagenew/common/empty/img_contact_empty.png" alt="" /><p>' + j + "</p></div>");
            f.sort(function(b, d) {
            ...
            t = count(a.model.myrequest_dat);
            if (t > 0) $C("#_contactWindowTabMyRequest").show(), $C("#_contactWindowMyRequestNum").text("(" +
                number_format(t) + ")");
            ...
            t = count(e);
            if (t > 0) $C("#_contactWindowTabNoRequest").show(), $C("#_contactWindowNoRequestNum").text("(" +
                number_format(t) + ")");
            ...
            if (t > 0) {
                ...
                for (k = 0; k < t; k++) b += "<li>" + escape_html(g[k]) + "</li>";
            ...
            for (k = 0; k < d; k++) t = g[k], b += '<li class="_contactList subContentShadow" data-aid="' + t + '">' + a.getContactPanel(t, i) + "</li>", e == t && (j = !0);
            j || $C("#_contactDetailClose").click();
            m.unCheck(!0);
            $C("#_contactWindowList").html(b);
            f.length ? $C("#_contactWindowPagerIndex").text((o + 1).toString() + " / " + l) : $C("#_contactWindowPagerIndex").text("");
            u.enableButtonAll();
            o == 0 && u.disableButton(0).disableButton(1);
            l - o <= 1 && u.disableButton(2).disableButton(3);
            a.tab_type == "invitemail" ? a.inviteEmailView.giveFocus() : $C("#_contactWindowSearch").focus()
        }
    };
    a.buildContactDetail = function(b) {
        AC.account_dat[b] && ($C("#_contactDetailBlankArea").hide(), $C("#_contactDetailArea").show(), a.assignDetailInfo($C("#_contactDetailArea"),
            b))
    };
    var r = 0;
    a.assignDetailInfo = function(b, d) {
        ...
        e = AC.getUrl(d);
        e.match(/^(https?|ftp)(:\/\/[-_.!~*\'()a-zA-Z0-9;\/?:\@&=+\$,%#]+)$/) ?
            (e = escape_html(e), b.find("._profileUrl").html('<a href="' + e + '" target="_blank">' + e + "</a>")) : b.find("._profileUrl").text(e);
        e = AC.getEmail(d);
        ...
        h && (e += '<li><span class="icoFontSkype"></span><span class="icoTextHide">skype</span><a href="skype:' + i + '?call">' + i + "</a></li>");
    ...
    a.getContactPanel = function(b, d) {
        ...
        g && (f = '<dd id="profileTipChatWorkId">' + L.profile_chatworkidtip + "<span>" + g + "</span></dd>");
        g = "";
        ...
        var n = "";
        e.showCover && (n = CW.getCoverPanel(b));
        var l = "",
            j = "";
        e.showButton && h && (e.footerButton ? j = '<div class="tooltipFooter"><div class="btnGroup"><div class="_profileTipButton">' +
            h + "</div></div></div>" : l = '<div class="btnGroup">' + h + "</div>");
        h = "";
        e.showCheckBox && (h = $.cwCheckBox.create(e.isChecked, "", b, {
            "class": "_contactPanelCheck"
        }));
        e = "";
        a.tab_type === "request" && AC.getRequestMessage(b) && (e = $("<div>").addClass("speakerProfileTooltipMessage").append($("<pre>").addClass("message").text(AC.getRequestMessage(b))), e = $("<div>").append(e).html());
        return '<div class="_contactPanel" data-aid="' + b + '"><div class="profileImgToolTip">' + n + '<div class="profileTooltipAvater">' + CW.getAvatarPanel(b, {
                hovertip: !1,
                clicktip: !1,
                size: "large"
            }) + '</div></div><div class="speakerProfileTooltipContent clearfix">' + h + "<dl><dt>" + i + '</dt><dd id="_profileTipOrgName">' + CW.getOrgName(b) + "</dd>" + f + g + l + "</dl></div>" + e + j
    };
...
function SettingView(b) {
    ...
    a.prepareSetting = function() {
        ...
        var f = function() {
            ...
            h = a.selectbox_dat;
            for (i in h) l = h[i], j = $("#" + i), g[l] = j.cwSelectBox().getVal();
        ...
        d = b.cwDialog({
            ...
            open: function() {
                ...
                for (f in b) g = b[f], h = $("#" + f).cwSelectBox({
                    parentFloatBox: d
                }), g !== null && typeof a.model.data[g] !== "undefined" && (g = a.model.data[g],
                h.findItemByValue(g) && h.select(g));
        ...
        $("#_langType").cwSelectBox().setOption({
            update: function() {
                ...
                var e = a.supported_dateformat,
                    ...
                    f = [];
                d = 0;
                for (var g = e.length; d < g; d++) f.push({
    ...
    a.prepare = function() {
        ...
        e.click(function() {
            if (!d.isVisible()) {
                ...
                e.removeClass("myStatusButtonHover");
                var a = e.outerWidth();
                if (a < TM.mymenu_min_width) a = TM.mymenu_min_width;
                d.width(a);
                ...
                l = {
                    getApiToken: function(a) {
                        CW.post("gateway.php", {
                            ...
                            a.api_token && l.displayTokenPanel(a.api_token)
                        }, function(a) {
            ...
            g = {
                init: function() {
                    d.find("._displayApiToken").click(function() {
                        h = a.val();
                        h.length === 0 ? CW.alert(L._chatwork_apitoken_empty_password) : l.getApiToken({
                            password: h
                        })
                    });
                    f.click(function() {
    ...
    var i = !1,
        ...
        k = function() {
            if (f) return !1;
            !i && !a.model.data.userguide_welcome && (i = !0, setTimeout(function() {
                a.openWelcomeDialog()
            }, 500))
        };
    a.openWelcomeDialog = function(a) {
        a = a || LANGUAGE === "ja";
        if (!f) {
            var b = !0;
            f =
                $("#_userguideWelcomeDialog").cwDialog({
                    closeOnEscape: !a,
                    title: a ? void 0 : L.welcome_title.replace("%%service_name%%", SERVICE_NAME),
                    width: 820,
                    close: function() {
                        b && CW.view.startTutorial();
                        CW.post("gateway.php", {
                            cmd: "send_chat_setting",
                            data: {
                                userguide_welcome: "1"
            ...
            $("#_userguideWelcomeOpen").click(function() {
                f.close();
                AL.trackEvent("onboarding", "click", "onboarding_wel_s")
            });
            $("#_userguideSkipTutorial").click(function() {
                b = !1;
                f.close();
                AL.trackEvent("onboarding", "click", "onboarding_wel_t")
            })
        }
        f.open()
    };
    ...
    a.requestNotificationPermission = function(a) {
        NotificationAPI ? NotificationAPI.requestPermission(function() {
            NotificationAPI.checkPermission() ==
            0 ? a(!0) : a(!1)
        }) : CW.alert(L.desktopalert_no_support)
    };
...
function FileView(b) {
    ...
    a.prepare = function() {
        $("#_openFileWindow").click(function() {
            a.openFileWindow();
            AL.trackEvent("file_list", "click", "file_list_navigation")
        });
        var b = !1;
        $("#_fileWindow,#_chatFileListTip").on("click", "._downloadFile", function() {
            $(this).parents("#_fileWindow").length ? AL.trackEvent("file_list", "click", "file_list_download") : AL.trackEvent("room_detail", "click", "room_detail_download");
            var a = $(this).attr("data-file-id");
            (a = FL.file_id2file_dat[a]) && $("#_downloadFrame").attr("src",
                SERVER_PATH + "/gateway.php?cmd=download_file&bin=1&file_id=" + a.id);
            return !1
        }).on("click", "._editFile", function() {
            $(this).parents("#_fileWindow").length ? AL.trackEvent("file_list", "click", "file_list_edit") : AL.trackEvent("room_detail", "click", "room_detail_file_edit");
            ...
            $(this).parents("#_fileWindow").length ? AL.trackEvent("file_list", "click", "file_list_message_jump") : AL.trackEvent("room_detail",
                "click", "room_detail_file_message_jump");
            var a = $(this).attr("data-file-id");
            (a = FL.file_id2file_dat[a]) && RL.selectRoom(a.rid, a.cid)
        }).on("click", "._deleteFile", function() {
            $(this).parents("#_fileWindow").length ? AL.trackEvent("file_list", "click", "file_list_delete") : AL.trackEvent("room_detail", "click", "room_detail_file_delete");
    ...
    a.buildFileDetail = function(b) {
        if (b = FL.file_id2file_dat[b]) $C("#_fileDetailBlankArea").hide(),
            $C("#_fileDetailArea").show(), a.assignDetailInfo($C("#_fileDetailArea"), b)
    };
    var f = null,
        g = {};
    a.assignDetailInfo = function(b, d) {
        var e = SERVER_PATH + "/gateway.php?cmd=download_file&bin=1&file_id=" + d.id,
            h = get_file_extension(d.fn);
        FL.view.isImage(h) ? (e += "&preview=1", b.find("._fileDetailPreview").html('<a href="' + e + '" target="_blank"><img src="' + e + '"/></a>')) : FL.view.isText(h) ? (f && f.abort(), g[d.id] ? (b.find("._fileDetailPreview").html('<div class="_codePreview codePreview">' + g[d.id].data + "</div>").scrollTop(0),
            a.startPreviewCacheTimer(d.id)) : (f = $.ajax({
            type: "GET",
            url: e + "&preview=1",
            success: function(e) {
                g[d.id] = {
        ...
        }), b.find("._fileDetailPreview").html('<div class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.file_loading +
            "</div>"))) : b.find("._fileDetailPreview").html(a.getFileTypeIcon(h));
        b.scrollTop(0);
    ...
    a.prepareFileType = function() {
        ...
        var a = {
                ...
                presentation: {
                    key: 3,
                    list: ["pptx", "ppt", "key",
                        "odp", "pptm", "ppsx", "potx", "pps", "pot", "gslides", "skitch"
                    ]
                },
                image: {
                    key: 4,
                ...
                script: {
                    key: 15,
                    list: ["js", "m", "h", "json", "hsp", "rb", "sh", "c", "dll", "h", "cpp", "bat", "py", "cs", "cgi", "crx", "pl", "uws", "atn", "as", "jsx", "erb", "class", "scala", "jsee", "inc", "pm", "asp", "vb", "vbs",
                        "module", "obj", "patch", "lua", "xcodeproj", "vcproj"
                    ]
                },
                php: {
                    key: 16,
                ...
                archive: {
                    key: 28,
                    list: ["zip", "lzh",
                        "rar", "gz", "7z", "tgz", "tar", "cab", "sit", "egg", "alzip"
                    ]
                }
            },
            b;
    ...
    a.openFileList = function(b) {
        ...
        b && AL.trackEvent("room_detail", "open", "room_detail_file_list")
    };
    var h = null;
    a.openPreviewDialog = function(b) {
        ...
        h || (h = $("#_filePreviewDialog").cwDialog({
            ...
            height: 500,
            modal: !0,
            buttonLabels: [L.file_preview_download,
                L.button_cancel
            ],
            buttonSubmit: 0,
            buttonCancel: 1,
            ...
            open: function(a) {
                ...
                this.data.file_id = a;
                this.$el.html('<div class="filePreviewDialogArea"><div id="_filePreviewLoading" class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.file_loading + '</div><div class="filePreviewImage"><img id="_filePreviewImage" style="visibility:hidden" src="' +
                    b + '"/><div class="filePreviewBlank"><span class="icoFontLinkBlank"></span><span class="icoTextHide">' + L.file_preview_open_newwindow + "<span></div></div></div>");
                ...
                d.load(function() {
                    ...
                    if (g) a.width = round(f), a.height = round(e);
                    d.css(a);
                    d.click(function() {
                        window.open(b)
                    });
    ...
    a.buildFileWindow = function(b) {
        if (m && m.isOpen()) {
            ...
            if (!a.model.myfile_load_flag.loaded) return $("#_fileWindowList").html('<li class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" alt="Loading" />' +
                L.file_loading + "</li>"), FL.loadAllMyFile(), !1;
            o.disable();
            var b = a.model.getMyFileList(),
                d = [];
            if (l)
                for (var e = l.toLowerCase(), f = 0, g = b.length; f < g; f++) {
                    var h = b[f],
            ...
            (i = count(t)) ?
                (i == b.length ? d.check() : d.partialCheck(), f.enable()) : (d.unCheck(), f.disable());
            ...
            h || (b = "", b = l ? L.file_search_not_found : L.file_nothing, h = '<li class="emptyAdminContent"><img src="./imagenew/common/empty/img_file_empty.png" alt="" /><p>' + b + "</p></li>");
            $C("#_fileWindowList").html(h);
            d || $C("#_fileDetailClose").click();
            e == 0 ? ($C("#_emptyFileContent").show(),
                $C("#_fileWindowPagerIndex").text("")) : ($C("#_emptyFileContent").hide(), $C("#_fileWindowPagerIndex").text((u + 1).toString() + " / " + q));
            x.enableButtonAll();
            u == 0 && x.disableButton(0).disableButton(1);
            q - u <= 1 && x.disableButton(2).disableButton(3);
            a.buildStorageInfo()
        }
    };
    ...
    var m = null,
        ...
        q = 0,
        u = 0,
        n = TM.taskwindow_pager_view_num,
        x = null,
        t = {};
    a.prepareFileWindow = function() {
        m = $("#_fileWindow").cwFloatWindow({
            width: 920,
            title: L.menu_file
        });
        ...
        $("#_fileWindowList").on("click", "li", function() {
            ...
            a.buildFileDetail(b);
            AL.trackEvent("file_list", "open", "file_detail")
            ...
            b ? t[d] = b : t[d] && delete t[d];
            a = $C("#_fileWindowCheckAll").cwCheckBox();
            b = $C("#_fileWindowList").find("._fileList").length;
            (d = count(t)) ? (d == b ? a.check() : a.partialCheck(), e.enable()) : (a.unCheck(), e.disable())
        });
        ...
        o = $("#_fileWindowCheckAllButton").cwButton({
            click: function() {
        ...
        x = $("#_fileWindowPager").cwButtonBar({
            update: function(b) {
                switch (f[b]) {
                    case "first":
                        u =
    ...
    a.updateStorageInfo = function(b, d, f, g) {
        ...
        if (d != void 0) A.storage = b, A.storage_limit = d, A.limit_time =
            f, A.is_limit = g, m && m.isOpen() && a.buildStorageInfo()
    };
...
function InviteMailAccountView() {
    var b = this;
    b.model = new InviteMailAccountModel;
    b.tabId = "_contactWindowTabInviteEmail";
    b.invite_mail_state_type = "individual";
    b.view_state = "invite";
    b.selectorOfMessageForm = "#_contentInviteMailNew [name=message]";
    b.selectorOfIndividualEmailForms = ".contactInviteMailList [type=email]";
    b.selectorOfIndividualEmailList = ".contactInviteMailList li";
    b.selectorOfBulkEmailForm = "#_addFromEmailContentEmails";
    b.prepare = function() {
        $C("#" + b.tabId).show();
        $C("#_wrapper").on("click", "#_contactInviteMail",
            b.handleClickSendInviteMail).on("click", "#_contactOtherInviteMail", b.handleClickOtherInviteMail).on("click", "#_contactInviteMailAddAddress", b.handleClickAddMailAddressInputForm).on("click", ".contactInviteMailList .fromCancelIcon", b.handleClickRemoveMailAddressInputForm).on("keyup", b.selectorOfIndividualEmailForms, b.handleKeyUpMailAddressInputForm).on("keyup", b.selectorOfBulkEmailForm, b.handleKeyUpMailBulkAddressTextArea).on("click", ".changeFormBulk", b.handleClickChangeFormBulk).on("click", ".changeFormIndividual",
            b.handleClickChangeFormIndividual).on("click", "._contactRequestLink", function() {
            $("#_contactWindowTabRequest").click()
        }).on("click", "._contactMyRequestLink", function() {
            $("#_contactWindowTabMyRequest").click()
        })
    };
    b.handleClickSendInviteMail = function() {
        b.applyModelMails();
        b.applyModelMessage();
        if (b.model.validate()) {
            var a = b.model.hasMessage();
            CW.post("gateway.php", b.callApiParams(b.model.emails(), b.model.message()), function(e) {
                b.view_state = "finished";
                b.buildFinishedView(e || {});
                e.sent_contact_requests.length >
                0 && AC.view.buildContactWindow();
                $C("#_contentInviteMailNew").hide();
                $C("#_contentInviteMailFinished").show();
                b.model.clear();
                $C(b.selectorOfMessageForm).val("");
                $C(".contactInviteErrorMessage").hide();
                $(b.selectorOfIndividualEmailList).remove();
                b.addMailAddress();
                $C(b.selectorOfBulkEmailForm).val("");
                b.visibleInputMailFromCancelIcon();
                $C("#_contactInviteMail").hide();
                $C("#_contactOtherInviteMail").show();
                a ? AL.trackEvent("contact_list", "send", "mail_invitation_with_message") : AL.trackEvent("contact_list",
                    "send", "mail_invitation")
            }, function(a) {
                CW.alert(a)
            })
        } else $C(".contactInviteErrorMessage").text(b.model.validateMessage()).show()
    };
    b.handleClickOtherInviteMail = function() {
        b.view_state = "invite";
        b.showInviteMailNew();
        b.giveFocus()
    };
    b.handleClickAddMailAddressInputForm = function() {
        b.addMailAddress();
        b.visibleInputMailFromCancelIcon();
        $(b.selectorOfIndividualEmailForms).last().focus()
    };
    b.handleClickRemoveMailAddressInputForm = function() {
        $(b.selectorOfIndividualEmailList).length > 1 ? $(this).closest("li").remove() :
            $(this).closest("li").find("[name=email]").val("");
        b.visibleInputMailFromCancelIcon();
        b.giveFocus()
    };
    b.handleKeyUpMailAddressInputForm = function() {
        b.visibleInputMailFromCancelIcon();
        b.applyModelMails();
        b.model.validate() && $C(".contactInviteErrorMessage").hide()
    };
    b.handleKeyUpMailBulkAddressTextArea = function() {
        b.applyModelMails();
        b.model.validate() && $C(".contactInviteErrorMessage").hide()
    };
    b.handleClickChangeFormBulk = function() {
        b.invite_mail_state_type = "bulk";
        var a = $(b.selectorOfIndividualEmailForms).filter(function(a,
                                                                    b) {
            return b.value
        }).map(function(a, b) {
            return b.value
        });
        b.model.setEmails(a.toArray());
        $C(b.selectorOfBulkEmailForm).val(b.model.emails().join("\n"));
        $C("#_contactInviteMailIndividual").hide();
        $C("#_contactInviteMailBulk").show();
        b.giveFocus()
    };
    b.handleClickChangeFormIndividual = function() {
        b.invite_mail_state_type = "individual";
        var a = $C(b.selectorOfBulkEmailForm).val();
        b.model.parseBulkEmails(a);
        $(b.selectorOfIndividualEmailList).remove();
        a = b.model.emails();
        a.length > 0 ? a.forEach(function(a) {
            ...
            b.addMailAddress();
        b.visibleInputMailFromCancelIcon();
        $C("#_contactInviteMailBulk").hide();
        $C("#_contactInviteMailIndividual").show();
        b.giveFocus()
    };
    b.init = function() {
        b.view_state = "invite"
    ...
    b.show = function() {
        $C(".contactInviteErrorMessage").hide();
        $C(".contactInviteMailFooter").show();
        $C("#_contactInviteMailArea").show();
        b.view_state == "invite" && (b.showInviteMailNew(), b.visibleInputMailFromCancelIcon())
    };
    b.hide = function() {
        $C("#_contactInviteMailArea").hide();
        $C(".contactInviteMailFooter").hide()
    };
    b.giveFocus = function() {
        b.invite_mail_state_type == "individual" ? $("#_contactInviteMailIndividual [type=email]").last().focus() : $(b.selectorOfBulkEmailForm).focus()
    };
    b.buildFinishedView = function(a) {
        var b = function(a) {
                return $("<li>").text(a)
            },
            d = (a.sent_invitations || []).concat(a.sent_contact_requests || []),
            d = (a.established || []).reduce(function(a, b) {
                a.push(b.email_address);
                return a
            }, d);
        $C("#_contactInviteMailSentEmails .contactInviteMailResultList").html(d.map(b));
        d.length > 0 ? ($C("#_contentInviteMailFinished .alertSuccess").show(),
            $C("#_contentInviteMailFinished .alertDanger").hide(), $C("#_contactInviteMailSentEmails").show()) : ($C("#_contentInviteMailFinished .alertSuccess").hide(), $C("#_contentInviteMailFinished .alertDanger").show(), $C("#_contactInviteMailSentEmails").hide());
        d = a.unreachable_email_addresses || [];
        $C("#_contactInviteMailUnreachableEmailAddresses .contactInviteMailResultList").html(d.map(b));
        d.length > 0 ? $C("#_contactInviteMailUnreachableEmailAddresses").show() : $C("#_contactInviteMailUnreachableEmailAddresses").hide();
        d = a.already_requested || [];
        $C("#_contactInviteMailAlreadyRequested .contactInviteMailResultList").html(d.map(function(a) {
            var b = $("<a>").addClass("_contactMyRequestLink").attr({
                href: "#"
            }).text(a.name);
            return $("<li>").text(a.email_address).append([" [", b, "]"])
        }));
        d.length > 0 ? ($C("#_contactInviteMailAlreadyRequested").show(), $("#_contentInviteMailFinished ._contactMyRequestLink").cwMessageTip({
            message: L.contact_invite_mail_move_to_your_sent_requests,
            delay: 100
        })) : $C("#_contactInviteMailAlreadyRequested").hide();
        d = a.already_connected || [];
        $C("#_contactInviteMailAlreadyConnected .contactInviteMailResultList").html(d.map(function(a) {
            var b = $("<a>").addClass("_roomLink").attr({
                href: "#",
                "data-rid": a.direct_chat_id
            }).text(a.name);
            return $("<li>").text(a.email_address).append([" [", b, "]"])
        }));
        d.length > 0 ? ($C("#_contactInviteMailAlreadyConnected").show(), $("#_contentInviteMailFinished ._roomLink").cwMessageTip({
            message: L.contact_invite_mail_move_to_direct_chat,
            delay: 100
        })) : $C("#_contactInviteMailAlreadyConnected").hide();
        d = a.request_already_received || [];
        $C("#_contactInviteMailRequestAlreadyReceived .contactInviteMailResultList").html(d.map(function(a) {
            var b = $("<a>").addClass("_contactRequestLink").attr({
                href: "#"
            }).text(a.name);
            return $("<li>").text(a.email_address).append([" [", b, "]"])
        }));
        d.length > 0 ? ($C("#_contactInviteMailRequestAlreadyReceived").show(), $("#_contentInviteMailFinished ._contactRequestLink").cwMessageTip({
            message: L.contact_invite_mail_move_to_incoming_requests,
            delay: 100
        })) : $C("#_contactInviteMailRequestAlreadyReceived").hide();
        d = a.not_allowed_connecting || [];
        $C("#_contactInviteMailNotAllowedConnecting .contactInviteMailResultList").html(d.map(b));
        d.length > 0 ? $C("#_contactInviteMailNotAllowedConnecting").show() : $C("#_contactInviteMailNotAllowedConnecting").hide();
        d = a.contact_request_limit_exceeded || [];
        $C("#_contactInviteMailContactRequestLimitExceeded .contactInviteMailResultList").html(d.map(b));
        d.length > 0 ? $C("#_contactInviteMailContactRequestLimitExceeded").show() : $C("#_contactInviteMailContactRequestLimitExceeded").hide();
        a = a.your_email_address != void 0 ? [a.your_email_address] : [];
        $C("#_contactInviteMailContactYourEmailAddress .contactInviteMailResultList").html(a.map(b));
        a.length > 0 ? $C("#_contactInviteMailContactYourEmailAddress").show() : $C("#_contactInviteMailContactYourEmailAddress").hide()
    };
    b.applyModelMails = function() {
        if (b.invite_mail_state_type === "individual") {
            var a = $(b.selectorOfIndividualEmailForms),
                a = $.map(a, function(a) {
                    return a.value
                });
            b.model.setEmails(a)
        } else a = $C(b.selectorOfBulkEmailForm), b.model.parseBulkEmails(a.val())
    };
    b.applyModelMessage = function() {
        var a = $C(b.selectorOfMessageForm);
        b.model.setMessage(a.val())
    };
    b.callApiParams = function(a, b) {
        return {
            cmd: "invite_contact",
            e: a,
            m: b,
    ...
    b.addMailAddress = function(a) {
        var b = '<input type="email" name="email" placeholder="' + L.contact_invite_mail_enter_your_email_address + '"/>',
            a = $('<li><span class="_cwFWButton icoFontCancel icoSizeLarge fromCancelIcon"></span></li>').prepend($(b).val(a));
        $(".contactInviteMailList").append(a)
    };
    b.visibleInputMailFromCancelIcon = function() {
        var a = $(b.selectorOfIndividualEmailList);
        a.length > 1 ? $(".contactInviteMailList .fromCancelIcon").show() : a.find("[name=email]").val() !== "" ? $(".contactInviteMailList .fromCancelIcon").show() : $(".contactInviteMailList .fromCancelIcon").hide()
    };
    b.showInviteMailNew = function() {
        $C("#_contentInviteMailFinished").hide();
        $C("#_contentInviteMailNew").show();
        $C("#_contactOtherInviteMail").hide();
        $C("#_contactInviteMail").show()
    }
}
...
function TaskView(b) {
    ...
    var e = function() {
        a.alltask_type === "my" && a.alltask_status === "open" ? AL.trackEvent("task_list", "open", "my_open_task") : a.alltask_type === "my" && a.alltask_status === "done" ? AL.trackEvent("task_list", "open", "my_done_task") : a.alltask_type === "assign" && a.alltask_status === "open" ? AL.trackEvent("task_list", "open", "assign_open_task") : a.alltask_type === "assign" && a.alltask_status === "done" && AL.trackEvent("task_list",
            "open", "assign_done_task")
    };
    a.prepare = function() {
        $("#_openTaskWindow").click(function() {
            a.openTaskWindow();
            AL.trackEvent("task_list", "click", "task_list_navigation")
        });
        var b = null,
            d = null;
    ...
    a.prepareTaskWindow = function() {
        $("#_taskWindowTabOpen").click(function() {
            if (a.alltask_status != "open") $("#_taskWindowTabDone").removeClass("floatTabSelect"),
                $(this).addClass("floatTabSelect"), a.alltask_status = "open", a.buildTaskWindow(), e()
        });
        $("#_taskWindowTabDone").click(function() {
            if (a.alltask_status != "done") $("#_taskWindowTabOpen").removeClass("floatTabSelect"), $(this).addClass("floatTabSelect"), a.alltask_status = "done", a.buildTaskWindow(), e()
        });
        $C("#_taskWindowList").on("click", "._taskList", function() {
            ...
            AL.trackEvent("task_list", "open", "task_detail")
        });
        ...
        $C("#_taskDetailTitle").click(function() {
            var a =
                    $C("#_taskDetailArea").attr("data-task-id"),
                a = $C("#_taskWindowList").find("li._taskList[data-task-id=" + a + "]");
    ...
    a.buildTaskWindow = function(b) {
        if (d && d.isOpen()) {
            ...
            if (!a.model.mytask_load_flag.loaded[h]) return $C("#_taskWindowList").html('<li class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.task_loading +
                "</li>"), a.model.mytask_load_flag.loading[h] || (a.model.mytask_load_flag.loading[h] = !0, CW.get("gateway.php", {
                cmd: "load_my_task",
                type: e,
                status: b
            }, function(b) {
                if (b.task_dat) {
                    for (var d in b.task_dat) b.task_dat[d].cid = parseInt(b.task_dat[d].cid, 10), a.model.setTask(b.task_dat[d]);
                    a.model.mytask_load_flag.loading[h] = !1;
                    a.model.mytask_load_flag.loaded[h] = time();
                    a.buildTaskWindow()
                }
            })), !1;
            var k = a.model.getMyTaskList(b, e);
            if (b == "open") {
                $C("#_taskWindowFilter").show();
                for (var n = [], m = time(), t = strtotime(CW.getDate(m,
                    "Y-m-d 00:00:00")), A = t + 86400, w = t + 604800, r = k.length, p = 0, s = 0, v = 0, B = 0, b = r; b--;) {
                    var E = k[b],
                        e = TK.task_id2task_dat[k[b]];
                    e.lt != 0 && e.lt <= m && (p++, a.alltask_filter == "limitover" && n.push(E));
                    t < e.lt && A > e.lt && (s++, a.alltask_filter == "today" && n.push(E));
                    t < e.lt && w > e.lt && (v++, a.alltask_filter == "inweek" && n.push(E));
                    e.lt == 0 && (B++, a.alltask_filter == "nolimit" && n.push(E));
                    a.alltask_filter == "all" && n.push(E)
                }
                RL.mytask_total > 0 ? $C("#_taskWindowNumAll").text(r).show() : $C("#_taskWindowNumAll").hide();
                p > 0 ? $C("#_taskWindowNumLimitOver").text(p).show() :
                    $C("#_taskWindowNumLimitOver").hide();
                s > 0 ? $C("#_taskWindowNumLimitToday").text(s).show() : $C("#_taskWindowNumLimitToday").hide();
                v > 0 ? $C("#_taskWindowNumLimitWeek").text(v).show() : $C("#_taskWindowNumLimitWeek").hide();
                B > 0 ? $C("#_taskWindowNumLimitNone").text(B).show() : $C("#_taskWindowNumLimitNone").hide()
            } else $C("#_taskWindowFilter").hide(), n = k;
            TK.sortTaskList(n);
            k = [];
            e = n.length;
            f = parseInt(e / i, 10);
            ...
            if (e >= i) {
                ...
                b = m + i;
                b > e && (b = e);
                for (e = m; e < b; e++) k.push(n[e])
            } else k = n;
            n = $C("#_taskDetailArea").attr("data-task-id");
            m = !1;
            t = "";
            A = k.length;
            for (b = 0; b < A; b++) e = TK.task_id2task_dat[k[b]], (w = RL.rooms[e.rid]) || (w = {
                getIcon: function() {
                    return ""
                },
                getName: function() {
            ...
            }), n == e.id && (m = !0), t += a.getTaskPanel(e, {
                type: "taskwindow"
            });
            $C("#_taskWindowList").html(t);
            m || $C("#_taskDetailClose").click();
            A == 0 && $C("#_emptyTaskContent").show();
            A ? $C("#_taskWindowPagerIndex").text((g + 1).toString() + " / " + f) : $C("#_taskWindowPagerIndex").text("");
            j.enableButtonAll();
            g == 0 && j.disableButton(0).disableButton(1);
            f - g <=
            1 && j.disableButton(2).disableButton(3);
            d.resize()
        }
    };
                ...
                if (!d)
                    if (i.timeline)
                        if (i.timeline.chat_id2chat_dat[e]) {
                            for (var m = 0, f = i.timeline.chat_list.length; m < f; m++) {
                                var p = i.timeline.chat_list[m];
                                if (p.id == e) break
                            }
                            30 > m && i.timeline.has_old && (k = j = !0)
                        } else j = !0;
                    else j = !0;
                if (j) d ? h = "<div>" + L.jump_to_addpoint_not_found + "</div>" : (h = '<div class="timeLineLoading"><img src="./imagenew/all/common/loader/img_loader_white.gif" />' +
                    L.chat_loading + "</div>", k ? i.timeline.loadOld(function() {
                    ...
                    m = j = 0;
                    for (f = i.timeline.chat_list.length; m < f; m++)
                        if (p = i.timeline.chat_list[m], p.id == e) {
                            j = m;
                            break
                        }
                    if (j) {
                        ...
                        j > 30 && (m = j - 30);
                        g = j + 30;
                        for (h = []; m <= g && m < f; m++) h.push(i.timeline.chat_list[m]);
    ...
    var h = {
        ...
        m = TM.timeline_assign_member_show_max;
...
function RoomListView(b) {
    ...
    a.prepare = function() {
        ...
        $C("#_wrapper").on("click", "._pin", function() {
            ...
            CW.post("gateway.php", {
                ...
                d.parents("._roomLink").length ? AL.trackEvent("room_list", "click", "room_list_pin", stick_on) : AL.trackEvent("timeline",
                    "click", "timeline_pin", stick_on)
            });
            a.model.build();
            RM.build();
            return !1
            ...
            var a = $(this);
            a.hasClass("ico19PinOn") || a.addClass("ico19PinHover")
            ...
            select: function(a) {
                switch (a) {
                    case "addchat":
                        ...
                        break;
                    case "addcontact":
                        AC.view.reachedContactLimit() ?
                            CW.view.showContactLimitErrorDialog() : (AC.view.tab_type = "invitemail", AC.view.openContactWindow())
                }
            }
        });
        ...
        $("#_sideChatMoveMyChat").click(function() {
            ...
            AL.trackEvent("room_list", "click", "my_chat")
        }).cwMessageTip({
            ...
            update: function(a, b) {
                if (b) switch (a) {
                    case 0:
                        ...
                        RL.setToOnly(!1);
                        RL.setTaskOnly(!1);
                        AL.trackEvent("room_list", "click", "unread_filter");
                        break;
                    case 1:
                        ...
                        RL.setToOnly(!0);
                        RL.setTaskOnly(!1);
                        AL.trackEvent("room_list", "click", "to_filter");
                        break;
                    case 2:
                        $.cookie("ui_roomfilter", "2", {
                            expires: 3650
                        }), RL.setReadOnly(!1), RL.setToOnly(!1), RL.setTaskOnly(!0), $C("#_chatTabTask").click(), AL.trackEvent("room_list", "click", "task_filter")
                } else $.removeCookie("ui_roomfilter"),
                    RL.setReadOnly(!1), RL.setToOnly(!1), RL.setTaskOnly(!1);
                RL.build()
            }
        });
        h.$el.show();
        ...
        (function() {
            var b = function() {
                ...
                e = function(b) {
                    if (b ==
                        0) a.model.focusRoom(a.model.filtered_room_list[0]);
                    else {
    ...
    a.prepareCategory = function() {
        ...
        $("#_chatCategoryList").on("click", "li._chatCategoryItem",
            function() {
                var b = $(this).attr("data-cat-id");
                a.model.selectCategory(b);
                AL.trackEvent("room_list", "click", "category_item");
                g.close()
        ...
        var i = $("#_newcatRoomfilter").cwSearchBox({
                ...
                update: function() {
                    ...
                    for (var l = 0, q = a.length; l < q; l++) {
                        ...
                        if (!(b && u.toLowerCase().indexOf(b) === -1)) {
                            e.push(p.id);
                            if (e.length >= o) break;
                            u = $.cwCheckBox.create(!!d[p.id], "", p.id, {
                                id: "_newcatCheck" + p.id,
                                "class": "_newcatCheck"
                            });
                            i += '<tr class="_newcatRoom _cwSelectableRow"><td class="check">' + u + '</td><td class="_newcatRoom_name"><span class="ui_room_icon">' + p.getIcon() + "</span></td><td>" + CW.getRoomName(p.id) + "</td></tr>"
                        }
                    }
                    i[g++] = "";
                    f.html(i)
            ...
            q = $("#_chatCategoryAddContent").cwDialog({
                width: 650,
                open: function(b) {
    ...
    a.toggleFold = function() {
        if (!g) {
            AL.trackEvent("message_input", "click", "toggle_fold_room_list");
            var b = $("#_mainContent"),
                d = b.css("left"),
            ...
            if (d == "0px") {
                a.is_folded = !1;
                b.removeClass("mainContent--foldLeft");
                b.css("left",
                    $("#_sideContent").outerWidth() + "px");
            ...
            } else a.is_folded = !0, b.addClass("mainContent--foldLeft"), b.css("left", "0px"), f = e.find(".icoFontTriangleLeft").addClass("rotate180"), setTimeout(function() {
                $.cookie("ui_fold_roomlist",
                    "1", {
                        expires: 3650
                    });
    ...
    a.selectCategory = function() {
        ...
        if (a.model.filter_category != "all") {
            var d = $C("#_chatCategoryList").find("[data-cat-id=" + a.model.filter_category + "]").find("span._categoryName").text();
    ...
    a.build = function(b) {
        ...
        if (e) {
            ...
            for (var g = 0; g < f; g++) b[g] != void 0 && (d += a.getRoomItemPanel(b[g]));
        ...
        } else $C("#_roomListItems").quickEmpty(), $C("#_chatListEmptyArea ._chatListEmpty").hide(), a.model.filter_readonly ?
            $C("#_chatListUnreadEmpty").show() : a.model.filter_toonly ? $C("#_chatListToEmpty").show() : a.model.filter_taskonly && $C("#_chatListTaskEmpty").show(), $C("#_chatListEmptyArea").show()
    };
    var i = {
        showOrg: !1,
        showPin: !0,
    ...
    a.getRoomItemPanel = function(b, d) {
        ...
        if (d == void 0) f = i;
            ...
            f = {};
            for (var g in i) f[g] = i[g];
            for (g in d) f[g] = d[g]
        }
        var o = e.getUnreadNum(),
            q = 0;
        o > 0 && (q = e.getMentionNum());
        g = "_room";
        var u = "",
            n = "",
            x = "";
        f.showSelected && RM && RM.id == b && (g += " _roomSelected menuListTitleSelected");
        o > 0 && (g += " roomUnread", u = '<li role="listitem" class="_unreadBadge unread"><span class="icoFontActionUnread"></span>' + o + "</li>", q && (n = '<li class="_mentionLabel _unreadBadge mention"><span class="icoFontSideTo"></span>' + q + "</li>", g += " roomMentionUnread"));
        e.mytask_num > 0 && (x = '<li><span class="icoFontActionTask"></span>' + Math.min(e.mytask_num, TASK_MAX_RESULTS) + "</li>");
        o = "";
        f.showPin && (o = e.sticky ? '<div class="chatListPin"><span class="_pin _pinRid' + e.id + ' ico19PinOn"></span></div>' : '<div class="chatListPin chatListPinOff"><span class="_pin _pinRid' +
        e.id + ' ico19PinOff"></span></div>');
        q = "";
        f.showRequest && e["public"] && e.member_request.length > 0 && (q = '<div class="alert alertWarning alertSmall"><span class="icoFontInfo marginRight"></span>' + L.chatroom_member_requests_notice.replace(/%%request_num%%/, e.member_request.length) + "</div>");
        var t = "";
        if (f.showOrg && e.type == "contact") {
            var A = e.getAccountId();
            (A = CW.getOrgTitle(A)) && (t = '<p class="chatListOrgName">' + A + "</p>")
        }
        var w = A = "";
        u || n || x ? (f.noTrim || (A = " autotrim"), w = '<ul class="incomplete">' + u + n + x + "</ul>") :
        f.noTrim || (A = " chatListTitleNoLabel");
        f = "";
        CW.is_business && ST.data.show_external && (e.isInternal() || (f = '<div class="_externalMark roomOthers ico19Others"></div>'));
        return '<li role="listitem" aria-label="' + escape_html(e.getName()) + '" class="_roomLink ' + g + '" data-rid="' + e.id + '"><div class="roomIcon">' + e.getIcon("html", "medium") + '</div><div class="chatListMeta"><p class="chatListTitleArea' + A + '">' + CW.getRoomName(e.id) + "</p>" + t + w + "</div>" + f + o + q + "</li>"
    };
    ...
    a.updateTitle = function(b) {
        if (MOBILE ==
            "") {
            var d = "";
            if (a.model.unread_room_sum > 0) d = a.model.unread_room_sum, a.model.mention_room_sum > 0 && (d += "(" + a.model.mention_room_sum + ")"), d = "[" + d + "]";
            d += SERVICE_NAME;
    ...
    RoomView.prototype = {
        ...
        build: function(a) {
            ...
            var g = "",
                ...
                i = CW.getRoomName(f.id);
            $C("#_roomTitle").html('<span class="_roomTitleText autotrim">' + i + "</span>" + g);
            $C("#_subRoomName").html(i);
            ...
            f.description == "" ? (f.buildtime == 0 ? $C("#_subRoomDescription").html('<div class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" alt="Loading" />' + L.loading + "</div>") : $C("#_subRoomDescription").html('<span class="emptyContent">' + L.chatroom_desc_none + "</span>"), RS.view.resizeRoomInfo()) : ($C("#_subRoomDescription").html('<div class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" alt="Loading" />' +
                L.loading + "</div>"), $C("#_subRoomDescription").html("<pre>" + CW.renderMessage(f.description) + "</pre>"), setTimeout(function() {
        ...
        buildMemberList: function() {
            ...
            switch (this.model.type) {
                case "group":
                    ...
                    switch (this.model.member_dat[AC.myid]) {
                        case "admin":
                            ...
                            a("groupCall");
                            if (this.model["public"]) a = this.model.member_request.length, a > 0 && $C("#_roomRequestArea").html('<span class="icoFontInfo marginRight"></span>' + L.chatroom_member_requests_notice.replace("%%request_num%%",
                                    a)).show();
                            break;
                        case "member":
                            this.model.allow_see_member && ($C("#_subRoomMemberArea").show(), a("groupCall"));
                            ...
                            break;
                        case "readonly":
                            this.model.allow_see_member && ($C("#_subRoomMemberArea").show(), a("groupCall")), TK.view.disableTaskArea(),
                                CS.view.disableChatArea(), FL.view.disableFileArea(), this.disabled_send = !0
                    }
                ...
                case "contact":
                    ...
                    break;
                case "my":
                    $C("#_subEditRoomInfo").show(), CS.view.enableChatArea(), TK.view.enableTaskArea(), FL.view.enableFileArea(), this.disabled_send = !1
            }
        ...
        prepareRequestDialog: function() {
                ...
                open: function(a) {
                    ...
                    if (a.length > 0) {
                        for (var i = 0, j = a.length; i < j; i++) {
                            var k =
                                    a[i],
                                h = CW.getAvatarPanel(k.aid, {
                                    hovertip: !1,
                                    clicktip: !1,
                                    size: "medium"
                                }),
                                m = escape_html(k.nm);
                            d += '<tr class="_roomRequestRow"><td>' + h + ' </td><td class="name"><span class="autotrim">' + m + '</span></td><td><div class="_roomRequestAccept button btnPrimary">' + L.button_accept_long + "</div> ( " + L.role + ":" + $.cwSelectBox.create([{
                                    value: "admin",
                                    label: L.admin
                                }, {
                                    value: "member",
                                ...
                                }) + ' )</td><td><div class="_roomRequestReject button buttonGray">' +
                                L.button_reject_long + '</div></td><td style="display:none;"><input type="hidden" value="' + k.aid + '" class="_roomRequestAid" /></td></tr>'
                        }
                        b.html(d)
                    }
                },
                postOpen: function() {
                    if (!this.dialog_resized) {
                        ...
                        var h = d.children(".roomRequest"),
                            m = h.height(),
                            m = parseInt(h.css("max-height"), 10) - m;
                        i > m && (i = m);
                        console.log(i);
                        j.height(k + i);
                        k = parseInt(j.css("margin-top"), 10);
                        j.css("margin-top", k - i / 2 + "px");
                        d.height(d.height() + i);
                        h.height(h.height() + i);
            ...
            var d = function(d, g) {
                var i = b.find("tr").eq(d),
                    j = i.find("._roomRoleSelect");
                i.find("button").button("disable");
                j.prop("disabled", !0);
                var k = i.find("._roomRequestAid").val(),
                    h = j.cwSelectBox().getVal(),
                    k = {
                        rid: a.data.room_id,
                        aid: k,
                        role: h
                    };
                k.cmd = g ? "accept_join_room" : "reject_join_room";
                CW.post("gateway.php", k, function(d) {
                    d.error ? (d.message != void 0 && CW.alert(d.message), i.find("button").button("enable"), j.prop("disabled", !1)) : (i.fadeOut(function() {
    ...
    TimeLineView.prototype = {
        read: function(a) {
            ...
            if (b == 0) $C("#_timeLine").find("._unreadMark").fadeOut("slow", function() {
                ...
                for (var e = this.model.chat_list.length - 1 - b, i = e; i > e - (a - b); i--) this.model.chat_list[i] != void 0 && $("#_messageId" + this.model.chat_list[i].id + " ._unreadMark").fadeOut("slow", function() {
                    $(this).remove()
                })
        },
        build: function(d) {
            ...
            if (a == k.room.id)
                if (g.everScroll) {
                    ...
                    if (!m)
                        for (var n = [], q = 0; q < o; q++) {
                            l = k.chat_list[q];
                            l.msg !== "[deleted]" && (n.push(q), 100 < n.length && n.shift());
                    ...
                    l = typeof n[0] === "number" ? n[0] : m - 100
                } else l = this.start_index;
            else l = m !== null ? m - 100 : o - 200;
            l < 0 && (l = 0);
            n = 0;
            for (q = l; q < o; q++)
                if (!(ST.data.show_delmessage ==
                    0 && k.chat_list[q].msg == "[deleted]") && (k.chat_list[q] && (h.push(k.chat_list[q]), n++), n >= 200)) break;
            this.start_index = l;
            h.length > 100 && h[h.length - 1].id != k.chat_list[o - 1].id ? (d == "End" && (d = !1), this.has_new = !0) : this.has_new = !1;
            ...
            var t = 0;
            g.smoothScroll && (t = g.sendingId ? 70 : 200);
            n = !1;
            h = i;
            if (CW.last_timeline_buildkey != h) {
            ...
            } else d && (A = this, w = $("#_messageId" + d), w.length && (n = !0, $C("#_timeLine").scrollTo(w, t, function() {
                g.highlight && A.highlight(w);
                g.jumpToCallback()
            })));
            k.has_old && !n && setTimeout(function() {
        ...
        getTimeLine: function(a, f) {
            for (var g =
                $.extend({
                    ...
                    selectId: !1,
                    idPrefix: ""
                }, f), i = "", j = "", k = 0, h = a.length; k < h; k++) {
                var m = {
                        idPrefix: g.idPrefix
                    },
                    l = a[k];
                if (ST.data.show_delmessage == 0 && l.msg == "[deleted]") i += '<div id="_messageId' + l.id + '"></div>';
                else {
                    var o = CW.getDate(l.tm, ST.data.dateformat);
                    if (j != o) j = o, e = 0, m.topView = !0, i += '<div class="dateHead"><div class="dateContent"><span class="icoFontClock"></span><span class="dateText">' + o + "</span></div></div>";
                    e == l.aid ? m.showSender = !1 : e = l.aid;
                    if (g.unreadFrom !== !1 && k >=
                        g.unreadFrom) m.showUnreadMark = !0;
                    if (g.readLock) m.readLock = !0;
                    if (g.editId && g.editId == l.id) m.editView = !0;
                    if (!g.selectId) g.selectId = b;
                    if (g.selectId && g.selectId == l.id) m.selectView = !0;
                    i += this.getMessagePanel(l, m)
                }
            }
            return i
        },
        ...
        getMessagePanel: function(a, b) {
            var e = this.model,
                ...
                k = "",
                h = "",
                m = "_message chatTimeLineMessage chatTimeLineMessageAnim clearfix",
                l = "";
            i.showSender && (j = '<div class="_speaker avatarSpeaker">' + CW.getAvatarPanel(a.aid, {
                    size: "medium"
                }) + "</div>", k = CW.getName(a.aid), h = '<p class="chatNameOrgname">' + CW.getOrgName(a.aid) + "</p>", i.topView || (m += " chatTimeLineBorder"));
            var o = "";
            i.showUnreadMark && (o = a.sid ? '<span class="_sendingMessage"><img src="./imagenew/all/common/loader/img_loader_white.gif" ald="Loading"/></span>' :
                i.readLock ? '<span class="_unreadMark unreadTimeLine unreadTimeLineLock"></span>' : '<span class="_unreadMark unreadTimeLine"></span>');
            var q = "",
                u = L.chat_edited_log;
            a.aid == AC.myid && (m += " chatTimeLineMessageMine");
            var n = 0;
            a.msg == "[deleted]" ? (n = 1, q = '<div class="_delete messegeDelete">' + L.chat_deleted + "</div>") : a.msg == "[deleted_by_admin]" ? (n = 1, q = '<div class="_delete messegeDelete">' + L.chat_deleted_by_admin + "</div>") : q = CW.renderMessage(a.msg, {
                mid: a.id
            });
            n && (l += ' data-deleted="1"');
            var x = i.showSender ? CW.getDate(a.tm,
                ST.data.dateformat_short + " H:i") : CW.getDate(a.tm, "H:i");
            a.utm > 0 && (x += ' <span class="icoFontActionEdit icoSizeSmall"></span>');
            a.mn && (m += " chatTimeLineMessageMention");
            u = "";
            i.editView && (m += " chatTimeLineMessageEdit", u = '<div class="chatTimeLineMessageEditText">' + L.chat_editing_label_on_message + '<span class="_editCancel closeAction icoFontCancel massageEditCancel"></span></div>');
            var t = "";
            i.selectView && (m += " _messageSelected chatTimeLineMessageMove", t = '<span class="icoFontMessegeMoveArrow icoSizeLarge"></span><span class="icoTextHide">\u79fb\u52d5\u3057\u305f\u30c1\u30e3\u30c3\u30c8</span>');
            e = a.rid ? a.rid : e.room.id;
            n = ' data-deleted="' + n + '" data-tm="' + a.tm + '"';
            a.utm && (n += ' data-utm="' + a.utm + '"');
            return '<div id="' + i.idPrefix + "_messageId" + a.id + '" data-rid="' + e + '" data-mid="' + a.id + '" class="' + m + '"' + l + '><div class="_chatTimeLineMessageBox chatTimeLineMessageInner">' + j + '<div class="chatTimeLineMessageArea clearfix"><div class="chatTimeLineItemHeader autotrim"><p class="_speakerName chatName">' + k + "</p>" + h + "</div><pre>" + q + '</pre></div><div class="_timeStamp timeStamp"' + n + ">" + o + x + "</div>" + u + '</div><div class="_moveArrow chatTimeLineMoveArrow selected">' +
                t + "</div></div>"
        },
    ...
    TaskListView.prototype = {
        build: function() {
            ...
            if (g > 0) {
                TK.sortTaskList(f);
                for (d = 0; d < g; d++) {
                    var i = TK.task_id2task_dat[f[d]];
                    if (!a || i.aid == AC.myid) this.task_num++, this.task_num <= this.view_limit && (e += TK.view.getTaskPanel(i, {
                        type: "tasklist"
                    }))
                }
                d = e
            ...
            this.task_num > 0 ? (this.view_limit <= this.task_num ? $C("#_roomTaskNum").show().text(L.task_num.replace("%%num%%", number_format(this.view_limit))) : $C("#_roomTaskNum").show().text(" (" + number_format(this.task_num) + ")"), $C("#_roomTaskAll").show()) :
                ($C("#_roomTaskNum").hide(), $C("#_roomTaskAll").hide());
            RS.showPromotion()
        }
    }
})();
...
function RoomDialogView(b) {
    ...
    a.link_code_checker = {
        ...
        validate: function(b, d) {
            ...
            if (e != this.last_checked_link_name) {
                ...
                e ? e.length > 50 ? (i.hide(), j.text(L.error_maxlength.replace("%%length%%", 50)).css("color", "red"), a.is_valid_link_name = !1) : e.match(/^[-_a-zA-Z0-9]+$/) ? (i.show(), j.text(""), this.type_timer = setTimeout(function() {
                    i.show();
                    CW.get("gateway.php", {
                    ...
                    (i.hide(), j.text(L.error_invalidchar).css("color", "red"), a.is_valid_link_name = !1) : (i.hide(), j.text(""), f.attr("data-clipboard-text", ""), a.is_valid_link_name = !1)
            }
        }
    };
            ...
            open: function(d) {
                if (d) {
                    ...
                    var g = e + f,
                        ...
                        k = h.find(".js_invitationLinkDisplayInput"),
    ...
    a.buildMember = function(b, d) {
        ...
        l && (k = CW.splitWithSpace(l), k = k.map(function(a) {
            return a.toLowerCase()
        }));
        for (l = 0; l < b.length; l++) {
            var m = b[l],
                v = [];
            if (Object.keys) v = Object.keys(j[m]);
            else
                for (var B in j[m]) v.push(B);
            Room.prototype.sortMember(v);
            var E = d.find("._memberTable" + ucfirst(m));
            E.quickEmpty();
            var z = "",
                F =
                    v.length;
            200 < F && $("#_roomInfoShowLimitNum" + ucfirst(m)).text(L.chatroom_show_limit_member_num.replace("%%num%%", 200));
            for (var y = 0; y < F; y++) {
                var D = v[y];
                if (m == "member") {
                    if (!(k.length > 0) || AC.isMatchedWithKeyList(k, D)) {
                        h++;
                        if (h > 200) break;
                ...
                } else if (!(e && AC.getGroupId(D) !== f) && (!(k.length > 0) || AC.isMatchedWithKeyList(k,
                        D))) {
                    i++;
                    if (i > 200) break;
                    var K = !!a.checked_flag[D],
                        H;
                    H = K ? "_memberTableIndividualRole" : "_memberTableIndividualRole isHide";
                    var I = a.common_role;
                    a.adding_member_list[D] && (I = a.adding_member_list[D]);
        ...
        /\sMSIE\s*([89]|10)\./i.test(navigator.userAgent) ? E.html(z) : E.get(0).innerHTML = z;
            m === "contact" && a.updateCheckBoxAll(d)
        }
    ...
    a.openAddRoomDialog = function() {
        ...
        j || (a.prepareRoomIconTooltip(), j = $("#_addRoom").cwDialog({
            ...
            open: function(d) {
                ...
                })), CW.is_business || $("#_roomInfoOrganizationFilter").hide(), $("#_addRoomInvitationLinkEditor").hide(), $("#_addRoomInvitationLinkSettingStatus").cwCheckBox().check(), $("#_addRoomInvitationLinkJoinNeedAccept").cwCheckBox().check(),
                    b(function(a) {
    ...
    a.editRoomMember = function(b) {
        m || (m = $("#_roomMemberEditDialog").cwDialog({
    ...
    a.addRoomMember = function(b) {
        ...
        l || (l = $("#_roomMemberAdditionDialog").cwDialog({
            ...
            open: function(b) {
                if (b) {
                    ...
                    CW.is_business || $("#_memberAdditionOrganizationFilter").hide();
                    a.prepareRoomDat(b);
                    ...
                    h.val(k);
                    f.val(j);
                    g.attr("data-clipboard-text", k).text(L.invitation_link_code_copy);
...
function RoomSubView(b) {
    ...
    a.prepare = function() {
        ...
        $("#_groupCall").click(function() {
            ...
            AL.trackEvent("message_input", "open", "chatwork_live_dialog")
        });
        ...
        var f = ["invitation_link_setting", "room_permission_setting", "same_member_addchat", "hr", "leave_room", "delete_contact",
            "delete_room"
        ];
                ...
                if (!RM || !RM.id) CW.alert(L.error_no_select);
                    ...
                    switch (a) {
                        ...
                        case "same_member_addchat":
                            ...
                            e ? CW.confirm(L.chatroom_createchat_same_members_confirm,
                                function() {
                                    setTimeout(function() {
                                        d()
                                    })
    ...
    var d = "hide";
    a.getCurrentPromotionSize = function() {
        return d
    };
    var f = function() {
        if (RM.tasklist.view.task_num > 0) return "hide";
        ...
        var a = RM.description;
        if (a === !1) return null;
        else if (a === "") return "double";
        return "single"
    };
    a.showPromotion = function() {
        var b = f();
        if (b === "hide") a.hidePromotion();
        else if (b !== null) b === d ? (b = RM.id, b != e && (e = b, a.refreshPromotion())) : b === "double" ? a.showDoubleSizePromotion() : b === "single" && a.showSingleSizePromotion()
    };
    ...
    a.showDoubleSizePromotion = function() {
        d = "double";
        j(g)
    };
    a.showSingleSizePromotion = function() {
        d = "single";
        j(i)
    };
    ...
    a.prepareTask =
        function() {
            m = $C("#_taskNameInput").focus(function() {
                a.expandTaskArea(!0);
                a.openFold();
            ...
            h = $("#_taskAssignList").cwListTip({
                ...
                update: function() {
                    b === null && (b = setTimeout(function() {
                        for (var a = h.getVal(), d = "", e = a.length, f = 0; f < e; f++) {
                            var g = a[f];
                            d += '<div class="assignContent assignMember"><span class="_taskAssignMemberLabel assignContentText" data-aid="' + g + '">' + CW.getName(g) + '</span><span class="_taskAssignCancel assignContentCancel" data-aid="' +
                                g + '"><span class="icoFontCancel"></span><span class="icoTextHide">' + L.button_delete + "</span></span></div>"
                        }
            ...
            var e = $("#_taskAssignQuickList").cwToolTip({
                offsetTop: 7,
                open: function() {
            ...
            e.$el.on("click", "._avatar", function() {
                var a = $(this).attr("data-aid");
                h.select(a)
            ...
            $("#_taskQuickWrapper").on("mouseenter", function() {
                !e.isOpen() && !h.isOpen() && e.open($C("#_taskAssignAddArea"))
            });
            ...
            $("#_taskAddButton").click(function() {
                if (RM.id) {
                    if (!RM.view.disabled_send) {
                        var b = rtrim(m.getVal());
                        if (b.length != 0) {
                            room_id = RM.id;
                            var d = $C("#_limitButton").cwDatePicker(),
                                e = d.getVal(),
                                f = a.getTaskAssignList();
                            f.length ? (task_data = b + "|" + f.join(",") + "|" + e, k != task_data && (k = task_data, m.setVal(""),
                                a.clearTaskAssign(), d.setVal(""), b = CS.convertToSend(b), a.model.addTask(room_id, b, e, f, function() {
                                a.initTaskArea();
                                latest_chat = k = ""
                            }, function(g) {
                                g ? CW.alert(g) : CW.alert(L.chatsend_error_send_task);
                                latest_chat = k = "";
                        ...
                        if (g != AC.myid) {
                            ...
                            d.push({
                                ...
                                label: CW.getAvatarPanel(g, {
                                    clicktip: !1,
                                    size: "small"
                                }) + '<p class="autotrim">' + escape_html(h) +
                                "</p>"
                            })
                        }
                    }
    ...
    a.toggleFold = function() {
        if (!l) {
            AL.trackEvent("message_input", "click", "toggle_fold_room_sub");
            var b = $("#_chatContent"),
                d = b.css("right"),
    ...
    a.prepareGroupCall = function() {
        ...
        $C("#_groupCallMember").on("cwCheckBox_update", function(a, b, d) {
            b ? o.data.select_flag[d] = b : o.data.select_flag[d] && delete o.data.select_flag[d]
        });
        $("#_videoChatContactFilter").cwSearchBox({
            update: function() {
                var a = o.data.select_flag,
                    b = [],
                    d = RL.rooms[o.data.room_id],
                    e = this.getVal(),
                    f = "",
                    g;
                for (g in d.member_dat)
                    if (g !=
                        AC.myid) {
                        var h = AC.account_dat[g].nm.toLowerCase();
                        e && h.indexOf(e.toLowerCase()) === -1 || b.push(g)
                    }
                $C("#_groupCallMember").quickEmpty();
    ...
    a.buildMember = function(a) {
        var b = RL.rooms[a];
        if (!b) return this;
        for (var d = b.getSortedMemberList(), e = d.length, f = TM.member_preview_show_max, g = "", h = TM.member_detail_show_max, i = {
            admin: "",
            member: "",
            readonly: "",
            nocontact: "",
            ...
            var m = d[l],
                o = b.member_dat[m];
            j[o] < h && (i[o] += CW.getAvatarPanel(m, {
                size: "small"
            }));
            l < f && (g += '<li class="chatRoomMemberListItem" role="listitem" aria-label="' +
                escape_html(AC.getName(m)) + '">' + CW.getAvatarPanel(m) + "</li>");
            j[o]++;
            k == "group" && !AC.isContact(m) && (AC.myrequest_dat[m] ? (j.requested < h && (i.requested += CW.getAvatarPanel(m, {
                size: "small"
            })), j.requested++) : (j.nocontact < h && (i.nocontact += CW.getAvatarPanel(m, {
                size: "small"
            })), j.nocontact++))
        }
        ...
        for (l = a.length; d < l; d++)
            if (m = a[d], o = m.key, i[o]) {
                var y = "subContentMemberGroup";
                m.boxClass != void 0 && (y += " " +
                    m.boxClass);
                b += '<div class="' + y + '">';
                m.label && (b += '<div class="subContentGroupInner"><div class="memberListLabel">' + m.label + "\uff1a</div><div>" + i[o]);
                j[o] > h && (b += '<a class="_showMoreMember showMoreMember" data-role="' + o + '">' + L.chatroom_member_rest_number.replace(/%%rest_number%%/, number_format(j[o] - h)) + "</a>");
                m.label && (b += "</div></div>");
                m.after && (b += m.after);
                b += "</div>"
            }
        k === "contact" ? ($C("#_subRoomMemberNum").hide(), $C("#_subRoomMemberList").hide(), q = "") : ($C("#_subRoomMemberNum").show().text(" (" +
            number_format(e) + ")"), $C("#_subRoomMemberList").html(g).show(), q = b);
        RM.member_dat[AC.myid] === "admin" && (q += '<div><a id="_memberDetailEditMember">' + L.member_detail_edit_member_label + "</a></div>");
        return this
    };
    a.setTask = function(b, d, e, f, g) {
        b ? (a.expandTaskArea(!1), f ? m.setVal(m.getVal() + b) : m.setVal(b)) : m.setVal(b);
        g && m.focus();
...
function ChatSendView(b) {
    ...
    a.prepare = function() {
        ...
        $("#_emoticon").click(function() {
            AL.trackEvent("message_input", "open", "emoticon_balloon");
            u || a.prepareEmoticon();
            u.open($(this))
        });
        ...
        SERVICE_PLAN === "free" ? ($("#_mainContentExpandRight").hide(),
            $(".chatSendAreaContent").css("margin-right", "4px")) : $("#_mainContentExpandRight").click(function() {
            RS.view.toggleFold()
        });
    ...
    a.prepareTimeLine = function() {
        var b = $("#_timeLine,#_messageSearchResult,#_taskDetailTimeLine,#_replyMessageTip"),
            ...
            g = {
                ...
                edit: function(b) {
                    ...
                    AL.trackEvent("message_action", "click", "edit_message_action")
                },
                task: function(a) {
                    this.$el.parents("#_messageSearchResultBox").length ? AL.trackEvent("message_search", "click",
                        "task_in_message_search") : AL.trackEvent("message_action", "click", "task_action");
                ...
                unread: function(a) {
                    AL.trackEvent("message_action", "click", "unread_message_action");
                    var b = RM;
                    CW.get("gateway.php", {
                        cmd: "read",
                        room_id: b.id,
                ...
                link: function(b) {
                    this.$el.parents("#_messageSearchResultBox").length ? AL.trackEvent("message_search", "click", "message_link_in_message_search") : AL.trackEvent("message_action", "click", "message_link_action");
                ...
                "delete": function(b) {
                    ...
                    if (d) {
                        ...
                        $("#_plainDialogBody").html('<div class="deleteContent"><p class="deleteLabel">' + L.chatsend_delete_filetip +
                            '</p><span class="deleteMeta">' + escape_html(f.fn) + "</span></div>");
                        var g = !1;
                            ...
                            buttonClick: function(e) {
                                ...
                                switch (e) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        a.model.deleteChat(b, RM.id), f.close()
                                }
                            }
                        }).open()
                    } else if (e) {
                        ...
                        if (i > 0) {
                            ...
                            $("#_plainDialogBody").html('<div class="deleteContent"><p class="deleteLabel">' + L.chatsend_delete_tasktip + '</p><pre><div class="deleteMeta">' +
                                j + "</div></pre></div>");
                            f = $("#_plainDialog");
                            f.cwDialog({
                                ...
                                buttonClick: function(d) {
                                    switch (d) {
                                        case 1:
                                            ...
                                            break;
                                        case 2:
                                            a.model.deleteChat(b, RM.id), this.close()
                                    }
                                }
                            }).open();
                            f.scrollTop(0)
                ...
                copy: function(a) {
                    AL.trackEvent("message_action", "click", "copy_message_action");
                    var b = RM.timeline.chat_id2chat_dat[a];
                ...
                move: function(a) {
                    AL.trackEvent("message_search", "click", "message_jump_in_search");
                    var b = this.findItemById(a).attr("data-rid");
                    b && a && RL.selectRoom(b, a)
                },
                quote: function(b) {
                    this.$el.parents("#_messageSearchResultBox").length ? AL.trackEvent("message_search", "click", "quote_in_message_search") : AL.trackEvent("message_action", "click", "quote_action");
                    var e = RM.timeline.chat_id2chat_dat[b];
        ...
        for (var h = ["reply", "quote", "task", "edit", "link", "copy", "unread", "delete"], j = 0, k = h.length; j < k; j++) {
            var l = h[j],
                m = ucfirst(l);
            q.addAction(l, {
        ...
        for (var o = f.cwActionBar({
                ...
                descriptionDelay: TM.messagetip_delay
                 ...
                 h = ["quote", "task", "move", "link"], j = 0, k = h.length; j < k; j++)(function() {
            var a = h[j],
                b = ucfirst(a);
            o.addAction(a, {
        ...
        b.on("mouseover", "._timeStamp", function() {
            ...
            function() {
                n || (n = $("#_showMoreAssignMemberTip").cwListTip({
                    search: !0,
                    useHtmlLabel: !0,
                    multiSelect: !1,
                    selectable: !1,
        ...
        e.scroll(function() {
            RM.timeline && (e.scrollTop() < 10 && (RM.timeline.has_old ? RM.timeline.loadOld() : RM.timeline.build({
                everScroll: !0
            })), RM.timeline.view.has_new && $("#_messageIdEnd").offset().top < i.offset().top + 50 && RM.timeline.build({
                everScroll: !0
            }))
        ...
        var M = 0,
            ...
            r = function(a, b) {
                ...
                f ? (M = e.id, p = f.id, d = e.timeline.view.getMessagePanel(f, {
                    idPrefix: "replyTip"
                }), $C("#_replyMessageTipContent").html(d), d = '<div class="tooltipFooter"><div class="_replyMoveButton _roomLink button" data-rid="' + M + '" data-mid="' + p + '">' + L.jump_to_message + "</div></div>", $C("#_replyMessageButtonArea").html(d).show()) : e ?
        ...
        $("#_quotePartlyToMessage").click(function() {
            AL.trackEvent("message_action", "click", "part_message_quote_action");
            $C("#_quoteTip").cwToolTip().close();
            a.setChatText(u, !0);
            d.focus()
        });
        $("#_quotePartlyToTask").click(function() {
            AL.trackEvent("message_action", "click", "part_task_quote_action");
            $C("#_quoteTip").cwToolTip().close();
    ...
    a.prepareSendArea = function() {
        ...
        $("#_sendEnterAction").cwCheckBox({
            update: function() {
                AL.trackEvent("message_input", "open", "message_enter_action");
                var a = !1;
                if (this.isChecked()) {
        ...
        $C("#_sendButton").click(function() {
            a.sendMessage();
            AL.trackEvent("message_input", "click", "send_message")
        }).keydown(function(b) {
    ...
    a.getTextSelection = function() {
        function a(b) {
            return $(b).contents().map(function() {
                ...
                if (this.nodeType ===
                    1 && this.nodeName.toLocaleLowerCase() === "img") return this.getAttribute("alt") || "";
    ...
    a.prepareEmoticonImage = function() {
        for (var a = "", b = 0; b < CW.emoticon.length; b++) {
            var d = CW.emoticon[b];
            a += '<li><img src="image/emoticon/' +
                d.src + '" title="' + d.title + '" alt="' + d.key + '"/></li>'
        }
    ...
    a.prepareTo = function() {
        var b = $("#_toList").cwListTip({
            ...
            select: function(b) {
                ...
                CW.view.key.shift || CW.view.key.ctrl ?
                    this.searchbox.$el.focus() : (this.close(), d.focus())
            }
        });
        $("#_to").click(function() {
            b.open($(this));
            AL.trackEvent("message_input", "open", "to_balloon")
        });
    ...
    a.prepareSendFile = function() {
        ...
        if (_has_fileapi) {
            $("#_file").click(function() {
                AL.trackEvent("message_input", "click", "upload_file");
                ...
                $("#_fileFrame").on("load", function() {
                    try {
                        ...
                        if (a.length > 0) {
                            var a = a.match(/\{.+\}/)[0],
                                d = $.parseJSON(a);
                            d.result.is_storage_limit != void 0 ? CW.showStorageLimitDialog("file") : !d.status.success &&
                            d.status.message ? CW.alert(d.status.message) : d.status.success == !0 && (FL.updateStorageInfo(d.result.storage, d.result.storage_limit, d.result.limit_time, d.result.is_limit), CW.watch())
                        } else throw "error";
                    } catch (f) {
                        if (b)
                            if (e++, e > 1) a = L.upload_cancel_send_message.replace(/%%size%%/g, bytename(FL.storage.available)), d = "", CW.plan == "free" ? (a += L.storage_cancel_send_object_suffix_upgrade, d = L.storage_cancel_upgrade_label) : CW.is_business && !CW.is_admin ? (a += L.storage_cancel_send_object_suffix_tell_admin, $("#cw_upload_error_button").hide()) :
                                (a += L.storage_cancel_send_object_suffix_add_storage, d = L.storage_cancel_add_storage_label), $("#cw_upload_error_body").html(a), $("#cw_upload_error_link").val(d), $("#cw_upload_error_dialog").dialog("open");
                            else {
                                setTimeout(function() {
    ...
    a.chatTextKeyDown = function(b) {
        ...
        h = typeof b.modifiers ==
        "undefined" ? b.shiftKey : b.modifiers & Event.SHIFT_MASK;
        m = typeof b.modifiers == "undefined" ? b.altKey : b.modifiers & Event.ALT_MASK;
        l = typeof b.modifiers == "undefined" ? b.metaKey : b.modifiers & Event.META_MASK;
        press_key = b.keyCode;
        if (press_key == 38) {
        ...
        if (ST.data.enter_action == "send") {
            if (press_key == 13)
                if (!h && !k && !m && !l) return b.preventDefault(), !1;
                else if (l) return a.chatTextKeyUp({
                    keyCode: 13
                }), b.preventDefault(), !1
        } else if (press_key == 13 && (k || h || m || l)) return l && a.chatTextKeyUp({
            keyCode: 13
        }), b.preventDefault(), !1;
    ...
    a.chatTextKeyUp = function(b) {
        ...
        if (up_key == 13 && press_key == 13)
            if (ST.data.enter_action == "send") !h && !k && !m && !l ? a.sendMessage() : (k || m || l) && d.insertAtCaretForMessage("\n");
            else if (k || h || m || l) return a.sendMessage(), !1;
        (function() {
            if (!(up_key !== 13 || press_key !== 13)) {
                var a = d.val(),
    ...
    a.expandChatArea = function(b) {
        RM && RM.id != n && (n = !RM.view.disabled_send && b ? RM.id : 0, a.resizeChatArea(!0))
    };
    var x = TM.timeline_min_height,
        t = TM.chattext_min_content_height,
        A = TM.chatSendArea_expandto_height_default,
        w = TM.chatSendArea_initial_height;
    ...
    a.resizeChatArea = function(a) {
        ...
        k < t && (k = t);
        if (!a && s == k) d.height(e), h != 0 && j.scrollTop(h);
        else {
            var l = f.outerHeight(),
            ...
            a || b != o ? (d.height(o - m - l - r), a = i.outerHeight(), a = q - p - a, b = $C("#_timeLine"), e = b.height(), l = b.scrollTop(), b.height(a), b.scrollTop(l + (e - a))) : d.height(e);
            s < k ? j.scrollTop(h + 30) : j.scrollTop(h);
            s = k
        }
    };
...
function SearchView(b) {
    ...
    a.prepareGlobalSearch = function() {
        ...
        var g = "",
            i = function(i) {
                var l = f.getVal();
                l.length > 0 || i ? (g != l && a.buildResult(l), g = l, d || ($C("#_searchResultChatList").find("._room").removeClass("searchResultChatListFocus"), $.cwFloatBox.close(), $.cwFloatBox.open(b, function() {
                    d = !1;
                    e = 0
    ...
    a.prepareMessageSearch = function() {
        ...
        i = $("#_messageSearchContent").cwFloatWindow({
        ...
        $("#_messageSearchOption").click(function() {
            ...
            a.isVisible() ? (AL.trackEvent("message_search", "click", "message_search_option", 1), a.slideUp("fast", function() {
                i.resize()
        ...
        $("#_messageSearchQuery").keydown(function(a) {
            ...
            m == a.keyCode && a.keyCode == 13 && ($C("#_messageSearchSend").click(), $.cwFloatBox.close())
        });
        $C("#_messageSearchSend").click(function() {
            ...
            if (!f.data("_searchMessage_doubleClick")) {
                ...
                if ($("#_messageSearchOptionArea").isVisible())
                    if (i.exq = $C("#_messageSearchExceptWord").val(), i.aid = g.getVal(), i.term = $("#_messageSearchTerm").cwSelectBox().getVal(), i.term == "specify") {
                        var d = $C("#_messageSearchDateFrom").val(),
                            m = $C("#_messageSearchDateTo").val();
                        if (d != "") i.term_from = strtotime_format(d, ST.data.dateformat);
                        if (m != "") i.term_to = strtotime_format(m, ST.data.dateformat)
                    } else if (i.term !=
                        "all") d = strtotime_format(CW.getDate(time(), "Y-m-d"), "Y-m-d"), i.term_from = d - parseInt(i.term, 10) * 86400, i.term_to = d;
                $C("#_messageSearchResultHead").hide();
                $C("#_messageSearchLoading").show();
                SC.search(i, function(b) {
                    e(f);
                    a.msg_dat = b;
                    a.ms_result_timeline_list = [];
                    a.ms_result_byroom_dat = {};
    ...
    a.openMessageSearchWindow = function() {
        i || a.prepareMessageSearch();
        AL.trackEvent("message_search", "open", "message_search_window", 1);
        i.open()
    };
            ...
            if (i.isOpen()) {
                ...
                if (a.ms_result_timeline_list.length > 0) {
                    ...
                    switch (a.ms_result_type) {
                        case "byroom":
                            f.enableButtonAll();
                            for (var o = 0, g = a.ms_result_byroom_idx_list.length; o < g; o++)
                                for (var q = a.ms_result_byroom_idx_list[o], u = 0, n = a.ms_result_byroom_dat[q].length; u < n; u++) l.push(a.ms_result_byroom_dat[q][u]);
                            break;
                        case "byuser":
                            f.enableButtonAll();
                            o = 0;
                            for (g = a.ms_result_byuser_idx_list.length; o <
                            g; o++) {
                                q = a.ms_result_byuser_idx_list[o];
                                u = 0;
                                for (n = a.ms_result_byuser_dat[q].length; u < n; u++) l.push(a.ms_result_byuser_dat[q][u])
                            }
                            break;
                        default:
                            f.disableButtonAll(), l = a.ms_result_timeline_list
                    }
                    g = l.length;
                    u = {
                        idPrefix: "_search"
                    ...
                    for (o = 0; o < g; o++) {
                        ...
                        switch (a.ms_result_type) {
                            case "byroom":
                                if (m != n.rid) m = n.rid, o > 0 && (e += "</div>"), e += '<div class="searchResultTitle _messageSearchChatGroup" data-gid="' + n.rid + '">' + RL.rooms[n.rid].getIcon() + " " + escape_html(RL.rooms[n.rid].getName()) + " <span>(" + number_format(a.ms_result_byroom_dat[n.rid].length) +
                                    L.search_result_unit + ')</span><span class="_messageSearchArrow transitionAll03sLinear icoFontTriangleDown"></span></div><div id="_searchResultGroupId' + n.rid + '" style="display:none">';
                                break;
                            case "byuser":
                                if (m != n.aid) m = n.aid, o > 0 && (e += "</div>"), e += '<div class="searchResultTitle _messageSearchChatGroup" data-gid="' + n.aid + '">' + CW.getAvatarPanel(n.aid, {
                                        clicktip: !1,
                                        hovertip: !1,
                                        size: "small"
                                    }) + " " + CW.getName(n.aid) + " <span>(" + number_format(a.ms_result_byuser_dat[n.aid].length) + L.search_result_unit + ')</span><span class="_messageSearchArrow transitionAll03sLinear icoFontTriangleDown"></span></div><div id="_searchResultGroupId' +
                                    n.aid + '" style="display:none">'
                        }
                        u.topView = o === 0 ? !0 : !1;
                        e += TimeLineView.prototype.getMessagePanel(n, u)
                    }
                    switch (a.ms_result_type) {
                        case "byroom":
                            g > 0 && (e += "</div>");
                    ...
                    $C("#_messageSearchResultNum").text(number_format(l.length));
                    l.length == SEARCH_MAX_RESULTS && $C("#_messageSearchOverflow").show();
                    $C("#_messageSearchResult").html(e);
                    b = b.replace(/\u3000|,|\u3001|\u30fb/g, " ").split(" ");
                    for (o in b) e = b[o], e.charAt(0) == "+" && (e = e.substr(1)),
                        e = trim(e), e.length > 0 && $("#_messageSearchResult pre").markText(e, "searchEm")
    ...
    a.buildResult =
        function(b) {
            if (b == void 0 || b == "") $C("#_searchResultChatList").quickEmpty(), $C("#_messageSearchHint").text(""), $C("#_messageSearchIcon").hide();
            else {
                ...
                var d = RL.getSortedRoomList(),
                    ...
                    g = d.length;
                if (g) {
                    for (var i = [], i = CW.splitWithSpace(b.toLowerCase()), q = 0, u = 0; u < g; u++)
                        if (d[u] != void 0) {
                            var n = d[u],
                                f = RL.rooms[n];
                            if (!(a.search_type == "contact" && f.type != "contact")) {
                                if (f.type == "contact") {
                                    if (!AC.isMatchedWithKeyList(i,
                                            f.getAccountId())) continue
                                } else if (!CW.isMatchedWithKeyList(i, f.getName())) continue;
                                e += RL.view.getRoomItemPanel(n, {
                                    showOrg: !0,
                                    showPin: !1,
                                    showSelected: !1,
                                    showRequest: !1,
...
function TutorialView(b) {
    var a = this,
        ...
        g = $("#_addButton"),
        i = $("#_headerSearch"),
        j = $("#_subRoomTaskAddArea"),
        k = $("#_chatSendToolbar"),
        h = $("#_chatTextArea"),
        m = $("#_tutorialHeader"),
        l = $("#_tutorialMessage"),
        o = $("#_tutorialNextButton"),
        q = $("#_openContactWindow"),
        u = $("#_tutorialStep").cwToolTip({
            useFloatBox: !1
        }),
        n = {
            "#_content": "",
    ...
    a.handleStart = function() {
        f = e ? a.bobPhose1Scenario() : a.defaultScenario();
        $('<script src="//fast.wistia.com/assets/external/E-v1.js" async><\/script>').appendTo("body");
        x();
        t();
        if (e) o.on("click", a.handleNextStep);
        else o.cwButton({
            type: "primary",
            click: a.handleNextStep
        });
        A();
    ...
    a.handleNextStep = function() {
        a.getCurrentStep().finish();
        d++;
        a.play();
        AL.trackEvent("onboarding", "click", "onboarding_t" + d + "_2")
    };
    a.handleFinish =
        function() {
            a.getCurrentStep().finish();
            u.close();
            j.css("z-index", "auto");
            for (var b in n) $C(b).css("z-index", n[b]);
            $("#_expose").fadeOut("slow");
            AL.trackEvent("onboarding", "click", "onboarding_t4_2")
        };
    a.defaultScenario = function() {
        return [w, r, p, s]
    };
    a.bobPhose1Scenario = function() {
        return [w, p, s, v]
    };
    a.play = function() {
        a.getCurrentStep().start();
        $(".tutorialStepIndicator .circle").removeClass("active");
        $(".tutorialStepIndicator .circle").eq(d).addClass("active");
        f.length === d + 1 && (e ? (o.find(".label").text("\u4f7f\u3044\u306f\u3058\u3081\u308b"),
            o.off("click"), o.on("click", a.handleFinish)) : o.cwButton().setOption({
            type: "success",
            text: L.button_complete,
            click: a.handleFinish
        }))
    };
    ...
    var x = function() {
        ...
        t = function() {
            var b = function() {
                    AL.trackEvent("onboarding", "click", "onboarding_t" + (d + 1) + "_1");
                    var b = a.getCurrentStep();
                    $(b.video_id).children().click()
                },
                e = $("#_tutorialShowMovieButton");
            e.length > 0 && e.cwButton({
                type: "primary",
                click: b
            })
        },
        A =
            function() {
                $(".tutorialStepIndicator").html("").append(f.map(function() {
        ...
        w = {
            ...
            start: function() {
                ...
                m.text("\u30b0\u30eb\u30fc\u30d7\u30c1\u30e3\u30c3\u30c8\u306e\u4f5c\u6210\u306f\u3053\u3053\u304b\u3089\u3067\u304d\u307e\u3059");
                l.text(L.tutorial_addbutton);
                u.isOpen() || u.open(g)
            },
            finish: function() {
                g.css("z-index", "auto")
        ...
        r = {
            start: function() {
                ...
                l.text(L.tutorial_globalsearch);
                u.move(i)
            },
            finish: function() {
                i.css("z-index", "auto")
        ...
        p = {
            ...
            start: function() {
                ...
                k.css("z-index", TM.expose_zindex);
                h.css("z-index", TM.expose_zindex);
                m.text("\u30e1\u30c3\u30bb\u30fc\u30b8\u306e\u9001\u4fe1\u306f\u3053\u3053\u304b\u3089\u3067\u304d\u307e\u3059");
                l.text(L.tutorial_send_message);
                u.move(k)
            },
            finish: function() {
                k.css("z-index", "auto");
        ...
        s = {
            ...
            start: function() {
                j.css("z-index", TM.expose_zindex);
                m.text("\u30bf\u30b9\u30af\u306e\u4f5c\u6210\u306f\u3053\u3053\u304b\u3089\u3067\u304d\u307e\u3059");
                l.text(L.tutorial_add_task);
                u.move(j)
            },
            finish: function() {
                j.css("z-index", "auto")
        ...
        v = {
            ...
            start: function() {
                ...
                m.text("\u3053\u3053\u304b\u3089\u30b3\u30f3\u30bf\u30af\u30c8\u3092\u8ffd\u52a0\u3067\u304d\u307e\u3059");
                l.text("\u77e5\u308a\u5408\u3044\u30fb\u53d6\u5f15\u5148\u306e\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9\u3067\u62db\u5f85\u3057\u3066\u307f\u3066\u304f\u3060\u3055\u3044\u3002\u30c1\u30e3\u30c3\u30c8\u30ef\u30fc\u30af\u3092\u5229\u7528\u4e2d\u306e\u65b9\u306b\u306f\u30b3\u30f3\u30bf\u30af\u30c8\u7533\u8acb\u3001\u672a\u5229\u7528\u306e\u65b9\u306b\u306f\u65b0\u898f\u30e6\u30fc\u30b6\u30fc\u3068\u3057\u3066\u62db\u5f85\u3059\u308b\u3053\u3068\u304c\u3067\u304d\u307e\u3059\u3002");
                u.move(q)
            },
            finish: function() {
                q.css("z-index", "auto")
...
(function(b) {
    ...
    b.fn.scrollTo = function(d, f, g) {
        ...
        return this._scrollable().each(function() {
            function i(a) {
                k.animate(l, f, g.easing, a && function() {
                        a.call(this, d, g)
                    })
            }
            if (d != null) {
                ...
                switch (typeof h) {
                    ...
                    case "string":
                        ...
                        if (!h.length) return;
                    case "object":
                        if (h.is || h.style) m = (h = b(h)).offset()
                }
                b.each(g.axis.split(""), function(a, b) {
                    var d = b == "x" ? "Left" : "Top",
                        ...
                        A = j[t],
                        w = e.max(j, b);
                    m ? (l[t] = m[f] + (o ? 0 : A - k.offset()[f]), g.margin && (l[t] -= parseInt(h.css("margin" + d), 10) || 0, l[t] -= parseInt(h.css("border" + d + "Width"), 10) || 0), l[t] += g.offset[f] || 0, g.over[f] && (l[t] += h[b == "x" ? "width" : "height"]() * g.over[f])) : (d = h[f], l[t] = d.slice && d.slice(-1) == "%" ? parseFloat(d) / 100 * w : d);
                    g.limit && /^\d+$/.test(l[t]) &&
                    (l[t] = l[t] <= 0 ? 0 : Math.min(l[t], w));
                    !a && g.queue && (A != l[t] && i(g.onAfterFirst), delete l[t])
                });
                i(g.onAfter)
            }
        }).end()
    ...
    e.max = function(a, e) {
        var g = e == "x" ? "Width" : "Height",
            i = "scroll" + g;
        if (!b(a).is("html,body")) return a[i] - b(a)[g.toLowerCase()]();
        var g = "client" + g,
            j = a.ownerDocument.documentElement,
            k = a.ownerDocument.body;
        return Math.max(j[i], k[i]) - Math.min(j[g], k[g])
    }
})(jQuery);
(function(b) {
    ...
    var f = /\+/g,
        g = b.cookie = function(f, j, k) {
            if (j !== void 0) {
                k = b.extend({}, g.defaults, k);
                if (typeof k.expires === "number") {
                    var h = k.expires,
                        m = k.expires = new Date;
                    m.setDate(m.getDate() + h)
                }
                j = g.json ?
                    JSON.stringify(j) : String(j);
                return document.cookie = [g.raw ? f : encodeURIComponent(f), "=", g.raw ? j : encodeURIComponent(j), k.expires ? "; expires=" + k.expires.toUTCString() : "", k.path ? "; path=" + k.path : "", k.domain ? "; domain=" + k.domain : "", k.secure ? "; secure" : ""].join("")
            }
            for (var j = g.raw ? a : e, k = document.cookie.split("; "), h = f ? void 0 : {}, m = 0, l = k.length; m < l; m++) {
                var o = k[m].split("="),
                    q = j(o.shift()),
                    o = j(o.join("="));
                if (f && f === q) {
        ...
        if (e !== "undefined") {
            ...
            if (e === "object") {
                ...
                if (a.constructor === Date) {
                    ...
                    a < 100 && (a = "0" + a);
                    a < 10 && (a = "0" + a);
                    return '"' + j + "-" + g + "-" + i + "T" + e + ":" + k + ":" + h + "." + a + 'Z"'
                }
                if (a.constructor === Array) {
                    g = [];
                    for (i = 0; i < a.length; i++) g.push(b.toJSON(a[i]) || "null");
                    return "[" + g.join(",") + "]"
                }
                i = [];
                for (j in a) {
                    e = typeof j;
                    if (e === "number") g = '"' + j + '"';
                    else if (e === "string") g = b.quoteString(j);
                    else continue;
                    e = typeof a[j];
                    e === "function" || e ===
                    "undefined" || (e = b.toJSON(a[j]), i.push(g + ":" + e))
                }
                return "{" + i.join(",") + "}"
            }
        }
...
(function(b) {
    ...
    function f(f) {
        function K(a) {
            S++ || (T(), Q && (v[J] = {
                s: [a]
            }), W && (a = W.apply(f, [a])), d(I, f, [a, A, f]), d(M, f, [f, A]))
        }

        function H(a) {
            S++ || (T(), Q && a != w && (v[J] = a), d(U, f, [f, a]), d(M, f, [f, a]))
        }
        var f = b.extend({}, z, f),
            I = f.success,
            U = f.error,
        ...
        J = J.replace(/=\?(&|$)/, "=" + X + "$1");
        if (Q && (R = v[J])) R.s ? K(R.s[0]) : H(R);
        else {
            r[X] = e;
            G = b(t)[0];
            G.id = m + B++;
            Y && (G[i] = Y);
            F && F.version() < 11.6 ? (O = b(t)[0]).text = "document.getElementById('" + G.id +
                "')." + o + "()" : G[g] = g;
            if (y) G.htmlFor = G.id, G.event = l;
            G[q] = G[o] = G[u] = function(a) {
                if (!G[n] || !/i/.test(G[n])) {
                    try {
                        G[l] && G[l]()
                    } catch (b) {}
    ...
    var g = "async",
        ...
        r = window,
        p = b.Deferred,
        s = b("head")[0] || document.documentElement,
        v = {},
        B = 0,
        E, z = {
            callback: m,
    ...
    var a = function(b, d, f, g) {
        ...
        for (f = f.firstChild; f; f = f.nextSibling)
            if (f.nodeType == 1)(!g.skipClassName || !g.skipClassName.test(f.className)) && a(b, d, f, g);
                ...
                for (;;) {
                    var i = f.nodeValue.toLowerCase().indexOf(b);
                    if (i == -1) break;
                    var j = f,
                        k = g.tag,
                        h = i;
                    i += b.length;
                    var m = document.createTextNode(j.nodeValue.substring(0, h));
                    j.parentNode.insertBefore(m, j);
                    k = document.createElement(k);
                    k.appendChild(document.createTextNode(j.nodeValue.substring(h, i)));
                    j.parentNode.insertBefore(k, j);
                    j.nodeValue = j.nodeValue.substring(i);
                    k.className = d
                }
    };
...
window.Modernizr = function(b, a, e) {
    ...
    var g = {},
        ...
        x = {}.hasOwnProperty,
        t;
    t = typeof x !== "undefined" && typeof x.call !== "undefined" ? function(a, b) {
        return x.call(a, b)
    } : function(a, b) {
        ...
        var d = q.call(arguments, 1),
            e = function() {
                if (this instanceof e) {
                    ...
                    var f = new f,
                        g = b.apply(f, d.concat(q.call(arguments)));
                    if (Object(g) === g) return g;
                    return f
                } else return b.apply(a, d.concat(q.call(arguments)))
            };
        return e
    };
    j.svg = function() {
        return !!a.createElementNS && !!a.createElementNS(l.svg, "svg").createSVGRect
    };
    for (var A in j) t(j, A) && (u = A.toLowerCase(), g[u] = j[A](), o.push((g[u] ? "" : "no-") + u));
    g.addTest = function(a, b) {
        if (typeof a == "object")
            for (var d in a) t(a, d) && g.addTest(d, a[d]);
        else {
            a = a.toLowerCase();
            if (g[a] !== e) return g;
            b = typeof b == "function" ? b() : b;
            typeof !0 !== "undefined" && (i.className +=
                " " + (b ? "" : "no-") + a);
            g[a] = b
        }
        return g
    ...
    g.testStyles = function(b, d, e, f) {
        var g, h, j = a.createElement("div"),
            k = a.body,
            m = k || a.createElement("body");
        if (parseInt(e, 10))
        ...
        (k ? j : m).innerHTML += e;
        m.appendChild(j);
        if (!k) m.style.background = "", m.style.overflow = "hidden", h = i.style.overflow, i.style.overflow = "hidden", i.appendChild(m);
        b = d(j, b);
        k ? j.parentNode.removeChild(j) : (m.parentNode.removeChild(m), i.style.overflow = h);
        return !!b
    };
    g.prefixed = function(a, b, d) {
        return b ? f(a, b, d) : f(a, "pfx")
    };
    i.className = i.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + o.join(" "));
    return g
}(this, this.document);
(function(b, a, e) {
    function d(a) {
    ...
    function k(b, d, e, f, g, h, k) {
        function m(a) {
            if (!p && i(l.readyState) && (s.r = p = 1, !x && j(), l.onload = l.onreadystatechange = null, a))
                for (var e in "img" != b && o(function() {
                    w.removeChild(l)
                }, 50), B[d]) B[d].hasOwnProperty(e) &&
                B[d][e].onload()
        }
        var k = k || F.errorTimeout,
            l = a.createElement(b),
            p = 0,
            r = 0,
            s = {
        ...
        1 === B[d] && (r = 1, B[d] = []);
        "object" == b ? l.data = d : (l.src = d, l.type = b);
        l.width = l.height = "0";
        l.onerror = l.onload = l.onreadystatechange = function() {
            m.call(this, r)
        };
        n.splice(f, 0, s);
        "img" != b && (r || 2 === B[d] ? (w.insertBefore(l, A ? null : q), o(m, k)) : B[d].push(l))
    }

    function h(a, b, d, e, g) {
        return x = 0, b = b || "j", f(a) ? k("c" == b ? p : r, a, b, this.i++, d, e, g) : (n.splice(this.i++, 0, a), 1 == n.length && j()), this
    }
    ...
    var l = a.documentElement,
        ...
        n = [],
        x = 0,
        t = "MozAppearance" in l.style,
        A = t && !!a.createRange().compareNode,
        w = A ? l : q.parentNode,
        l = b.opera && "[object Opera]" == u.call(b.opera),
        l = !!a.attachEvent && !l,
        r = t ? "object" : l ? "script" : "img",
        p = l ? "script" : r,
    ...
    F = function(a) {
        function b(a) {
            var a = a.split("!"),
                ...
                g, h, i;
            for (h = 0; h < f; h++) i = a[h].split("="), (g = E[i.shift()]) && (e = g(e, i));
            for (h = 0; h < d; h++) e = v[h](e);
            return e
        }

        function h(a, f, g, i, j) {
            var k = b(a),
                l = k.autoCallback;
            k.url.split(".").pop().split("?").shift();
            k.bypass || (f && (f = d(f) ? f : f[a] || f[i] || f[a.split("/").pop().split("?")[0]]), k.instead ? k.instead(a, f, g, i, j) : (B[k.url] ? k.noexec = !0 : B[k.url] = 1, g.load(k.url, k.forceCSS || !k.forceJS && "css" == k.url.split(".").pop().split("?").shift() ? "c" : e, k.noexec, k.attrs, k.timeout),
            (d(f) || d(l)) && g.load(function() {
                m();
                f && f(k.origUrl, j, i);
                l && l(k.origUrl, j, i);
                B[k.url] = 2
                    ...
                    if (f(a)) g || (m = function() {
                        ...
                        if (Object(a) === a)
                            for (n in o = function() {
                                ...
                                return b
                            }(), a) a.hasOwnProperty(n) && (!g && !--o && (d(m) ? m = function() {
                                var a = [].slice.call(arguments);
                                l.apply(this, a);
                                I()
                            } : m[n] = function(a) {
        ...
        if (f(a)) h(a, 0, l, 0);
            ...
            for (j = 0; j < a.length; j++) k = a[j], f(k) ? h(k, 0, l, 0) : s(k) ? F(k) : Object(k) === k && i(k, l);
        else Object(a) === a && i(a, l)
    };
    ...
    b.yepnope.injectJs = function(b, d, e, f, h, k) {
        var m = a.createElement("script"),
            l, n, f = f || F.errorTimeout;
        m.src = b;
        for (n in e) m.setAttribute(n, e[n]);
        d = k ? j : d || g;
        m.onreadystatechange = m.onload = function() {
            !l && i(m.readyState) && (l = 1, d(), m.onload = m.onreadystatechange = null)
        };
        o(function() {
            l || (l = 1, d(1))
        }, f);
        h ? m.onload() : q.parentNode.insertBefore(m, q)
    };
    b.yepnope.injectCss = function(b, d, e, f, h, i) {
        ...
        h || (q.parentNode.insertBefore(f, q), o(d, 0))
    }
})(this, document);
...
(function(b) {
    ...
    var e, d = {
        ...
        z = function(a, e) {
            ...
            a && this.clip(a);
            typeof e !== "undefined" && (r("new ZeroClipboard(elements, options)", y.debug), z.config(e));
            this.options = z.config();
            if (typeof d.disabled !== "boolean") d.disabled = !E();
            if (d.disabled === !1 && d.outdated !== !0 && d.bridge === null) {
                ...
                if (!k) {
                    f = z.config();
                    f.jsModuleId = typeof h === "string" && h || typeof m === "string" && m || null;
                    var k = v(b.location.host, y),
                        l, o, n, p = [],
                        q = [],
                        t = [];
                    f.trustedOrigins && (typeof f.trustedOrigins === "string" ? q.push(f.trustedOrigins) : typeof f.trustedOrigins === "object" && "length" in f.trustedOrigins && (q =
                        q.concat(f.trustedOrigins)));
                    f.trustedDomains && (typeof f.trustedDomains === "string" ? q.push(f.trustedDomains) : typeof f.trustedDomains === "object" && "length" in f.trustedDomains && (q = q.concat(f.trustedDomains)));
                    if (q.length) {
                        l = 0;
                        for (o = q.length; l < o; l++)
                            if (q.hasOwnProperty(l) && q[l] && typeof q[l] === "string" && (n = s(q[l]))) {
                                if (n === "*") {
                                    t = [n];
                                    break
                                }
                                t.push.apply(t, [n, "//" + n, b.location.protocol + "//" + n])
                            }
                    }
                    t.length && p.push("trustedOrigins=" + encodeURIComponent(t.join(",")));
                    typeof f.jsModuleId === "string" && f.jsModuleId &&
                    p.push("jsModuleId=" + encodeURIComponent(f.jsModuleId));
                    f = p.join("&");
                    l = y.moviePath + (y == null || y && y.cacheBust === !0 && y.useNoCache === !0 ? (y.moviePath.indexOf("?") === -1 ? "?" : "&") + "noCache=" + (new Date).getTime() : "");
                    f = '      <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="global-zeroclipboard-flash-bridge" width="100%" height="100%">         <param name="movie" value="' + l + '"/>         <param name="allowScriptAccess" value="' + k + '"/>         <param name="scale" value="exactfit"/>         <param name="loop" value="false"/>         <param name="menu" value="false"/>         <param name="quality" value="best" />         <param name="bgcolor" value="#ffffff"/>         <param name="wmode" value="transparent"/>         <param name="flashvars" value="' +
                        f + '"/>         <embed src="' + l + '"           loop="false" menu="false"           quality="best" bgcolor="#ffffff"           width="100%" height="100%"           name="global-zeroclipboard-flash-bridge"           allowScriptAccess="' + k + '"           allowFullScreen="false"           type="application/x-shockwave-flash"           wmode="transparent"           pluginspage="http://www.macromedia.com/go/getflashplayer"           flashvars="' + f + '"           scale="exactfit">         </embed>       </object>';
    ...
    z.activate = function(a) {
        e && (n(e, y.hoverClass), n(e, y.activeClass));
        e = a;
        u(a, y.hoverClass);
        K();
        ...
        if (!(f = y.forceHandCursor === !0)) {
            a: {
                b.getComputedStyle ? f = b.getComputedStyle(a, null).getPropertyValue("cursor") : (f = o("cursor"), f = a.currentStyle ? a.currentStyle[f] : a.style[f]);
                if (!f || f === "auto")
    ...
    z.deactivate = function() {
        ...
        e && (n(e, y.hoverClass), n(e, y.activeClass), e = null)
    };
    var D = function(a) {
    ...
    z.prototype.on = function(a, b) {
        var e, f, g, h = {},
            j = i[this.id] && i[this.id].handlers;
        ...
        if (g && g.length) {
            e = 0;
            for (f = g.length; e < f; e++) a = g[e].replace(/^on/, ""), h[a] = !0, j[a] || (j[a] = []), j[a].push(b);
            h.noflash && d.disabled && H.call(this, "noflash", {});
            h.wrongflash && d.outdated && H.call(this, "wrongflash", {
                flashVersion: d.version
            });
            h.load && d.ready && H.call(this, "load", {
                flashVersion: d.version
            })
        }
        return this
    ...
    z.prototype.off = function(a, b) {
        var d, e, f, g, h, j = i[this.id] && i[this.id].handlers;
        ...
        if (g && g.length) {
            ...
            for (e = g.length; d < e; d++)
                if (a = g[d].toLowerCase().replace(/^on/, ""), (h = j[a]) && h.length)
                    if (b)
                        for (f = x(b, h); f !== -1;) h.splice(f, 1), f = x(b, h, f);
                    else j[a].length = 0
        }
        return this
    };
    z.prototype.handlers = function(a) {
        var b, d = null,
            e = i[this.id] && i[this.id].handlers;
        if (e) {
    ...
    z.prototype.clip = function(a) {
        for (var a = t(a), b = 0; b < a.length; b++)
            if (a.hasOwnProperty(b) && a[b] && a[b].nodeType === 1) {
                if (a[b].zcClippingId) x(this.id, k[a[b].zcClippingId]) === -1 && k[a[b].zcClippingId].push(this.id);
                ...
                d = i[this.id].elements;
                x(a[b], d) === -1 && d.push(a[b])
            }
        return this
    };
    z.prototype.unclip = function(a) {
        var b = i[this.id];
        if (b)
            for (var b = b.elements, d, a = typeof a === "undefined" ? b.slice(0) : t(a), e = a.length; e--;)
                if (a.hasOwnProperty(e) && a[e] && a[e].nodeType === 1) {
                    for (d = 0;
                         (d = x(a[e], b, d)) !== -1;) b.splice(d, 1);
                    var f = k[a[e].zcClippingId];
                    if (f) {
                        for (d = 0;
                             (d = x(this.id, f, d)) !== -1;) f.splice(d, 1);
                        f.length === 0 && (y.autoActivate === !0 && (d = a[e], f = q, d && d.nodeType === 1 && (d.removeEventListener ? d.removeEventListener("mouseover", f, !1) :
    ...
    z.detectFlashSupport = function() {
        r("ZeroClipboard.detectFlashSupport", y.debug);
        return E()
    };
            ...
            if (d) {
                ...
                if (e && y.autoActivate === !0) {
                    ...
                    if (e && e.nodeType === 1 && (g = e.zcClippingId) && k.hasOwnProperty(g))
                        if ((g = k[g]) && g.length) {
                            h = 0;
                            for (j = g.length; h < j; h++)(m = i[g[h]].instance) && m instanceof z && f.push(m)
                        }
                } else {
                    j = [];
                    m = B(i);
                    f = 0;
                    for (g = m.length; f < g; f++)(h = i[m[f]].instance) && h instanceof z && j.push(h);
                    f = j
                }
                g = 0;
                for (h = f.length; g < h; g++) H.call(f[g], d, b)
            }
        }
    };
    z.prototype.setHandCursor = function(a) {
        r("ZeroClipboard.prototype.setHandCursor", y.debug);
        a = typeof a === "boolean" ?
            a : !!a;
        F(a);
        y.forceHandCursor = a;
    ...
    z.prototype.reposition = function() {
        r("ZeroClipboard.prototype.reposition", y.debug);
        return K()
    };
    z.prototype.receiveEvent = function(a, b) {
        r("ZeroClipboard.prototype.receiveEvent", y.debug);
        if (typeof a === "string" && a) {
    ...
    z.prototype.setCurrent = function(a) {
        r("ZeroClipboard.prototype.setCurrent", y.debug);
        z.activate(a);
        return this
    };
    z.prototype.resetBridge = function() {
        r("ZeroClipboard.prototype.resetBridge",
            y.debug);
        z.deactivate();
        return this
    };
    z.prototype.setTitle = function(a) {
        r("ZeroClipboard.prototype.setTitle", y.debug);
    ...
    z.setDefaults = function(a) {
        r("ZeroClipboard.setDefaults", y.debug);
        z.config(a)
    };
    z.prototype.addEventListener = function(a, b) {
        r("ZeroClipboard.prototype.addEventListener", y.debug);
        return this.on(a, b)
    };
    z.prototype.removeEventListener = function(a, b) {
        r("ZeroClipboard.prototype.removeEventListener",
            y.debug);
        return this.off(a, b)
    };
    z.prototype.ready = function() {
        r("ZeroClipboard.prototype.ready", y.debug);
        return d.ready === !0
    };
    var H = function(g, h) {
        var g = g.toLowerCase().replace(/^on/, ""),
            j = h && h.flashVersion && a(h.flashVersion) || null,
            k = e,
            m = !0;
        switch (g) {
            case "load":
            ...
            case "datarequested":
                if (k) {
                    var l = k.getAttribute("data-clipboard-target");
                    (l = (l = !l ? null : document.getElementById(l)) ? l.value || l.textContent || l.innerText : k.getAttribute("data-clipboard-text")) && this.setText(l)
                }
                m = !1;
                break;
            case "complete":
                if (f)
                    for (var o in f) f.hasOwnProperty(o) && delete f[o];
                if (j = k) {
                    a: {
                        try {
        ...
        l = [this, h];
        if ((j = i[this.id] && i[this.id].handlers[g]) && j.length) {
            var p, r, s = k || this;
            o = 0;
            for (p = j.length; o < p; o++) {
                r = j[o];
                k = s;
                typeof r === "string" && typeof b[r] === "function" && (r = b[r]);
                if (typeof r === "object" && r && typeof r.handleEvent === "function") k = r, r = r.handleEvent;
                typeof r === "function" && A(r, k, l, m)
            }
        }
        return this
    };
    ...
    "object" && module.exports && typeof b.require === "function" ? (m = module.id || null, module.exports = z) : b.ZeroClipboard = z
})(function() {
    return this
}());
var C;
(function(b) {
    ...
    b.cwUI.addWidget = function(f, g, i, o) {
        b[f] = new k(f, g);
        if (o != void 0)
            for (var q in o) b[f][q] = o[q];
        e[f] = function() {
            this.widget_name = f
        };
        e[f].prototype = new j;
        for (q in i) e[f].prototype[q] = i[q];
        d[f] = function(a) {
            this.widget_name = f;
            this.widget_list = a
        };
        for (q in e[f].prototype)(function() {
            var a =
                q;
    ...
    b.cwFloatBox = {
        ...
        close: function(d, e) {
            ...
            if (i > 0) {
                if (d) {
                    var m;
                    if (d instanceof jQuery) m = [d];
                    else if (b.isArray(d)) m = d;
                    else return;
                    for (i -= 1; i >= 0; i--) {
                        for (var l = !1, o = 0, q = m.length; o < q; o++)
                            if (m[o][0] == a[i].obj[0]) {
                                l = !0;
                                break
                            }
                        e ? l ? h.push(a[i]) : k.push(a[i]) : l ? k.push(a[i]) : h.push(a[i])
                    }
                } else k = a;
                i = 0;
                for (m = k.length; i < m; i++) j = k[i], typeof j.callback == "function" && j.callback(), j.noanim ? (j.obj.hide(), j.obj.css("z-index", j.zindex)) : j.obj.fadeOut("fast", function() {
...
(function(b) {
    ...
    b.cwResize = {
        setHandle: function(g, i) {
            ...
            g.addClass(k).on("mousedown.cwResize", function(g) {
                a = !0;
    ...
    b.cwValidate = {
        File: {
            hasError: function(e, d) {
                ...
                d.onlyimage && (in_array(i, ["jpg", "png", "gif", "jpeg"]) || g.push(a.error_upload_image));
                    ...
                    f || (f = d.cwToolTip({
                        open: function() {
                            ...
                            for (var b = g.attr("data-cwui-ab-id"), e = "", f = 0, h = a.option.moreActionList.length; f < h; f++) {
                                var m = a.option.moreActionList[f],
                                    l = a.action_item[m];
                                e += '<li class="_cwABAction chatActionMore" data-cwui-ab-id="' + b + '" data-cwui-ab-type="' + m + '"><span class="' + l.iconClass + '"></span><span class="chatActiontext">' + l.label + "</li>"
                            }
        ...
        open: function(a) {
            ...
            if (a[0] != void 0 && this.latest_showed_jqObj[0] !=
                ...
                if (!b.data(e[0], "_cwABNavInit")) {
                    for (var d = '<ul role="toolbar" class="_messageActionNav cwTextUnselectable actionNav">', f = this.option.idKey ? a.attr(this.option.idKey) : "", g = 0, i = this.option.actionList.length; g < i; g++) {
                        var j = this.option.actionList[g],
        ...
        _create: function(a) {
            ...
            if (a.hasClass("_cwBB")) return !1;
                ...
                a.find("li").each(function() {
                    var a = b(this);
                    f.push(a.html());
                    d[i] = a.hasClass("._cwBBSelected") ? !0 : !1;
...
(function(b) {
    ...
    b.cwUI.addWidget("cwCheckBox", {
        ...
        create: function(a, e, d, f) {
            ...
            var i = '<span role="checkbox"',
                j = "_cwCB";
            a ? (j += " _cwCBChecked " + b.cwCheckBox._getClass("active", g), i += ' aria-checked="true"') : (j += " _cwCBUnchecked " + b.cwCheckBox._getClass("", g), i += ' aria-checked="false"');
    ...
    b.cwUI.addWidget("cwDatePicker", {
        ...
        _build: function() {
            ...
            for (var n = 1; n <= 6; n++) {
                q += "<tr>";
                for (var x = 0; x < 7; x++) {
                    n == 1 ? x < f ? (o = new Date(a, b - 1, x - f + 1), m = o.getFullYear(), l = o.getMonth() +
                        1, o = o.getDate()) : x == f ? (m = a, l = b, o = 1, u = !0) : o++ : o >= d ? (u = !1, l = new Date(a, b, 1), m = l.getFullYear(), l = l.getMonth() + 1, o = 1) : o++;
                    var t = "";
                    u ? m == this.now_year && l == this.now_month && o == this.now_day && (t = "datePickerToday") : t = "datePickerOtherMonth";
                    m == this.val_year && l == this.val_month && o == this.val_day && (t.length > 0 && (t += " "), t += "datePickerSelected");
                    q += '<td data-cwui-dp-date="' + m + "-" + l + "-" + o + '" class="' + t + '">' + o + "</td>"
                }
                q += "</tr>"
            }
    ...
    b.cwUI.addWidget("cwDialog", {
        ...
        _setOption: function(a) {
            ...
            if (this.option.buttonLabels != void 0 && (a.buttonLabels != void 0 || a.buttonSubmit != void 0 || a.buttonDelete != void 0 || a.buttonCancel != void 0)) {
                ...
                for (k = 0; k < e; k++) {
                    ...
                    l = b.cwUI.escapeHTML(this.option.buttonLabels[k]);
                    d += '<div role="button" aria-label="' + l + '" class="_cwDGButton' +
                        m + " button " + h + '" data-idx="' + k + '">' + l + "</div>"
                }
        ...
        open: function() {
            ...
            switch (this.option.height) {
                ...
                case "full":
                    ...
                    j = a.getMaxHeight();
                    k = this.option.height == "auto" ? d.innerHeight() + k + h : j;
                    h = 0;
        ...
        close: function() {
            if (this.is_open) return this.is_open = !1, typeof this.option.close == "function" && this.option.close.apply(this, arguments), b.cwFloatBox.closeUpperLayer(this.backbox), b.cwUI.unsetZIndex(this.backbox), this.backbox.fadeOut("fast",
                function() {}), e = [], b("#_cwDGBase").fadeOut("fast"), this
        },
        buttonClick: function(a) {
        ...
        resize: function() {
            ...
            if (a.val() === "" && !this.is_focused) a.css({
                ...
                if (this.option.maxHeight) {
                    var i;
                    i = typeof this.option.maxHeight === "function" ? this.option.maxHeight.apply(this) : this.option.maxHeight;
                    f > i && (i = f);
                    d > i && (d = i, g = !0)
                }
                a.height(d);
    ...
    b.cwUI.addWidget("cwFloatWindow", {
        ...
        _setOption: function(a) {
            ...
            if (this.option.buttonLabels != void 0 && (a.buttonLabels != void 0 || a.buttonSubmit != void 0 || a.buttonCancel)) {
                for (var a = "", e = this.option.buttonLabels.length, g = 0; g < e; g++) {
                    var i = "buttonGray",
                        j = "";
                    this.option.buttonSubmit != void 0 && this.option.buttonSubmit == g ? i = "btnPrimary" : this.option.buttonCancel != void 0 && this.option.buttonCancel == g && (j += " _cwFWButtonCancel");
                    var k = b.cwUI.escapeHTML(this.option.buttonLabels[g]);
                    a += '<div role="button" aria-label="' + k + '" class="_cwFWButton' + j + " button " + i + '" data-cwui-fw-idx="' + g + '">' + k + "</div>"
                }
        ...
        open: function() {
            ...
            if (this.is_open) f.scrollTop(0);
                ...
                var i = [];
                if (!g.allowOverlay)
                    for (var j in e) e[j].isOpen() && i.push(j);
                g = function() {
                    for (var b = i.length; b--;) e[i[b]].close();
                    a.resize();
        ...
        resize: function() {
            ...
            var e = this.finner.find("h1").outerHeight(),
                ...
                i = this.finner.find("._cwFWFooter"),
                i = i.length > 0 && i.isVisible() ? i.outerHeight() : 0,
                j = this.finner.find("._cwFWButtonFooter"),
                k = j.isVisible() ? j.outerHeight() : 0,
                j = this.fcontent,
                h = j.innerHeight() - j.height(),
                a = a - e - g - i - k - h;
            j.height(a);
    ...
    b.cwUI.addWidget("cwListTip", {
        ...
        _setOption: function(e) {
            ...
            if (e.multiSelect != void 0) {
                var g = f.find("._cwLTCheckHandle"),
                    k = this.ul;
                e.multiSelect ? (k.addClass("toolTipSelectList"), g.html('<span class="_cwLTCheckAll linkStatus">' + a.checkall + '</span> / <span class="_cwLTUnCheckAll linkStatus">' + a.uncheckall + "</span>"), g.find("._cwLTCheckAll").on("click.cwListTip", function() {
        ...
        build: function() {
            ...
            var e = "",
                d = this.getList();
            if (b.isArray(d)) {
                for (var f = 0, g = d.length, i = 0; i <
                g; i++) {
                    var j = d[i];
                    f++;
                    if (!(f > this.option.limit)) {
                        var k = b.cwUI.escapeHTML(j.value),
                            h = this.option.useHtmlLabel ? j.label : b.cwUI.escapeHTML(j.label);
                        e += this.option.selectable ? this.select_dat[j.value] != void 0 ? '<li class="_cwSelectableRow listSelected" role="listitem" data-cwui-lt-idx="' + i + '" data-cwui-lt-value="' + k + '">' + b.cwCheckBox.create(!0, "", i, {
                            "data-theme": "green"
                        }) + h + "</li>" : '<li class="_cwSelectableRow" role="listitem" data-cwui-lt-idx="' + i + '" data-cwui-lt-value="' + k + '">' + b.cwCheckBox.create(!1,
                            "", i, {
                                "data-theme": "green"
                            }) + h + "</li>" : '<li role="listitem" data-cwui-lt-idx="' + i + '" data-cwui-lt-value="' + k + '">' + h + "</li>"
                    }
                }
...
(function(b) {
    ...
    b.cwUI.addWidget("cwMessageTip", {
        ...
        open: function() {
            ...
            var e = b.option.delayQuickMode && j ? 0 : i.option.delay,
                l = function() {
                    g ? (b.refresh(i.$el), d && (i.tooltip.open(i.$el), j = !0)) : (b.tooltip.close(), i._closeTip());
                    f = null
                };
            e ? f = setTimeout(l, e) : l();
    ...
    b.cwUI.addWidget("cwScrollTable", {}, {
        ...
        resize: function(a) {
            ...
            for (i = 0; i < this.column_num; i++) {
                var h = d[i];
                h != "auto" ? (j += h, i != this.column_num - 1 && (f = b(this.body_table_head[i]), g = this.column_padding[i], this.column_width[i] = h - g, f.width(this.column_width[i]))) : k.push(i)
            }
            d = k.length;
            if (d > 0) {
                e = parseInt((e - j) / d, 10);
                for (i = 0; i < d; i++) f = b(this.body_table_head[k[i]]), g = this.column_padding[i], this.column_width[i] = e - g, f.width(this.column_width[i])
            }
            for (i = 0; i < this.column_num - 1; i++) b(this.header_row[i]).width(b(this.body_table_head[i]).width());
...
(function(b) {
    ...
    b.cwUI.addWidget("cwSelectBox", {
        ...
        create: function(a, e, d, f) {
            ...
            d == void 0 && (d = "");
            var g = "<div",
                i = "_cwSL selectbox cwTextUnselectable",
                j;
            for (j in f) switch (j) {
                case "class":
                    i +=
    ...
    b.cwUI.addWidget("cwToolTip", {
        ...
        move: function(a) {
            ...
            var i = b(document.body),
                ...
                l = parseInt(m / 2, 10),
                o = "",
                o = this.option.direction == "vertical" ? h.top - m < 0 ? "bottom" : "top" : this.option.direction == "horizontal" ? h.left > parseInt(j / 2, 10) ? "left" : "right" : this.option.direction,
                q = b.cwUI.ucFirst(this.option.theme.toLowerCase());
            switch (o) {
                case "top":
                    q = "toolTipTriangle" + q + "Bottom";
                    break;
                case "bottom":
                    q = "toolTipTriangle" + q + "Top";
                    break;
                case "left":
                    q = "toolTipTriangle" + q + "Right";
                    break;
                case "right":
                    q = "toolTipTriangle" +
                        q + "Left";
            ...
            if (!this.option.noTriangle) d.prepend('<div class="_cwTTTriangle toolTipTriangle ' + q + '"></div>'), this.triangle = o;
            if (this.option.noTriangle) var q = null,
                u = 0,
                n = 0;
            else q = d.find("._cwTTTriangle"), u = q.outerHeight(), n = q.outerWidth();
            var x = a.outerWidth(),
                t = parseInt(x / 2, 10),
                A = a.outerHeight(),
                w = parseInt(A / 2, 10);
            ...
            switch (o) {
                ...
                case "bottom":
                    switch (this.option.showPosition) {
                        case "left":
                            p = this.option.noTriangle ? h.left + g : h.left - parseInt(i / 2, 10) + g;
                            break;
                        case "right":
                            p = this.option.noTriangle ? h.left - i + x + g : h.left - parseInt(i / 2, 10) + x + g;
                            break;
                        default:
                            p = h.left - parseInt(i / 2, 10) + t + g
                    }
                    break;
                case "left":
                case "right":
            ...
            p + i > j && (p = j - this.option.windowMargin - i);
            if (p < this.option.windowMargin) p = this.option.windowMargin;
            r + m > k && (r = k - this.option.windowMargin - m);
            if (r < this.option.windowMargin) r = this.option.windowMargin;
            if (q) switch (j = parseInt(u / 2, 10), k = parseInt(n / 2, 10), o) {
                case "top":
                case "bottom":
                    switch (this.option.showPosition) {
                        case "left":
                        ...
                        case "right":
                            f = h.left - p + x - k + g;
                            g = i - n - this.option.triangleMargin;
                            f > g && (tip_p_left = g);
                            break;
                        default:
                            f = h.left - p + t - k + g
                ...
                case "right":
                    switch (this.option.showPosition) {
                        case "top":
                            f =
                                h.top - r + this.option.triangleMargin + f;
                            break;
                        case "bottom":
                            f = h.top - r + m - u - this.option.triangleMargin + f;
                            break;
                        default:
                            f = h.top - r + l - j + f
                    }
            ...
            $(this).on("copy", function(d) {
                if (ST.data.shorten_url && (d = (d.target.tagName ||
                    ...
                    var d = window.getSelection().getRangeAt(0),
                        i = d.commonAncestorContainer;
                    if (i.childElementCount) d = i.getElementsByClassName(b.targetClass), d.length && (f = a(Array.prototype.slice.call(d), function() {
                        f = void 0
                    }));
                    else {
                        var j = e(d);
...
function Analytics() {
    ...
    b.start = function(g) {
        if (!a) {
            ...
            b.trackPageView();
            for (var g = 0, j = e.length; g < j; g++) e[g]();
            e = [];
            return b
        }
    };
    ...
    b.comet = function(f) {
        if (b.use_local_comet) CW.get("gateway.php", {
            ...
            if (f) i(f);
                ...
                g ? f != g && (k(), a.setItem("session.account_id",
                    f)) : (a.getItem("session.account_id") && k(), a.setItem("session.account_id", f));
                (f = a.getItem("channel_token_key")) ? i(f): CW.post("gateway.php", {
    ...
    var f = 3E3,
        ...
        i = function(d, e) {
            ...
            i ? j(i) : $.jsonp({
                ...
                success: function(b) {
                    b.status &&
                    b.status.success && (a.setItem("channel_token", b.result.token), j(b.result.token), f = 3E3, g = 7, e != !0 && CW.post("gateway.php", {
