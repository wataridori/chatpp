...
(function(b) {
    ...
    function i(b, h) {
        b[h >> 5] |= 128 << h % 32;
        b[(h + 64 >>> 9 << 4) + 14] = h;
        var i, l, n, j, m, p = 1732584193,
            q = -271733879,
            v = -1732584194,
            t = 271733878;
        for (i = 0; i < b.length; i += 16) l = p, n = q, j = v, m = t, p = d(p,
            q, v, t, b[i], 7, -680876936), t = d(t, p, q, v, b[i + 1], 12, -389564586), v = d(v, t, p, q, b[i + 2], 17, 606105819), q = d(q, v, t, p, b[i + 3], 22, -1044525330), p = d(p, q, v, t, b[i + 4], 7, -176418897), t = d(t, p, q, v, b[i + 5], 12, 1200080426), v = d(v, t, p, q, b[i + 6], 17, -1473231341), q = d(q, v, t, p, b[i + 7], 22, -45705983), p = d(p, q, v, t, b[i + 8], 7, 1770035416), t = d(t, p, q, v, b[i + 9], 12, -1958414417), v = d(v, t, p, q, b[i + 10], 17, -42063), q = d(q, v, t, p, b[i + 11], 22, -1990404162), p = d(p, q, v, t, b[i + 12], 7, 1804603682), t = d(t, p, q, v, b[i + 13], 12, -40341101), v = d(v, t, p, q, b[i + 14], 17, -1502002290),
            q = d(q, v, t, p, b[i + 15], 22, 1236535329), p = f(p, q, v, t, b[i + 1], 5, -165796510), t = f(t, p, q, v, b[i + 6], 9, -1069501632), v = f(v, t, p, q, b[i + 11], 14, 643717713), q = f(q, v, t, p, b[i], 20, -373897302), p = f(p, q, v, t, b[i + 5], 5, -701558691), t = f(t, p, q, v, b[i + 10], 9, 38016083), v = f(v, t, p, q, b[i + 15], 14, -660478335), q = f(q, v, t, p, b[i + 4], 20, -405537848), p = f(p, q, v, t, b[i + 9], 5, 568446438), t = f(t, p, q, v, b[i + 14], 9, -1019803690), v = f(v, t, p, q, b[i + 3], 14, -187363961), q = f(q, v, t, p, b[i + 8], 20, 1163531501), p = f(p, q, v, t, b[i + 13], 5, -1444681467), t = f(t, p, q, v, b[i + 2], 9, -51403784),
            v = f(v, t, p, q, b[i + 7], 14, 1735328473), q = f(q, v, t, p, b[i + 12], 20, -1926607734), p = e(q ^ v ^ t, p, q, b[i + 5], 4, -378558), t = e(p ^ q ^ v, t, p, b[i + 8], 11, -2022574463), v = e(t ^ p ^ q, v, t, b[i + 11], 16, 1839030562), q = e(v ^ t ^ p, q, v, b[i + 14], 23, -35309556), p = e(q ^ v ^ t, p, q, b[i + 1], 4, -1530992060), t = e(p ^ q ^ v, t, p, b[i + 4], 11, 1272893353), v = e(t ^ p ^ q, v, t, b[i + 7], 16, -155497632), q = e(v ^ t ^ p, q, v, b[i + 10], 23, -1094730640), p = e(q ^ v ^ t, p, q, b[i + 13], 4, 681279174), t = e(p ^ q ^ v, t, p, b[i], 11, -358537222), v = e(t ^ p ^ q, v, t, b[i + 3], 16, -722521979), q = e(v ^ t ^ p, q, v, b[i + 6], 23, 76029189), p = e(q ^
            v ^ t, p, q, b[i + 9], 4, -640364487), t = e(p ^ q ^ v, t, p, b[i + 12], 11, -421815835), v = e(t ^ p ^ q, v, t, b[i + 15], 16, 530742520), q = e(v ^ t ^ p, q, v, b[i + 2], 23, -995338651), p = g(p, q, v, t, b[i], 6, -198630844), t = g(t, p, q, v, b[i + 7], 10, 1126891415), v = g(v, t, p, q, b[i + 14], 15, -1416354905), q = g(q, v, t, p, b[i + 5], 21, -57434055), p = g(p, q, v, t, b[i + 12], 6, 1700485571), t = g(t, p, q, v, b[i + 3], 10, -1894986606), v = g(v, t, p, q, b[i + 10], 15, -1051523), q = g(q, v, t, p, b[i + 1], 21, -2054922799), p = g(p, q, v, t, b[i + 8], 6, 1873313359), t = g(t, p, q, v, b[i + 15], 10, -30611744), v = g(v, t, p, q, b[i + 6], 15, -1560198380),
            q = g(q, v, t, p, b[i + 13], 21, 1309151649), p = g(p, q, v, t, b[i + 4], 6, -145523070), t = g(t, p, q, v, b[i + 11], 10, -1120210379), v = g(v, t, p, q, b[i + 2], 15, 718787259), q = g(q, v, t, p, b[i + 9], 21, -343485551), p = a(p, l), q = a(q, n), v = a(v, j), t = a(t, m);
        return [p, q, v, t]
    }
...
function ChatWork(b) {
                        ...
                        switch (g) {
                            case "room":
                                for (var h in i) {
                                    ...
                                    if (i[h].cd)
                                        for (var l in i[h].cd)
                                            if (RL.rooms[h].timeline &&
                                                (RL.rooms[h].timeline.deleteChat(l), RL.setUpdate(!0)), RM && h == RM.id) e.RM = !0;
                                    if (i[h].ce)
                                        for (l in i[h].ce)
                                            if (!i[h].cd || !i[h].cd[l])
                                                if (RL.rooms[h].timeline && (RL.rooms[h].timeline.refreshChat(l), RL.setUpdate(!0)), RM && h == RM.id) e.RM = !0;
                                    if (i[h].fe)
                                    ...
                                    if (i[h].te)
                                        for (o in i[h].te)(!i[h].td || !i[h].td[o]) && TK.refreshTask(o);
                                    if (i[h].td) {
                            ...
                            case "account":
                                if (i.a) {
                                    var j = [],
                                        m;
                                    for (m in i.a) j.push(parseInt(m, 10));
                                    AC.refreshAccount(j, !0)
                                }
                                i.s && ST.getSetting();
                                if (i.r)
                                    for (h in j = i.r, AC.account_dat[j] && AC.refreshContactList(), RL.rooms) RL.rooms[h].member_dat[j] && RL.setMemberUpdate(h);
                                i.n && ST.getAnnounce();
                                break;
                            case "contact":
                                ...
                                if (i.m) {
                                    j = [];
                                    for (m in i.m) j.push(parseInt(m, 10));
                                    AC.refreshMentionInfo(j)
                                }
    ...
    a.getFilePanel = function(b, f) {
        if (f == void 0) f = w;
            ...
            for (var d in w) f[d] == void 0 && (f[d] = w[d]);
...
function Account(b) {
    ...
    a.updateContactList = function(b, d, e, j) {
        ...
        for (n in b) n = parseInt(n, 10), a.contact_flag[n] = !0, CW.registerAvatar(n), a.contact_list.push(n), a.setAccountDat(n, b[n]), delete k[n], h[n] || m.push(n);
...
function RoomList() {
    ...
    b.load = function() {
        ...
        if (h) {
            ...
            if (a.length) {
                l = 0;
                for (var n = a.length; l < n; l++) {
                    m = a[l];
                    h[m] = {};
                    if (b.rooms[m]) {
                        var o = b.rooms[m];
                        h[m].c = o.chat_num;
                        h[m].u = o.getUnreadNum();
                        h[m].l = o.timeline ? b.rooms[m].timeline.getLastChatId() : 0;
                        if (o.filelist) {
                            var s = o.filelist.getFileNum();
                            h[m].f = $.isNumeric(s) ? s : o.filelist.getFileList().length;
                            h[m].lf = o.filelist.getLastFileId()
                        }
    ...
    b.updateRoomData = function(a) {
        ...
        for (k in a) {
            ...
            if (rval.task_dat) {
                ...
                var m = [],
                    s;
                for (s in rval.task_dat) TK.setTask(rval.task_dat[s]),
                    m.push(s);
            ...
            if (rval.file_list) {
                ...
                n = 0;
                for (m = rval.file_list.length; n < m; n++) h.filelist.insertFile(rval.file_list[n]);
            ...
            if (rval.chat_list && rval.chat_list.length > 0) {
                ...
                if (CW.enable_popup && !CW.is_first_load) {
                    n = 0;
                    for (m = rval.chat_list; n < m; n++) j[rval.chat_list[n].aid] = !0
                }
                var u = "";
                n = 0;
                for (m = rval.chat_list.length; n <
                m; n++)
                    if (g = !0, h.timeline.addChat(rval.chat_list[n]), CW.enable_popup && !CW.is_first_load && (o = rval.chat_list[n], e[o.id] == void 0)) {
                        e[o.id] = !0;
                        var w = ST.data.notifier_message == "1" ? CW.renderMessage(o.msg, {
                                text: !0
                            }) : L.notifier_newmessage,
                            u = w.length > 0 && AC.myid != o.aid ? {
                                id: o.id,
                                aid: o.aid,
                                room_id: h.id,
                                msg: w
        ...
        a = function() {
            u && (!ST.data.notifier_onlyto || b.rooms[u.room_id].timeline.chat_id2chat_dat[u.id].mn) && CW.popup(CW.getAvatarPanel(u.aid, {
                src: !0
            }), RL.rooms[u.room_id].getName(),
                AC.getName(u.aid) + ":" + u.msg, u.room_id);
            ...
            for (var m = 0; m < d.length; m++)
                if (d[m] != void 0) {
                    var e = b.rooms[d[m]],
                        ...
                        n = 0;
                    l > 0 && (b.unread_total +=
                        l, b.unread_room_sum++, n = e.getMentionNum(), n > 0 && b.mention_room_sum++);
                    ...
                    if (h.length > 0) {
                        ...
                        } else if (!CW.isMatchedWithKeyList(h, l)) continue
...
function ChatWorkView(b) {
    ...
    a.confirm = function(a, b, d, e) {
        var f = "_confirmDialogBody" + o,
            h = $('<div id="_confirmDialog' + o + '" class="dialog dialogPadding"><pre id="' + f + '" class="confirmDialogBody"></pre></div>');
        $C("body").append(h);
        e ?
    ...
    a.confirmDelete = function(a, b, d, e, f) {
        var h = "_confirmDialogBody" + o,
            g = $('<div id="_confirmDialog' + o + '" class="dialog dialogPadding"><pre id="' + h + '" class="confirmDialogBody"></pre></div>');
        $C("body").append(g);
        h = $("#" + h);
        e ? a = mlength(h.html(a).text()) : (h.text(a), a = mlength(a));
    ...
    a.registerKeyboardShortcut = function(b, d, e, f, h, g) {
        a.keyfunc[a.getKeyCombinationMap(b, d, e, f, h)] = g;
        return a
    };
    ...
    a.postLoad = function() {
        ...
        else if (e.indexOf("contact_request") != -1) AC.view.openContactWindow(), $("#_contactWindowTabRequest").click();
    ...
    (function() {
        ...
        a.popup = function(a, f, h, g) {
            if (!wfocus && NotificationAPI && NotificationAPI.checkPermission() == 0) b && (typeof b.cancel == "function" ? b.cancel() : typeof b.close == "function" && b.close()), e && (h = " " + h), b = NotificationAPI.createNotification(a, f, h), b.room_id =
    ...
    a.changeFavicon = function(a) {
        r != a && (r = a, $("#_favicon").remove(), $("head").append($('<link rel="shortcut icon" id="_favicon" href="' + a + '?1"  type="image/vnd.microsoft.icon" />')))
    };
    ...
    a.setConnectionError = function(b) {
        b == "NO LOGIN" || b == "NO TOKEN" || b == "IP ERROR" ? (f || ($("#_statusAlertMessage").html('<a href="./">' + L.connection_error_logout + "</a>"), $("#_statusAlert").fadeIn()), b == "IP ERROR" && (d || a.model.alert(L.error_cant_login_ip), d = !0)) : b == "INVALID USER" ? f || ($("#_statusAlertMessage").html('<a href="./">' + L.connection_error_invalid_user + "</a>"), $("#_statusAlert").fadeIn()) : b == "INVALID TOKEN" ? !f && RM !== null && (a.setDrafts(), location.reload()) : f || ($("#_statusAlertMessage").html('<a href="./">' + L.connection_error_offline + "</a>"), $("#_statusAlert").fadeIn())
    };
    ...
    a.renderMessage = function(b, d) {
        ...
        time();
        for (var h in a.model.reg_cmp) b = e.text && a.model.reg_cmp[h].reptxt != void 0 ? b.replace(a.model.reg_cmp[h].key, a.model.reg_cmp[h].reptxt) : b.replace(a.model.reg_cmp[h].key,
            a.model.reg_cmp[h].rep);
        var g = b.match(/\[pname:\d+\]/g);
        if (g)
            for (h = 0; h < g.length; h++) var i = g[h].match(/\[pname:(\d+)\]/),
                i = i[1], l = e.text ? AC.getName(i) : CW.getName(i), b = b.replace("[pname:" + i + "]", l);
        if (g = b.match(/\[dtext:\w+\]/g))
            for (h = 0; h < g.length; h++) i = g[h].match(/\[dtext:(\w+)\]/), i = i[1], L.hasOwnProperty(i) && "string" === typeof L[i] && (b = b.replace("[dtext:" + i + "]", L[i]));
        if (g = b.match(/\[picon:\d+\]/g))
            for (h = 0; h < g.length; h++) i = g[h].match(/\[picon:(\d+)\]/), i = i[1], b = b.replace("[picon:" + i + "]", CW.getAvatarPanel(i, {
                size: "tiny"
            }));
        if (g = b.match(/\[date:\d+\]/g))
            for (h = 0; h < g.length; h++) i = g[h].match(/\[date:(\d+)\]/), i = i[1], b = b.replace("[date:" + i + "]", a.model.getDate(i));
        if (g = b.match(/\[task aid=[0-9,]+ st=[^\s]+ lt=-?[0-9]*\]/g))
            for (h = 0; h < g.length; h++) i = g[h].match(/\[task aid=([0-9,]+) st=([^\s]+) lt=(-?[0-9]*)\]/), e.text ? b = b.replace(i[0], "[") : (l = {
                aid: i[1],
                st: i[2],
                lt: parseInt(i[3], 10)
        ...
        if (g = b.match(/\[live id=[^\ ]+ rid=\d+]/g))
            for (h = 0; h <
            g.length; h++)
                if (i = g[h].match(/\[live id=([^\ ]+) rid=(\d+)\]/), e.text) b = b.replace(i[0], "[ChatWork Live]");
                else {
                    var l = "",
                        n = i[1],
                        q = i[2];
                    l += MOBILE === "ipad" ? '<div class="button btnDisable"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>" : RL.rooms[q] ? '<div class="_joinLive button btnSuccess" data-live-id="' + n + '"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>" : '<div class="button btnDisable"><span class="icoFontVideoChat"></span><span>' + L.live_join + "</span></div>";
                    b = b.replace(i[0], l)
                }
        /MSIE\s9\.0;/i.test(navigator.userAgent) || (b = b.replace(/<a\shref="gateway\.php\?cmd=download_file\W.+?".*?>.+?<\/a>/g, function(b) {
            ...
            var e = a.filePreview.getPreviewType(e),
                ...
                h = "",
                g = "";
            e !== "image" ? (h = "_previewLink", d = d.replace(/\'\"\`/g, ""), g = ' data-url="' + urlencode(f + "&preview=1") + '" data-type="chatworkFilePreview" data-content-id="' +
                d + '"') : (h = "_filePreview", g = 'data-file-id="' + (f.match(/\Wfile_id=(\d+)/i) || [""]).pop() + '"');
            return b + (' <a class="' + h + ' timelineLinkAppend" ' + g + ">" + (e === "video" ? L.preview_video : L.preview) + "</a>")
        }));
if (g = b.match(/<link_title>https?:\/\/[-_.!~*\'()a-zA-Z0-9;?:\@&=+\$,%#\{\}]+[-_.!~*\'\(\)a-zA-Z0-9;\/?:\@&=+\$,%#\{\}]+<\/link_title>/g))
    for (h = 0; h < g.length; h++) {
        var i = g[h].match(/(<link_title>(https?:\/\/([^\/]+)[-_.!~*\'\(\)a-zA-Z0-9;\/?:\@&=+\$,%#\{\}]+)<\/link_title>)/),
            l = i[1],
            n = i[2],
            o = i[3],
            q = "";
        ...
        if (n.indexOf("chatwork.com") != -1 || n.indexOf("www.chatwork.com") != -1 || n.indexOf("kcw.kddi.ne.jp") != -1) {
            var j = n.match(/(#!rid(\d+)\-?(\d+)?)$/),
                o = "chatwork.com";
            if (j) n = j[1], q = j[2], q = (j = j[3]) ? '</a> <a class="_messageLink timelineLinkAppend" data-rid="' + q + '" data-mid="' + j + '">' + L.message_link + "</a>" : '</a> <a class="_roomLink timelineLinkAppend" data-rid="' + q + '">' + L.message_open_chat + "</a>";
            else if (j = n.match(/\/g\/([-\w]+)$/)) n = j[0], q = '</a> <a class="_groupchatLink timelineLinkAppend" data-linkCode="' +
                j[1] + '">' + L.message_join_groupchat + "</a>"
        }
        if ((o == "secure.mindjet.com" || o == "www.mindjet.com") && n.indexOf("openlink") != -1) i = 40, q = '</a><a class="timelineLinkAppend" href="mj-link:' + n + '">' + L.message_open_mindmanager + "</a>";
        if ((o == "vision.mindjet.com" || o == "connect.mindjet.com") && n.indexOf("/link") != -1) i = 40, q = '</a><a class="timelineLinkAppend" href="mj-connect:' + n + '">' + L.message_open_mindmanager + "</a>";
        ...
        if (_has_sandbox) {
            ...
            switch (o) {
                case "teachme.jp":
                    if (o =
                            n.match(/^https?:\/\/teachme\.jp\/contents\/([0-9]+)/)) j = "teachme", t = o[1];
                    break;
                case "speakerdeck.com":
                    if (o = n.match(/^https?:\/\/speakerdeck\.com\/([^\/]+)\/([^\/]+)$/)) j = "speakerdeck", m = o[1], t = o[2];
                    break;
                case "www.slideshare.net":
                    if (o = n.match(/^https?:\/\/www\.slideshare\.net\/([^\/]+)\/([^\/]+)$/)) j = "slideshare", m = o[1], t = o[2];
                    break;
                case "prezi.com":
                    if (o = n.match(/^https?:\/\/prezi\.com\/([^\/]+)\//)) j = "prezi", t = o[1];
                    break;
                case "www.youtube.com":
                    if (o = n.match(/^https?:\/\/www\.youtube\.com\/watch\?v=([^\/&]+)/)) j =
                        "youtube", t = o[1];
                    break;
                case "youtu.be":
                    if (o = n.match(/^https?:\/\/youtu\.be\/([^\/&]+)/)) j = "youtube", t = o[1];
                    break;
                case "vimeo.com":
                    if (o = n.match(/^https?:\/\/vimeo\.com\/(?:channels\/staffpicks\/)?([^\/]+)/)) j = "vimeo", t = o[1];
                    break;
                case "slides.com":
                    if (o = n.match(/^https?:\/\/slides\.com\/([^\/]+\/[^\/]+)$/)) j = "slid.es", t = o[1];
                    break;
                case "slid.es":
                    if (o = n.match(/^https?:\/\/slid\.es\/([^\/]+\/[^\/]+)$/)) j = "slid.es", t = o[1];
                    break;
                case "corabbit.com":
                    if (o = n.match(/^https:\/\/corabbit\.com\/#\/file\/([^\/]+)$/)) j =
                        "corabbit", t = o[1];
                    break;
                case "docs.google.com":
                    if (o = n.match(/^https:\/\/docs.google\.com\//)) j = "googledocs", t = "-";
                    break;
                case "drive.google.com":
                    if (o = n.match(/^https:\/\/drive.google\.com\//)) j = "googledocs", t = "-";
                    break;
                case "cacoo.com":
                    if (o = n.match(/^https:\/\/cacoo\.com\/diagrams\/([^\/]+)(?:\/edit)?$/)) j = "cacoo", t = o[1];
                    break;
                case "sharepoint.com":
                    if (o = n.match(/^https:\/\/([\w\-\.\/]+?)\?.*(sourcedoc=[\{\}\w\-]+?|guestaccesstoken=[\%\w]+&(?:amp;?)docid=\w+)(?:&|$)/)) j = "sharepoint", t = o[1] + "?" + o[2]
            }
            j &&
            (q = '</a> <a class="_previewLink timelineLinkAppend" data-url="' + urlencode(n) + '" data-type="' + j + '" data-user-id="' + m + '" data-content-id="' + t + '">' + L.preview + "</a>")
        }
        e.trimLink && (n = trim_width(n, 0, i));
        b = b.replace(l, n + q)
    }
if (!e.text && f.length) var B = $("<div></div>"),
    b = b.replace(/\[code\]\[\/code\]/gi, function() {
        return '<code class="chatCode">' + B.text(f.shift()).html() + "</code>"
    });
...
var q = $("#_globalHeader").outerHeight(!0),
    v = parseInt($("#_content").css("margin-top"), 10),
    t = $C("#_mainContent").outerHeight(!0) - $C("#_mainContent").innerHeight(),
...
a.resizeLayout = function() {
    ...
    d < 540 ? ($C("#_search").removeClass("inputLong"), $C("#_adminNavi").hide(), $C("#_myStatusButton").addClass("headerNameShort"), $C("#_myStatusName").hide(), $C("#_logo").hide(), $C("#_headerSearch").addClass("headerSearchShort")) : (d < 730 ? ($C("#_search").removeClass("inputLong"), $C("#_adminNavi").hide(), $C("#_myStatusButton").addClass("headerNameShort"),
        $C("#_myStatusName").hide()) : d < 912 ? ($C("#_search").removeClass("inputLong"), $C("#_adminNavi").show(), $C("#_myStatusButton").addClass("headerNameShort"), $C("#_myStatusName").hide()) : (d < 1124 ? $C("#_search").removeClass("inputLong") : $C("#_search").addClass("inputLong"), $C("#_adminNavi").show(), $C("#_myStatusButton").removeClass("headerNameShort"), $C("#_myStatusName").show()), $C("#_logo").show(), $C("#_headerSearch").removeClass("headerSearchShort"));
...
a.setLimitDialog = function(b, d) {
    ...
    d != void 0 && L[d] != void 0 && (b = b.replace(/%%object%%/g,
        L[d]));
        ...
        open: function(d, e, f, h) {
            if (d) {
                ...
                switch (d) {
                    case "teachme":
                        o = !0;
                        i = "//teachme.jp/contents/" +
                            h + "/embed?mb=0";
                        g.title = "Teachme";
                        break;
                    case "speakerdeck":
                        q = o = !0;
                        g.title = "Speaker Deck";
                        I = $.ajax({
                            type: "GET",
                            url: "./api_proxy.php?type=speakerdeck&url=" + urlencode(e),
                            success: function(a) {
                                $("#_previewLinkContent").html(m(a, s, u))
                            },
                            error: function() {
                    ...
                    case "slideshare":
                        ...
                        I = $.jsonp({
                            ...
                            success: function(a) {
                                $("#_previewLinkContent").html(m(i.replace("%%slideshow_id%%", a.slideshow_id), s, u))
                            },
                            error: function() {
                                $("#_previewLinkContent").html(L.raise_error)
                            }
                    ...
                    case "prezi":
                        o = !0;
                        n = !1;
                        i = "//prezi.com/embed/" + h + "/?bgcolor=ffffff&amp;lock_to_path=0&amp;autoplay=0&amp;autohide_ctrls=0&amp;features=undefined&amp;disabled_features=undefined";
                        g.title = "Prezi";
                        break;
                    case "youtube":
                        o = !0;
                    ...
                    case "slid.es":
                        ...
                        break;
                    case "corabbit":
                        i = "//corabbit.com/embed/" + h;
                        g.title = "Corabbit";
                        break;
                    case "googledocs":
                        n = !1;
                        i = e.replace(/(\/file\/.+)\/(edit|view)$/, "$1/preview");
                        g.title = "Google Drive " + L.preview_needlogin;
                        break;
                    case "cacoo":
                        i = function() {
                            var a = h.split("#"),
                            ...
                            return "//cacoo.com/diagrams/" +
                                b + "/view?w=" + (s - 2) + "&h=" + (u - 30) + (a ? "#" + a : "")
                        };
                        j = "no";
                        g.title = "Cacoo";
                        break;
                    case "sharepoint":
                        i = "https://" + h + "&action=interactivepreview&wdSmallView=1";
                        g.title = "Office 365";
                        break;
                    case "chatworkFilePreview":
                        n = !1;
                        g.title = $("<div></div>").text(h).html();
                        g.buttonLabels = [L.open_window, L.button_close];
                        var t = a.filePreview.getPreviewType(h.split(".").pop()),
                            B = function(a, b, d) {
                                ...
                                $(window).on("message.previewLinkContent", function(b) {
                                    if (b.originalEvent.origin ===
                                        ...
                                        f.type === "fixWindowSize" && (b = Math.min(f.width + TM.preview_dialog_width_padding, g.width), f = Math.min(f.height + TM.preview_dialog_height_padding + 82, g.height), H.setOption({
                                            width: b,
                                            height: f
                                        }), H.open(), a.attr({
                                            width: b,
                        ...
                        if (t === "iframe") i = e;
                            ...
                            $.ajax({
                                ...
                                success: function(a) {
                                    n = !1;
                                    $("#_previewLinkContent").html(m("https://d2cxqj2w0ktore.cloudfront.net/preview/iframe/index.html", s, u, j));
                        ...
                        else if (t === "video") i = "https://d2cxqj2w0ktore.cloudfront.net/preview/iframe/index.html", $("#_previewLinkDialog").parent().hide(), setTimeout(function() {
                ...
                if (o) {
                    ...
                    s = 1120;
                    for (u = 840; s > 160 && (f < s + 40 || p < u + l + 40);) s -= 160, u -= 120;
                    g.width = s + TM.preview_dialog_width_padding
                } else this.$el.addClass("previewFullDialog"),
                    s = f - 40, u = p - l - 40, g.width = s;
                g.height = u + l;
                d && h && (q ? $("#_previewLinkContent").html('<div style="margin:auto"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.loading + "</div>") : $("#_previewLinkContent").html(m(i, s, u, j)));
                this.setOption(g)
            }
        },
        close: function() {
        ...
        if ($.isEmptyObject(b)) d.hide();
            ...
            $.each(b, function(b, d) {
                ...
                var h = {
                    ...
                    g = d.linkClick || function() {
                            a.openAnnounceDialog(h)
                        };
                f.click(function() {
                    g(h)
                })
    ...
    var a = g.$el.find("._navlist"),
        b = function(d) {
            ...
            f < a.length - 1 ? (d.push(L.pager_next), h.push(function() {
                b(1)
            })) : f == a.length - 1 && (d.push(L.button_close), h.push(function() {
                g.close()
            }));
            g.setOption({
                buttonLabels: d,
...
function AccountView(b) {
            ...
            "#_addNoContactMember", function() {
                if (!b($(this))) {
                    ...
                    if (f = RL.rooms[f]) {
                        var h = [],
                            g;
                        for (g in f.member_dat) AC.isContact(g) || h.push(g);
                        h.length > 0 && a.requestContact(h, e)
                    }
                }
            });
    ...
    a.getNoRequestDat = function(b) {
        ...
        for (var f in e) {
            var b = RL.rooms[f],
                h;
            for (h in b.member_dat) a.model.myid != h && !a.model.isContact(h) && !a.model.myrequest_dat[h] && (d[h] = a.model.account_dat[h])
        }
        return d
    };
    a.buildMyStatus = function() {
                        ...
                        if (b.length) CW.alert(b.join("\n"));
                            ...
                            CW.post("gateway.php", e, function(b) {
                                var d = {
                                    ...
                                    h;
                                for (h in d) b[h] && (e[d[h]] = b[h]), f = h + "_priv", b[f] && (e[d[h] + "_priv"] = b[f]);
    ...
    a.prepareContactWindow = function() {
        ...
        $C("#_contactWindowList").on("click", "._contactList", function() {
            ...
            b ? u[e] = b : u[e] && delete u[e];
            a = $C("#_contactWindowList").find("._contactList").length;
            (b = count(u)) ? (b == a ? m.check() : m.partialCheck(), d.enable()) : (m.unCheck(), d.disable())
        }).on("click",
            "._inviteContact", function() {
        ...
        s = $("#_contactWindowPager").cwButtonBar({
            update: function(b) {
                switch (e[b]) {
                    case "first":
                        n = 0;
                        ...
                        if (b.error != void 0) {
                            ...
                            if (b.error_dat != void 0) {
                                ...
                                for (d in b.error_dat) {
                                    var h = b.error_dat[d].length;
                                    if (d == "noexist")
                                        for (var g = 0; g < h; g++) x.inviteMailList.push(b.error_dat[d][g]);
                                    else {
                                        ...
                                        h = "";
                                        for (g = 0; g < l; g++) h && (h += ","), h += b.error_dat[d][g];
                                        f += h;
        ...
        if (h && h.isOpen()) {
            ...
            switch (a.tab_type) {
                case "addcontact":
                    ...
                    for (var i = [], k = 0, p = f.length; k < p; k++) {
                        var r = f[k];
                        !AC.isContact(r) && !AC.request_dat[r] && !AC.myrequest_dat[r] && i.push(r)
                    }
                    f = i;
                    break;
                case "contact":
                    ...
                    for (var f = [], k = 0, w = a.model.contact_list.length; k < w; k++) r = a.model.contact_list[k], p(r, i) && f.push(r);
                ...
                case "myrequest":
                    ...
                    if (f) i = CW.splitWithSpace(f), x.isSearched = !0;
                    f = [];
                    for (r in a.model.myrequest_dat) p(r,
                        i) && f.push(r);
                ...
                case "request":
                    ...
                    if (f) i = CW.splitWithSpace(f), x.isSearched = !0;
                    f = [];
                    for (r in a.model.request_dat) p(r, i) && f.push(r);
                ...
                case "norequest":
                    ...
                    f = [];
                    e = a.getNoRequestDat();
                    for (r in e) p(r, i) && f.push(r);
                    b += '<div class="contactAddAllHint">' + L.contact_add_all_hint + "</div>";
                    $C("#_contactWindowAdd").show().cwButton().disable()
            }
            x.isLoading ? b += '<div class="contentLoading"><img src="./imagenew/all/common/loader/img_loader_gray.gif" />' + L.loading + "</div>" : f.length == 0 && g.length == 0 && (b += x.isSearched ? '<div class="emptyAdminContent"><img src="./imagenew/common/empty/img_contact_empty.png" alt="" /><p>' +
            ...
            r = count(a.model.myrequest_dat);
            if (r > 0) $C("#_contactWindowTabMyRequest").show(), $C("#_contactWindowMyRequestNum").text("(" +
                number_format(r) + ")");
            ...
            r = count(e);
            if (r > 0) $C("#_contactWindowTabNoRequest").show(), $C("#_contactWindowNoRequestNum").text("(" +
                number_format(r) + ")");
            ...
            if (r > 0) {
                ...
                for (k = 0; k < r; k++) b += "<li>" + escape_html(g[k]) + "</li>";
            ...
            for (k = 0; k < d; k++) r = g[k], b += '<li class="_contactList subContentShadow" data-aid="' + r + '">' + a.getContactPanel(r, i) + "</li>", e == r && (j = !0);
            j || $C("#_contactDetailClose").click();
            m.unCheck(!0);
            $C("#_contactWindowList").html(b);
            f.length ? $C("#_contactWindowPagerIndex").text((n + 1).toString() + " / " + l) : $C("#_contactWindowPagerIndex").text("");
            s.enableButtonAll();
            n == 0 && s.disableButton(0).disableButton(1);
            l - n <= 1 && s.disableButton(2).disableButton(3);
    ...
    a.assignDetailInfo = function(b, d) {
        ...
        h && (e += '<li><span class="icoFontTwitter"></span><span class="icoTextHide">twitter</span><a href="http://twitter.com/' + h + '" target="_blank">' + h + "</a></li>");
        g && (e += '<li><span class="icoFontSkype"></span><span class="icoTextHide">skype</span><a href="skype:' + i + '?call">' + i + "</a></li>");
    ...
    a.getContactPanel = function(b, d) {
        var e = $.extend({
            ...
            f = "",
            h = CW.getChatWorkIdLink(b);
        h && (f = '<dd id="profileTipChatWorkId">' + L.profile_chatworkidtip + "<span>" + h + "</span></dd>");
        h = "";
        AC.getRoomId(b) && e.showLive && (MOBILE === "ipad" ? h = '<div class="btnGroup"><div class="button btnDisable"><span class="icoFontVideoChat icoSizeLarge"></span><span class="icoTextHide">' + L.live_join + "</span></div></div>" : b != AC.myid && (h = '<div class="btnGroup"><div class="_joinLive button" data-aid="' + b + '"><span class="icoFontVideoChat icoSizeLarge"></span><span class="icoTextHide">' + L.live_join + "</span></div></div>"));
        if (e.showButton) {
            e.showLive = !1;
            var g = a.getContactButton(b, e)
        } else g = ""; if (e.profileLink && !AC.isUndisclosed(b)) {
            g += '<div class="_profileTipButton _openProfile _moveButton button" data-aid="' + b + '">' + L.menu_profile_setting + "</div>";
        ...
        var n = "",
            o = "";
        e.showButton && g && (e.footerButton ? o = '<div class="tooltipFooter"><div class="btnGroup"><div class="_profileTipButton">' +
            g + "</div></div></div>" : n = '<div class="btnGroup">' + g + "</div>");
        g = "";
        e.showCheckBox && (g = $.cwCheckBox.create(e.isChecked, "", b, {
        ...
        return '<div class="_contactPanel" data-aid="' + b + '"><div class="profileImgToolTip">' + l + '<div class="profileTooltipAvater">' + CW.getAvatarPanel(b, {
                ...
                clicktip: !1,
                size: "large"
            }) + '</div></div><div class="speakerProfileTooltipContent clearfix">' + g + "<dl><dt>" + i + '</dt><dd id="_profileTipOrgName">' + CW.getOrgName(b) + "</dd>" + f + h + n + "</dl></div>" + e + o
    };
...
function SettingView(b) {
    ...
    a.prepareSetting = function() {
        ...
        var f = function() {
            ...
            g = a.selectbox_dat;
            for (i in g) l = g[i], n = $("#" + i), h[l] = n.cwSelectBox().getVal();
            typeof h.notify_term !== "undefined" && (h.ai_notify_term = h.notify_term);
        ...
        d = b.cwDialog({
            ...
            open: function() {
                ...
                for (f in b) {
                    var h = b[f],
                        g = $("#" + f);
                    a.model.data[h] == 1 ? g.cwCheckBox().check() : g.cwCheckBox().unCheck()
                }
                b = a.selectbox_dat;
                for (f in b) h = b[f], g = $("#" + f).cwSelectBox({
                    parentFloatBox: d
                }), h !== null && typeof a.model.data[h] !== "undefined" && (h = a.model.data[h],
                g.findItemByValue(h) && g.select(h));
        ...
        $("#_langType").cwSelectBox().setOption({
            update: function() {
                ...
                var e = a.supported_dateformat,
                    ...
                    f = [];
                d = 0;
                for (var h = e.length; d < h; d++) f.push({
...
function FileView(b) {
        ...
        d = $("#_chatFileListTip").cwListTip({
            ...
            list: function() {
                ...
                if (d > 0) {
                    ...
                    for (var e = 0; e < d; e++) {
                        var f = a[e],
                            h = FL.file_id2file_dat[f];
                        h != void 0 && h.st != "deleted" && b.push({
                            keys: [h.fn],
                            value: f,
                            label: FL.view.getFilePanel(h, {
                                type: "filelist"
                            })
                        })
                    }
            ...
            open: function(a) {
                ...
                d.load(function() {
                    ...
                    var a = d.width(),
                        ...
                        f = a,
                        h = !1;
                    a > 1200 && (e *= 1200 / f, f = 1200, h = !0);
                    e > 600 && (f *= 600 / e, e = 600, h = !0);
                    a = {
                        visibility: "visible"
                    };
                    if (h) a.width = round(f), a.height = round(e);
                    d.css(a);
                    d.click(function() {
                        window.open(b)
                    });
    ...
    a.buildByFileId = function(b) {
        ...
        for (f in file_id_list) {
            var h = FL.file_id2file_dat[file_id_list[f]];
            RM && RM.id == h.rid && (b = !0);
            h.aid == AC.myid && (e = !0)
        }
        b && RM.filelist.build();
    ...
    a.buildFileWindow = function(b) {
        if (m && m.isOpen()) {
            ...
            var b = a.model.getMyFileList(),
                d = [];
            if (l)
                for (var e = l.toLowerCase(), f = 0, h = b.length; f < h; f++) {
                    var g = b[f],
            ...
            g || (b = "", b = l ? L.file_search_not_found : L.file_nothing, g = '<li class="emptyAdminContent"><img src="./imagenew/common/empty/img_file_empty.png" alt="" /><p>' + b + "</p></li>");
            $C("#_fileWindowList").html(g);
            d || $C("#_fileDetailClose").click();
            e == 0 ? ($C("#_emptyFileContent").show(),
                $C("#_fileWindowPagerIndex").text("")) : ($C("#_emptyFileContent").hide(), $C("#_fileWindowPagerIndex").text((s + 1).toString() + " / " + o));
            w.enableButtonAll();
            s == 0 && w.disableButton(0).disableButton(1);
            o - s <= 1 && w.disableButton(2).disableButton(3);
            a.buildStorageInfo()
        }
    };
    ...
    a.prepareFileWindow = function() {
        ...
        $("#_fileWindowList").on("click", "li", function() {
            ...
            (d = count(r)) ? (d == b ? a.check() : a.partialCheck(), e.enable()) : (a.unCheck(), e.disable())
        });
        ...
        w = $("#_fileWindowPager").cwButtonBar({
            update: function(b) {
                switch (f[b]) {
                    case "first":
                        s =
    ...
    a.updateStorageInfo = function(b, d, f, h) {
        ...
        if (g >= 100) {
            ...
            else var l = L.storage_limit_notice_footer,
                l = l.replace(/%%date%%/, CW.getDate(f, ST.data.dateformat)), i = {
                    ...
                    linkClick: function(a) {
                        CW.view.showStorageCautionDialog({
                            title: a.subject,
                            body: a.body,
                            footer: '<span class="textDanger">' + l + "</span>"
                        })
                    }
                };
        ...
        if (d != void 0) A.storage = b, A.storage_limit = d, A.limit_time =
            f, A.is_limit = h, m && m.isOpen() && a.buildStorageInfo()
    };
    a.buildStorageInfo = function() {
        ...
        a.chat != void 0 && (f = Math.round(a.chat /
            b * 100), d += f, h = bytename(a.chat));
        $("#_storageUsageMessageSize").text(h);
        var h = 0,
            g = "";
        a.other != void 0 && (h = Math.round(a.other / b * 100), d += h, g = bytename(a.other));
        $("#_storageUsageOtherSize").text(g);
        d > 100 && (f = Math.round(f / d * 100), e = Math.round(e / d * 100), h = Math.round(h / d * 100), d = f + e + h);
        g = parseInt(a.file, 10) + parseInt(a.chat, 10) + parseInt(a.other, 10);
        g = Math.floor(g / parseInt(b, 10) * 100);
        if (g >= 100 && d != 100 && g > d) switch (d = [f, e, h], ["chat", "file", "other"][d.indexOf(Math.max.apply(null, d))]) {
            case "chat":
                f++;
                break;
            case "file":
        ...
        $("#_storageUsageOther").css("width", h + "%");
        e = "";
...
function InviteMailAccountView() {
    ...
    b.buildFinishedView = function(a) {
        ...
        d.length > 0 ? ($C("#_contentInviteMailFinished .alertSuccess").show(), $C("#_contentInviteMailFinished .alertDanger").hide(),
            $C("#_contactInviteMailSentEmails").show()) : ($C("#_contentInviteMailFinished .alertSuccess").hide(), $C("#_contentInviteMailFinished .alertDanger").show(), $C("#_contactInviteMailSentEmails").hide());
        ...
        $C("#_contactInviteMailAlreadyRequested .contactInviteMailResultList").html(d.map(function(a) {
            var b =
                $("<a>").addClass("_contactMyRequestLink").attr({
                    href: "#"
                }).text(a.name);
        ...
        $C("#_contactInviteMailRequestAlreadyReceived .contactInviteMailResultList").html(d.map(function(a) {
            var b =
                $("<a>").addClass("_contactRequestLink").attr({
                    href: "#"
                }).text(a.name);
            return $("<li>").text(a.email_address).append([" [", b, "]"])
        }));
    ...
    b.visibleInputMailFromCancelIcon = function() {
        ...
        a.length > 1 ? $(".contactInviteMailList .fromCancelIcon").show() :
            a.find("[name=email]").val() !== "" ? $(".contactInviteMailList .fromCancelIcon").show() : $(".contactInviteMailList .fromCancelIcon").hide()
    };
...
function TaskView(b) {
    ...
    a.buildByTaskId = function(b, d) {
        ...
        if (d) {
            for (var j in h) RL.rooms[j].refreshTaskNum();
            RL.build()
        }
        e && RM.tasklist.build();
        f && a.buildTaskWindow()
    ...
    a.buildTaskWindow = function(b) {
        if (d && d.isOpen()) {
            ...
            var m = a.model.getMyTaskList(b, e);
            if (b == "open") {
                $C("#_taskWindowFilter").show();
                for (var k = [], w = time(), r = strtotime(CW.getDate(w, "Y-m-d 00:00:00")), A = r + 86400, x = r + 604800, p =
                    m.length, q = 0, v = 0, t = 0, B = 0, b = p; b--;) {
                    var E = m[b],
                        e = TK.task_id2task_dat[m[b]];
                    e.lt != 0 && e.lt <= w && (q++, a.alltask_filter == "limitover" && k.push(E));
                    r < e.lt && A > e.lt && (v++, a.alltask_filter == "today" && k.push(E));
                    r < e.lt && x > e.lt && (t++, a.alltask_filter == "inweek" && k.push(E));
                    e.lt == 0 && (B++, a.alltask_filter == "nolimit" && k.push(E));
                    a.alltask_filter == "all" && k.push(E)
                }
                RL.mytask_total > 0 ? $C("#_taskWindowNumAll").text(p).show() : $C("#_taskWindowNumAll").hide();
                q > 0 ? $C("#_taskWindowNumLimitOver").text(q).show() : $C("#_taskWindowNumLimitOver").hide();
                v > 0 ? $C("#_taskWindowNumLimitToday").text(v).show() : $C("#_taskWindowNumLimitToday").hide();
                t > 0 ? $C("#_taskWindowNumLimitWeek").text(t).show() : $C("#_taskWindowNumLimitWeek").hide();
                B > 0 ? $C("#_taskWindowNumLimitNone").text(B).show() : $C("#_taskWindowNumLimitNone").hide()
            } else $C("#_taskWindowFilter").hide(), k = m;
            TK.sortTaskList(k);
            m = [];
            e = k.length;
            f = parseInt(e / i, 10);
            ...
            A =
                m.length;
            for (b = 0; b < A; b++) e = TK.task_id2task_dat[m[b]], (x = RL.rooms[e.rid]) || (x = {
                getIcon: function() {
                    return ""
                },
                getName: function() {
            ...
            }), k == e.id && (w = !0), r += a.getTaskPanel(e, {
                type: "taskwindow"
            });
            $C("#_taskWindowList").html(r);
            w || $C("#_taskDetailClose").click();
            ...
            f - g <= 1 && j.disableButton(2).disableButton(3);
            d.resize()
        }
    };
                ...
                if (!d)
                    if (i.timeline)
                        if (i.timeline.chat_id2chat_dat[e]) {
                            for (var k = 0, f = i.timeline.chat_list.length; k < f; k++) {
                                var q = i.timeline.chat_list[k];
                                if (q.id == e) break
                            }
                            30 > k && i.timeline.has_old && (m = j = !0)
                        } else j = !0;
                    else j = !0;
                if (j) d ? g = "<div>" + L.jump_to_addpoint_not_found + "</div>" : (g = '<div class="timeLineLoading"><img src="./imagenew/all/common/loader/img_loader_white.gif" />' +
                    L.chat_loading + "</div>", m ? i.timeline.loadOld(function() {
                    ...
                    k = j = 0;
                    for (f = i.timeline.chat_list.length; k < f; k++)
                        if (q = i.timeline.chat_list[k], q.id == e) {
                            j = k;
                            break
                        }
                    if (j) {
                        ...
                        j > 30 && (k = j - 30);
                        h = j + 30;
                        for (g = []; k <= h && k < f; k++) g.push(i.timeline.chat_list[k]);
...
function RoomListView(b) {
    ...
    a.prepareCategory = function() {
        ...
        var i = $("#_newcatRoomfilter").cwSearchBox({
                ...
                update: function() {
                    ...
                    e = [];
                    for (var l = 0, o = a.length; l < o; l++) {
                        var s = RL.rooms[a[l]],
                            v = s.getName();
                        if (!(b && v.toLowerCase().indexOf(b) === -1)) {
                            e.push(s.id);
                            if (e.length >= n) break;
                            v = $.cwCheckBox.create( !! d[s.id], "", s.id, {
                                id: "_newcatCheck" + s.id,
                                "class": "_newcatCheck"
                            });
                            i += '<tr class="_newcatRoom _cwSelectableRow"><td class="check">' + v + '</td><td class="_newcatRoom_name"><span class="ui_room_icon">' + s.getIcon() + "</span></td><td>" + CW.getRoomName(s.id) + "</td></tr>"
                        }
                    }
                    i[g++] = "";
                    f.html(i)
        ...
        $("#_chatCategoryList").on("click", "._categoryEdit", function() {
            ...
            o.open(b);
            $("#_categoryName").val(d);
            s(a.model.category_dat[b].list, !0)
    ...
    a.build = function(b) {
        ...
        } else $C("#_roomListItems").quickEmpty(), $C("#_chatListEmptyArea ._chatListEmpty").hide(),
            a.model.filter_readonly ? $C("#_chatListUnreadEmpty").show() : a.model.filter_toonly ? $C("#_chatListToEmpty").show() : a.model.filter_taskonly && $C("#_chatListTaskEmpty").show(), $C("#_chatListEmptyArea").show()
    };
    var i = {
        showOrg: !1,
        showPin: !0,
    ...
    a.getRoomItemPanel = function(b, d) {
        ...
        var s = "",
            ...
            w = "";
        f.showSelected &&
        RM && RM.id == b && (g += " _roomSelected menuListTitleSelected");
        n > 0 && (g += " roomUnread", s = '<li role="listitem" class="_unreadBadge unread"><span class="icoFontActionUnread"></span>' + n + "</li>", o && (u = '<li class="_mentionLabel _unreadBadge mention"><span class="icoFontSideTo"></span>' + o + "</li>", g += " roomMentionUnread"));
        e.mytask_num > 0 && (w = '<li><span class="icoFontActionTask"></span>' + Math.min(e.mytask_num, TASK_MAX_RESULTS) + "</li>");
        n = "";
        f.showPin && (n = e.sticky ? '<div class="chatListPin"><span class="_pin _pinRid' +
        e.id + ' ico19PinOn"></span></div>' : '<div class="chatListPin chatListPinOff"><span class="_pin _pinRid' + e.id + ' ico19PinOff"></span></div>');
        o = "";
        f.showRequest && e["public"] && e.member_request.length > 0 && (o = '<div class="alert alertWarning alertSmall"><span class="icoFontInfo marginRight"></span>' + L.chatroom_member_requests_notice.replace(/%%request_num%%/, e.member_request.length) + "</div>");
        var r = "";
        if (f.showOrg && e.type == "contact") {
            var A = e.getAccountId();
            (A = CW.getOrgTitle(A)) && (r = '<p class="chatListOrgName">' +
                A + "</p>")
        }
        var x = A = "";
        s || u || w ? (f.noTrim || (A = " autotrim"), x = '<ul class="incomplete">' + s + u + w + "</ul>") : f.noTrim || (A = " chatListTitleNoLabel");
        f = "";
        CW.is_business && ST.data.show_external && (e.isInternal() || (f = '<div class="_externalMark roomOthers ico19Others"></div>'));
        return '<li role="listitem" aria-label="' + escape_html(e.getName()) + '" class="_roomLink ' + g + '" data-rid="' + e.id + '"><div class="roomIcon">' + e.getIcon("html", "medium") + '</div><div class="chatListMeta"><p class="chatListTitleArea' + A + '">' + CW.getRoomName(e.id) +
            "</p>" + r + x + "</div>" + f + n + o + "</li>"
    };
    ...
    a.updateTitle = function(b) {
        if (MOBILE == "") {
            ...
            document.title = d;
            ST.data.faviconstat ? (b = "", b = a.model.unread_room_sum == 0 ? "./image/favicon/favicon00.ico" : a.model.unread_room_sum < 10 ? "./image/favicon/favicon0" + a.model.unread_room_sum.toString() + ".ico" : "./image/favicon/favicon09+.ico",
                CW.view.changeFavicon(b)) : CW.view.changeFavicon("./image/favicon/favicon00.ico")
        }
    };
    a.updateSumNumbers = function() {
        ...
        if (a.last_sumnum_key != b) a.last_sumnum_key = b, a.model.mytask_total > 0 ? $C("#_myAllTaskNum").text(a.model.mytask_total).show() : $C("#_myAllTaskNum").hide(), a.model.unread_room_sum > 0 ? (b = a.model.unread_room_sum, b > 1E3 && (b = "999+"), e.html(b).show(), a.model.mention_room_sum > 0 ? (b = a.model.mention_room_sum,
        b > 1E3 && (b = "999+"), d.text(b).show()) : d.fadeOut()) : (e.fadeOut(), d.fadeOut()), a.model.mytask_room_sum > 0 ? f.text(a.model.mytask_room_sum).show() : f.fadeOut(), RM && a.updateTitle(RM.id)
    };
    a.buildCategory = function() {
        ...
        for (e in d) {
            var f = d[e];
            b += (f == a.model.filter_category ? '<li class="_chatCategoryItem listSelected" data-cat-id="' + f + '">' : '<li class="_chatCategoryItem" data-cat-id="' + f + '">') + '<span class="_categoryName categoryName autotrim">' + escape_html(a.model.category_dat[f].name) +
                '</span><div class="_categoryAction chatCategoryAction linkIconStatus"><span class="icoFontActionEdit _categoryEdit"></span><span class="icoTextHide">' + L.button_edit + '</span><span class="icoFontActionDelete _categoryDelete"></span><span class="icoTextHide">' + L.button_delete + "</span></li>"
        }
    ...
    a.showJoinPublicChatDialog =
        function(a) {
            ...
            a.header ? ($("#_joinpublicchatHeader").remove(), $("#_joinpublicchatDialog").find("._overflow").prepend('<div id="_joinpublicchatHeader" class="joinpublicCover"></div>'),
                $("#_joinpublicchatHeader").html('<img id="_joinpublicchatHeaderImage" src="' + S3_PATH + "/header/" + a.header + '" />'), $("#_joinpublicchatHeaderImage").bind("load", function() {
                d()
...
(function() {
    ...
    RoomView.prototype = {
        ...
        getViewStat: function() {
            var a = {}, b = $C("#_chatSendArea").position().top;
            a.last_read_id = 0;
            a.noview_num = 0;
...
(function() {
    ...
    TimeLineView.prototype = {
        ...
        build: function(d) {
            ...
            if (a == k.room.id)
                if (g.everScroll) {
                    var s = $C("#_timeLine").offset().top;
                    if (!m)
                        for (o = 0; o < n; o++) {
                            var l = k.chat_list[o],
                                u = $("#_messageId" + l.id);
                            if (u.length > 0 && s < u.offset().top) {
            ...
            else l = m !== null ? m - 100 : n - 200;
            l < 0 && (l = 0);
            m = 0;
            for (o = l; o < n; o++)
                if (k.chat_list[o] && (h.push(k.chat_list[o]), m++), m >= 200) break;
            this.start_index = l;
            h.length > 100 &&
            h[h.length - 1].id != k.chat_list[n - 1].id ? (d == "End" && (d = !1), this.has_new = !0) : this.has_new = !1;
            n = k.sending_chat_list;
            if (n.length)
                for (o = 0; o < n.length; o++)(l = n[o]) && h.push(l);
            ...
            var w = 0;
            g.smoothScroll && (w = g.sendingId ? 70 : 200);
            h = !1;
            o = i;
            if (CW.last_timeline_buildkey != o) {
                ...
                if ((this.model.room.rswitch || d) && d) {
                    ...
                    A.length && (g.highlight && (b = d), h = !0, function() {
                        ...
                        d.one("scroll", b).scrollTo(A, w, function() {
                            g.highlight && r.highlight(A);
                            g.jumpToCallback()
                        });
                        setTimeout(function() {
            ...
            } else d && (r = this, A = $("#_messageId" + d), A.length && (h = !0, $C("#_timeLine").scrollTo(A, w, function() {
                g.highlight && r.highlight(A);
                g.jumpToCallback()
            })));
        ...
        getTimeLine: function(a, f) {
            for (var g = $.extend({
                ...
                if (ST.data.show_delmessage == 0 && l.msg == "[deleted]") i += '<div id="_messageId' + l.id + '"></div>';
                    ...
                    var n = CW.getDate(l.tm, ST.data.dateformat);
                    if (j != n) j = n, e = 0, m.topView = !0, i += '<div class="dateHead"><div class="dateContent"><span class="icoFontClock"></span><span class="dateText">' + n + "</span></div></div>";
                    e == l.aid ? m.showSender = !1 : e = l.aid;
                    if (g.unreadFrom !== !1 && k >= g.unreadFrom) m.showUnreadMark = !0;
                    if (g.readLock) m.readLock = !0;
                    if (g.editId && g.editId == l.id) m.editView = !0;
                    if (!g.selectId) g.selectId = b;
                    if (g.selectId &&
                        g.selectId == l.id) m.selectView = !0;
        ...
        getMessagePanel: function(a, b) {
            ...
            var n = "";
            i.showUnreadMark && (n = a.sid ? '<span class="_sendingMessage"><img src="./imagenew/all/common/loader/img_loader_white.gif" ald="Loading"/></span>' : i.readLock ? '<span class="_unreadMark unreadTimeLine unreadTimeLineLock"></span>' : '<span class="_unreadMark unreadTimeLine"></span>');
            var o = "",
                s = L.chat_edited_log;
            a.aid == AC.myid && (m += " chatTimeLineMessageMine");
            var u = 0;
            a.msg == "[deleted]" ? (u = 1, o = '<div class="_delete messegeDelete">' + L.chat_deleted + "</div>") : a.msg == "[deleted_by_admin]" ? (u = 1, o = '<div class="_delete messegeDelete">' + L.chat_deleted_by_admin + "</div>") : o = CW.renderMessage(a.msg, {
                mid: a.id
            });
            u && (l += ' data-deleted="1"');
            var w = i.showSender ? CW.getDate(a.tm, ST.data.dateformat_short + " H:i") : CW.getDate(a.tm, "H:i");
            a.utm > 0 && (w += ' <span class="icoFontActionEdit icoSizeSmall"></span>');
            a.mn && (m += " chatTimeLineMessageMention");
            s = "";
            i.editView && (m += " chatTimeLineMessageEdit", s = '<div class="chatTimeLineMessageEditText">' + L.chat_editing_label_on_message + '<span class="_editCancel closeAction icoFontCancel massageEditCancel"></span></div>');
            var r = "";
            i.selectView && (m += " _messageSelected chatTimeLineMessageMove", r = '<span class="icoFontMessegeMoveArrow icoSizeLarge"></span><span class="icoTextHide">\u79fb\u52d5\u3057\u305f\u30c1\u30e3\u30c3\u30c8</span>');
            e = a.rid ? a.rid : e.room.id;
            u = ' data-deleted="' +
                u + '" data-tm="' + a.tm + '"';
            a.utm && (u += ' data-utm="' + a.utm + '"');
            return '<div id="' + i.idPrefix + "_messageId" + a.id + '" data-rid="' + e + '" data-mid="' + a.id + '" class="' + m + '"' + l + '><div class="_chatTimeLineMessageBox chatTimeLineMessageInner">' + j + '<div class="chatTimeLineMessageArea clearfix"><div class="chatTimeLineItemHeader autotrim"><p class="_speakerName chatName">' + k + "</p>" + h + "</div><pre>" + o + '</pre></div><div class="_timeStamp timeStamp"' + u + ">" + n + w + "</div>" + s + '</div><div class="_moveArrow chatTimeLineMoveArrow selected">' +
                r + "</div></div>"
        },
...
function RoomDialogView(b) {
    ...
    a.prepareInvitationLinkSetting = function() {
            ...
            open: function(d) {
                if (d) {
                    ...
                    var h = e + f,
                        ...
                        l = g.find(".js_invitationLinkDisplayInput"),
        ...
        $("#_invitationLinkActive").on("click",
            ".js_invitationLinkOpenEditor", function() {
                d.open();
                e.open()
    ...
    a.buildMember = function(b, d) {
        ...
        var f = AC.getGroupId(AC.myid),
            ...
            m = d.find("._searchBox").cwSearchBox().getVal();
        m && (l = CW.splitWithSpace(m), l = l.map(function(a) {
            return a.toLowerCase()
        }));
        for (m = 0; m < b.length; m++) {
            var k = b[m],
                t = [];
            if (Object.keys) t = Object.keys(j[k]);
            else
                for (var B in j[k]) t.push(B);
            Room.prototype.sortMember(t);
            var E = d.find("._memberTable" + ucfirst(k));
            E.quickEmpty();
            var z = "",
                F =
                    t.length;
            200 < F && $("#_roomInfoShowLimitNum" + ucfirst(k)).text(L.chatroom_show_limit_member_num.replace("%%num%%", 200));
            for (var y = 0; y < F; y++) {
                var D = t[y];
                if (k == "member") {
                    if (!(l.length > 0) || AC.isMatchedWithKeyList(l, D)) {
                        g++;
                        if (g > 200) break;
                ...
                } else if (!(e && AC.getGroupId(D) !== f) && (!(l.length > 0) || AC.isMatchedWithKeyList(l,
                        D))) {
                    i++;
                    if (i > 200) break;
        ...
        l || (l = $("#_roomMemberAdditionDialog").cwDialog({
            ...
            buttonClick: function(b) {
                ...
                switch (b) {
                    case 0:
                        ...
                        var h = RL.rooms[d];
                        Object.keys(h.member_dat).map(function(b) {
                            b in a.member_flag || (a.member_flag[b] = h.member_dat[b])
                        });
            ...
            open: function(b) {
                if (b) {
                    ...
                    g.val(l);
                    f.val(j);
                    h.attr("data-clipboard-text", l).text(L.invitation_link_code_copy);
...
function RoomSubView(b) {
    ...
    a.prepareTask = function() {
        ...
        $("#_taskQuickWrapper").on("mouseenter", function() {
            !g.isOpen() && !d.isOpen() && g.open($C("#_taskAssignAddArea"))
        });
    ...
    a.toggleFold = function() {
        if (!g) {
            AL.trackEvent("message_input",
                "click", "toggle_fold_room_sub");
            var b = $("#_chatContent"),
                d = b.css("right"),
    ...
    a.resizeWidth = function(b) {
        ...
        if ($C("#_timeLine").width() < TM.timeline_min_width &&
            d < b) return !1;
    ...
    a.prepareGroupCall = function() {
        ...
        $C("#_groupCallMember").on("cwCheckBox_update", function(a, b, d) {
            b ? i.data.select_flag[d] = b : i.data.select_flag[d] && delete i.data.select_flag[d]
        });
        $("#_videoChatContactFilter").cwSearchBox({
            update: function() {
                var a =
                        i.data.select_flag,
                    b = [],
                    d = RL.rooms[i.data.room_id],
                    e = this.getVal(),
                    f = "",
                    g;
                for (g in d.member_dat)
                    if (g != AC.myid) {
                        var j = AC.account_dat[g].nm.toLowerCase();
                        e && j.indexOf(e.toLowerCase()) === -1 || b.push(g)
                    }
                $C("#_groupCallMember").quickEmpty();
                if (b.length === 0) f = '<div class="groupcallNoMembers">' + L.live_member_not_found + "</div>";
                else {
                    d.sortMember(b);
                    for (d = 0; d < b.length; d++) g = b[d], f += '<div class="_groupCallMember _cwSelectableRow groupCallMember" data-aid="' + g + '"><div class="groupCallAvatar">' + $.cwCheckBox.create( !! a[g],
                            "", g, {
                                "data-theme": "green"
                            }) + CW.getAvatarPanel(g, {
                            size: "medium",
    ...
    a.buildMember = function(a) {
        var b = RL.rooms[a];
        if (!b) return this;
        for (var d = b.getSortedMemberList(), e = d.length, f = TM.member_preview_show_max, g = "", i = TM.member_detail_show_max, k = {
            admin: "",
            member: "",
            readonly: "",
            nocontact: "",
            ...
            var p = d[x],
                q = b.member_dat[p];
            r[q] < i && (k[q] += CW.getAvatarPanel(p, {
                size: "small"
            }));
            x < f && (g += '<li class="chatRoomMemberListItem" role="listitem" aria-label="' + escape_html(AC.getName(p)) + '">' + CW.getAvatarPanel(p) + "</li>");
            r[q]++;
            A == "group" && !AC.isContact(p) && (AC.myrequest_dat[p] ? (r.requested < i && (k.requested += CW.getAvatarPanel(p, {
                size: "small"
            })), r.requested++) : (r.nocontact < i && (k.nocontact += CW.getAvatarPanel(p, {
                size: "small"
            })), r.nocontact++))
        }
        ...
        for (x = a.length; d < x; d++)
            if (p = a[d], q = p.key, k[q]) {
                var v = "subContentMemberGroup";
                p.boxClass != void 0 && (v += " " + p.boxClass);
                b += '<div class="' + v + '">';
                p.label && (b += '<div class="subContentGroupInner"><div class="memberListLabel">' + p.label + "\uff1a</div><div>" + k[q]);
                r[q] > i && (b += '<a class="_showMoreMember showMoreMember" data-role="' + q + '">' + L.chatroom_member_rest_number.replace(/%%rest_number%%/, number_format(r[q] - i)) + "</a>");
                p.label && (b += "</div></div>");
                p.after && (b += p.after);
                b += "</div>"
            }
        A === "contact" ? ($C("#_subRoomMemberNum").hide(), $C("#_subRoomMemberList").hide(), j = "") : ($C("#_subRoomMemberNum").show().text(" (" + number_format(e) + ")"), $C("#_subRoomMemberList").html(g).show(), j = b);
    ...
    a.getTaskMemberList = function(a) {
        for (var a = RL.rooms[a].getSortedMemberList(),
                 b = a.length, d = [], e = 0; e < b; e++) {
            var f = a[e],
                g = AC.getName(f);
            d.push({
...
function ChatSendView(b) {
    ...
    a.prepareTimeLine = function() {
        var b = $("#_timeLine,#_messageSearchResult,#_taskDetailTimeLine,#_replyMessageTip"),
            ...
            h = {
                ...
                "delete": function(b) {
                    ...
                    if (match = RM.timeline.chat_id2chat_dat[b].msg.match(/^\[info\][\s\S]+\[download:([0-9]+)\][^\[]+\[\/download\]\[\/info\]$/)) {
                    ...
                    } else(match = RM.timeline.chat_id2chat_dat[b].msg.match(/^\[info\].+\[task aid=[0-9,]+ st=open lt=[0-9]+\][\s\S]+\[\/task\]\[\/info\]$/)) && (e = !0); if (d) {
                        ...
                        var g = [];
                        for (f in TK.task_id2task_dat) e = TK.task_id2task_dat[f], e.st != "deleted" && e.cid && e.cid == b && g.push(f);
                        var i = g.length;
                        if (i > 0) {
                            for (var j = "", k = 0; k < i; k++) f = g[k], e = TK.task_id2task_dat[f], j += TK.view.getTaskPanel(e, {
                                type: "preview"
                            });
                    ...
                    } else CW.view.confirmDelete(L.chatsend_confirm_delete,
                        function() {
                            a.model.deleteChat(b)
                        })
                },
                ...
                quote: function(b) {
                    this.$el.parents("#_messageSearchResultBox").length ?
                        AL.trackEvent("message_search", "click", "quote_in_message_search") : AL.trackEvent("message_action", "click", "quote_action");
                    var e = RM.timeline.chat_id2chat_dat[b];
        ...
        for (var g = ["reply", "quote", "task", "edit", "link", "copy", "unread", "delete"], j = 0, k = g.length; j < k; j++) {
            var l =
                    g[j],
                m = ucfirst(l);
            o.addAction(l, {
        ...
        for (var n = f.cwActionBar({
            ...
            descriptionDelay: TM.messagetip_delay
        }), g = ["quote", "task", "move", "link"], j = 0, k = g.length; j < k; j++)(function() {
            var a = g[j],
                b = ucfirst(a);
            n.addAction(a, {
        ...
        b.on("mouseover", "._timeStamp", function() {
            ...
            if (e && (d = parseInt(d.attr("data-mid"), 10), d = RM.timeline.chat_id2chat_dat[d], d != void 0)) {
                r = "[" + L.chatsend_quote + " aid=" + d.aid + " time=" + d.tm + "]" + e + "[/" + L.chatsend_quote + "]\n";
                var f = $C("#_quoteTip").cwToolTip();
                f.isOpen() ? ($.cwFloatBox.skip(),
                    setTimeout(function() {
        ...
        e.scroll(function() {
            RM.timeline &&
            (e.scrollTop() < 10 && (RM.timeline.has_old ? RM.timeline.loadOld() : RM.timeline.build({
                everScroll: !0
        ...
        var M = 0,
            ...
            s = function(a, b) {
                ...
                var d = a.attr("data-mid"),
                    e = a.attr("data-rid"),
                    f = null;
                if (e = RL.rooms[e]) e.prepareBuild(),
                    f = e.timeline.chat_id2chat_dat[d];
                $C("#_replyMessageButtonArea").hide();
                f ? (M = e.id, q = f.id, d = e.timeline.view.getMessagePanel(f, {
                    idPrefix: "replyTip"
                }), $C("#_replyMessageTipContent").html(d), d = '<div class="tooltipFooter"><div class="_replyMoveButton _roomLink button" data-rid="' + M + '" data-mid="' + q + '">' + L.jump_to_message + "</div></div>", $C("#_replyMessageButtonArea").html(d).show()) : e ? b ? $C("#_replyMessageTipContent").html(L.chat_error_not_found) : (e.load({
                    jumpTo: d,
                    autoBuild: !1
                }, function() {
                    s(a, !0);
        ...
        u.$el.on("click", "._messageLink", function() {
            u.close();
            var a = $(this),
                b = u.tipFrom,
                d = b.attr("data-rid"),
        ...
        $("#_quotePartlyToTask").click(function() {
            ...
            $C("#_quoteTip").cwToolTip().close();
            RS.view.setTask(r, null, null, !0, !0)
        })
    };
    a.prepareSendArea = function() {
        ...
        (function() {
            ...
            d.on("paste", function(d) {
                if (!h || !h.createObjectURL) a();
                else if (d = d.originalEvent.clipboardData) {
                    var e = f(d);
                    if (e) {
                        var d = e.getAsFile(),
                            e = e.type.split("/").pop(),
                            g = h.createObjectURL(d);
                        $("#_imageDropZone").html('<img src="' + g + '">');
                        g = "screenshot_" + CW.getDate(time(), "Y_m_d");
                        $("#_imageDropFileNameInput").val(g);
                        d.name = g + "." + e;
    ...
    a.prepareEmoticon = function() {
        ...
        $C("#_emoticonList").on("mouseenter", "li", function() {
            ...
            CW.view.key.ctrl || CW.view.key.command ? (s.close(),
                a.sendMessage($(this).find("img").prop("alt"), !0)) : (d.focus(), a.setChatText($(this).find("img").prop("alt"), !0), CW.view.key.shift || s.close())
        })
    };
    a.prepareTo = function() {
        ...
        $("#_toListSelectAll").click(function() {
            for (var e = b.getList(), f = "", h = 0, g = e.length; h < g; h++) {
                var i = e[h].value;
    ...
    a.prepareSendFile = function() {
        ...
        if (_has_fileapi) {
            ...
            $C("#_dropZone").on("dragover", function() {
                if (d) return !1;
                $C("#_dropZone").css("background-color",
                    "#E9F4F5");
                return !1
                ...
                $("#_fileFrame").on("load", function() {
                    try {
                        ...
                        if (a.length > 0) {
                            var a = a.match(/\{.+\}/)[0],
                                d = $.parseJSON(a);
                            d.result.is_storage_limit != void 0 ? CW.showStorageLimitDialog("file") : !d.status.success && d.status.message ? CW.alert(d.status.message) : d.status.success == !0 && (FL.updateStorageInfo(d.result.storage, d.result.storage_limit,
                                d.result.limit_time, d.result.is_limit), CW.watch())
                        } else throw "error";
                    } catch (f) {
                        if (b)
                            if (e++, e > 1) a = L.upload_cancel_send_message.replace(/%%size%%/g, bytename(FL.storage.available)), d = "", CW.plan == "free" ? (a += L.storage_cancel_send_object_suffix_upgrade, d = L.storage_cancel_upgrade_label) : CW.is_business && !CW.is_admin ? (a += L.storage_cancel_send_object_suffix_tell_admin, $("#cw_upload_error_button").hide()) : (a += L.storage_cancel_send_object_suffix_add_storage, d = L.storage_cancel_add_storage_label), $("#cw_upload_error_body").html(a),
                                $("#cw_upload_error_link").val(d), $("#cw_upload_error_dialog").dialog("open");
                            else {
                                setTimeout(function() {
    ...
    var w = TM.timeline_min_height,
        r = TM.chattext_min_content_height,
    ...
    a.resizeChatArea = function(a) {
        ...
        k < r && (k = r);
        if (!a && v == k) d.height(e), h != 0 && j.scrollTop(h);
        else {
            var l = f.outerHeight(),
            ...
            a || b != n ? (d.height(n - m - l - p), a = i.outerHeight(), a = o - q - a, b = $C("#_timeLine"), e = b.height(), l = b.scrollTop(), b.height(a), b.scrollTop(l + (e - a))) : d.height(e);
            v < k ? j.scrollTop(h + 30) : j.scrollTop(h);
            v = k
        }
    };
            ...
            if (i.isOpen()) {
                ...
                if (a.ms_result_timeline_list.length > 0) {
                    ...
                    switch (a.ms_result_type) {
                        case "byroom":
                            ...
                            for (var n = 0, h = a.ms_result_byroom_idx_list.length; n < h; n++)
                                for (var o = a.ms_result_byroom_idx_list[n], s = 0, u = a.ms_result_byroom_dat[o].length; s < u; s++) l.push(a.ms_result_byroom_dat[o][s]);
                            break;
                        case "byuser":
                            f.enableButtonAll();
                            n = 0;
                            for (h = a.ms_result_byuser_idx_list.length; n <
                            h; n++) {
                                o = a.ms_result_byuser_idx_list[n];
                                s = 0;
                                for (u = a.ms_result_byuser_dat[o].length; s < u; s++) l.push(a.ms_result_byuser_dat[o][s])
                            }
                            break;
                        default:
                    ...
                    for (n = 0; n < h; n++) {
                        ...
                        switch (a.ms_result_type) {
                            case "byroom":
                                if (g != u.rid) g = u.rid, n > 0 && (e += "</div>"), e += '<div class="searchResultTitle _messageSearchChatGroup" data-gid="' + u.rid + '">' + RL.rooms[u.rid].getIcon() + " " + escape_html(RL.rooms[u.rid].getName()) + " <span>(" + number_format(a.ms_result_byroom_dat[u.rid].length) +
                                    L.search_result_unit + ')</span><span class="_messageSearchArrow transitionAll03sLinear icoFontTriangleDown"></span></div><div id="_searchResultGroupId' + u.rid + '" style="display:none">';
                                break;
                            case "byuser":
                                if (g != u.aid) g = u.aid, n > 0 && (e += "</div>"), e += '<div class="searchResultTitle _messageSearchChatGroup" data-gid="' + u.aid + '">' + CW.getAvatarPanel(u.aid, {
                                        clicktip: !1,
                                        hovertip: !1,
                                        size: "small"
                                    }) + " " + CW.getName(u.aid) + " <span>(" + number_format(a.ms_result_byuser_dat[u.aid].length) + L.search_result_unit + ')</span><span class="_messageSearchArrow transitionAll03sLinear icoFontTriangleDown"></span></div><div id="_searchResultGroupId' +
                                    u.aid + '" style="display:none">'
                        }
                        s.topView = n === 0 ? !0 : !1;
                        e += TimeLineView.prototype.getMessagePanel(u, s)
                    }
                    switch (a.ms_result_type) {
                        case "byroom":
                            h > 0 && (e += "</div>");
                    ...
                    b = b.replace(/\u3000|,|\u3001|\u30fb/g, " ").split(" ");
                    for (n in b) e = b[n], e.charAt(0) == "+" && (e = e.substr(1)),
        ...
        function(b) {
            if (b == void 0 || b == "") $C("#_searchResultChatList").quickEmpty(), $C("#_messageSearchHint").text(""), $C("#_messageSearchIcon").hide();
                ...
                var d = RL.getSortedRoomList(),
                    ...
                    g = d.length;
                if (g) {
                    for (var i = [], i = CW.splitWithSpace(b.toLowerCase()), o = 0, s = 0; s < g; s++)
                        if (d[s] != void 0) {
                            var u = d[s],
                                f = RL.rooms[u];
...
function TutorialView(b) {
    var a = this,
        ...
        m = $("#_tutorialHeader"),
        l = $("#_tutorialMessage"),
        n = $("#_tutorialNextButton"),
        o = $("#_openContactWindow"),
        s = $("#_tutorialStep").cwToolTip({
            useFloatBox: !1
        }),
        u = {
            "#_content": "",
    ...
    a.handleStart = function() {
        ...
        w();
        r();
        if (e) n.on("click", a.handleNextStep);
        else n.cwButton({
            type: "primary",
    ...
    a.handleFinish =
        function() {
            ...
            s.close();
            j.css("z-index", "auto");
            for (var b in u) $C(b).css("z-index", u[b]);
    ...
    a.play = function() {
        ...
        f.length === d + 1 && (e ? (n.find(".label").text("\u4f7f\u3044\u306f\u3058\u3081\u308b"),
            n.off("click"), n.on("click", a.handleFinish)) : n.cwButton().setOption({
            type: "success",
            ...
            if (d != null) {
                ...
                b.each(g.axis.split(""), function(a, b) {
                    var d = b == "x" ? "Left" : "Top",
                        ...
                        A = j[r],
                        x = e.max(j, b);
                    m ? (l[r] = m[f] + (n ? 0 : A - k.offset()[f]), g.margin && (l[r] -= parseInt(h.css("margin" + d), 10) || 0, l[r] -= parseInt(h.css("border" + d + "Width"), 10) || 0), l[r] += g.offset[f] || 0, g.over[f] && (l[r] += h[b == "x" ? "width" : "height"]() * g.over[f])) : (d = h[f], l[r] = d.slice && d.slice(-1) == "%" ? parseFloat(d) / 100 * x : d);
                    g.limit && /^\d+$/.test(l[r]) &&
                    (l[r] = l[r] <= 0 ? 0 : Math.min(l[r], x));
                    !a && g.queue && (A != l[r] && i(g.onAfterFirst), delete l[r])
                });
                i(g.onAfter)
            }
        }).end()
...
(function(b) {
    ...
    function f(f) {
        ...
        function H(a) {
            S++ || (T(), Q && a != x && (t[J] = a), d(U, f, [f, a]), d(M, f, [f, a]))
        }
        var f = b.extend({}, z, f),
            I = f.success,
            U = f.error,
        ...
        J = J.replace(/=\?(&|$)/, "=" + X + "$1");
        if (Q && (R = t[J])) R.s ? K(R.s[0]) : H(R);
        else {
            p[X] = e;
            G = b(r)[0];
            G.id = m + B++;
            Y && (G[i] = Y);
            F && F.version() < 11.6 ? (O = b(r)[0]).text = "document.getElementById('" + G.id +
                "')." + n + "()" : G[g] = g;
            if (y) G.htmlFor = G.id, G.event = l;
            G[o] = G[n] = G[s] = function(a) {
                if (!G[u] || !/i/.test(G[u])) {
                    try {
                        G[l] && G[l]()
                    } catch (b) {}
    ...
    var g = "async",
        ...
        p = window,
        q = b.Deferred,
        v = b("head")[0] || document.documentElement,
        t = {}, B = 0,
        E, z = {
            callback: m,
            url: location.href
...
window.Modernizr = function(b, a, e) {
    ...
    var g = {}, i = a.documentElement,
        ...
        w = {}.hasOwnProperty,
        r;
    r = typeof w !== "undefined" && typeof w.call !== "undefined" ? function(a, b) {
        return w.call(a, b)
    } : function(a, b) {
    ...
    for (var A in j) r(j, A) && (s = A.toLowerCase(), g[s] = j[A](), n.push((g[s] ? "" : "no-") + s));
    g.addTest = function(a, b) {
        if (typeof a == "object")
            for (var d in a) r(a, d) && g.addTest(d, a[d]);
        else {
            a = a.toLowerCase();
            if (g[a] !== e) return g;
    ...
    g.testStyles = function(b, d, e, f) {
        ...
        (k ? j : m).innerHTML += e;
        m.appendChild(j);
        if (!k) m.style.background = "", m.style.overflow = "hidden", g = i.style.overflow, i.style.overflow = "hidden", i.appendChild(m);
        b = d(j, b);
        k ? j.parentNode.removeChild(j) : (m.parentNode.removeChild(m), i.style.overflow = g);
        return !!b
    };
    g.prefixed = function(a, b, d) {
        return b ? f(a, b, d) : f(a, "pfx")
    };
    i.className = i.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + n.join(" "));
    return g
}(this, this.document);
(function(b, a, e) {
    function d(a) {
    ...
    function k(b, d, e, f, h, g, k) {
        function m(a) {
            if (!p && i(l.readyState) && (r.r = p = 1, !w && j(), l.onload = l.onreadystatechange = null, a))
        ...
        u.splice(f, 0, r);
        "img" != b && (q || 2 === B[d] ? (x.insertBefore(l, A ? null : o), n(m, k)) : B[d].push(l))
    }

    function h(a, b, d, e, h) {
        return w = 0, b = b || "j", f(a) ? k("c" == b ? q : p, a, b, this.i++, d, e, h) : (u.splice(this.i++, 0, a), 1 == u.length && j()), this
    }
    ...
    var l = a.documentElement,
        ...
        A = r && !! a.createRange().compareNode,
        x = A ? l : o.parentNode,
        l = b.opera && "[object Opera]" == s.call(b.opera),
        l = !! a.attachEvent && !l,
        p = r ? "object" : l ? "script" : "img",
        q = l ? "script" : p,
    ...
    F = function(a) {
        function b(a) {
            ...
            for (g = 0; g < f; g++) i = a[g].split("="), (h = E[i.shift()]) && (e = h(e, i));
            for (g = 0; g < d; g++) e = t[g](e);
            return e
        }
        ...
        function h(a, f, g, i, j) {
            ...
            k.bypass || (f && (f = d(f) ? f : f[a] || f[i] || f[a.split("/").pop().split("?")[0]]), k.instead ? k.instead(a, f, g, i, j) : (B[k.url] ? k.noexec = !0 : B[k.url] = 1, g.load(k.url, k.forceCSS || !k.forceJS && "css" == k.url.split(".").pop().split("?").shift() ? "c" : e, k.noexec, k.attrs, k.timeout), (d(f) || d(l)) && g.load(function() {
                m();
                f && f(k.origUrl, j, i);
                l && l(k.origUrl, j, i);
                B[k.url] = 2
        ...
        if (f(a)) h(a, 0, l, 0);
            ...
            for (j = 0; j < a.length; j++) k = a[j], f(k) ? h(k, 0, l, 0) : v(k) ? F(k) : Object(k) === k && i(k, l);
    ...
    b.yepnope.injectJs = function(b, d, e, f, h, k) {
        var l = a.createElement("script"),
            m, p, f = f || F.errorTimeout;
        l.src = b;
        for (p in e) l.setAttribute(p, e[p]);
        d = k ? j : d || g;
        l.onreadystatechange = l.onload = function() {
            !m && i(l.readyState) && (m = 1, d(), l.onload = l.onreadystatechange = null)
        };
        n(function() {
            m || (m = 1, d(1))
        }, f);
...
(function(b) {
                ...
                if (!k) {
                    ...
                    if (r.length) {
                        ...
                        for (n = r.length; l < n; l++)
                            if (r.hasOwnProperty(l) && r[l] && typeof r[l] === "string" && (o = v(r[l]))) {
                                if (o === "*") {
                                    s = [o];
                                    break
                                }
                                s.push.apply(s, [o, "//" + o, b.location.protocol + "//" + o])
                            }
                    }
                    s.length && q.push("trustedOrigins=" + encodeURIComponent(s.join(",")));
    ...
    z.prototype.setText = function(a) {
        if (a && a !== "") f["text/plain"] = a, d.ready === !0 && d.bridge && typeof d.bridge.setText === "function" ? d.bridge.setText(a) : d.ready = !1;
        return this
    };
    ...
    z.activate = function(a) {
        e && (u(e, y.hoverClass), u(e, y.activeClass));
        e = a;
        s(a, y.hoverClass);
        K();
    ...
    z.deactivate = function() {
        ...
        e && (u(e, y.hoverClass), u(e, y.activeClass), e = null)
    };
    var D = function(a) {
    ...
    z.prototype.on = function(a, b) {
        var e, f, h, g = {}, j = i[this.id] && i[this.id].handlers;
        ...
        if (h && h.length) {
            e = 0;
            for (f = h.length; e < f; e++) a = h[e].replace(/^on/, ""), g[a] = !0, j[a] || (j[a] = []), j[a].push(b);
            g.noflash && d.disabled && H.call(this, "noflash", {});
            g.wrongflash && d.outdated && H.call(this, "wrongflash", {
                flashVersion: d.version
            });
            g.load && d.ready && H.call(this, "load", {
                flashVersion: d.version
            })
        }
        return this
    ...
    z.prototype.off = function(a, b) {
        var d, e, f, h, g, j = i[this.id] && i[this.id].handlers;
        if (arguments.length === 0) h = B(j);
        ...
        if (h && h.length) {
            ...
            for (e = h.length; d < e; d++)
                if (a = h[d].toLowerCase().replace(/^on/, ""), (g = j[a]) && g.length)
                    if (b)
                        for (f = w(b, g); f !== -1;) g.splice(f, 1), f = w(b, g, f);
                    else j[a].length = 0
        }
        return this
    };
    ...
    z.prototype.clip = function(a) {
        for (var a = r(a), b = 0; b < a.length; b++)
            if (a.hasOwnProperty(b) && a[b] && a[b].nodeType === 1) {
                if (a[b].zcClippingId) w(this.id, k[a[b].zcClippingId]) === -1 && k[a[b].zcClippingId].push(this.id);
    ...
    z.prototype.unclip = function(a) {
        var b = i[this.id];
        if (b)
            for (var b = b.elements, d, a = typeof a === "undefined" ? b.slice(0) : r(a), e = a.length; e--;)
                if (a.hasOwnProperty(e) && a[e] && a[e].nodeType === 1) {
                    for (d = 0;
                         (d = w(a[e], b, d)) !== -1;) b.splice(d, 1);
                    var f = k[a[e].zcClippingId];
                    if (f) {
                        for (d = 0;
                             (d = w(this.id, f, d)) !== -1;) f.splice(d, 1);
        ...
        if (typeof a === "string" && a) {
            ...
            if (d) {
                ...
                if (e && y.autoActivate === !0) {
                    var h, g, j, l;
                    f = [];
                    if (e && e.nodeType === 1 && (h = e.zcClippingId) && k.hasOwnProperty(h))
                        if ((h = k[h]) && h.length) {
                            g = 0;
                            for (j = h.length; g < j; g++)(l = i[h[g]].instance) && l instanceof z && f.push(l)
                        }
                } else {
                    j = [];
                    l = B(i);
                    f = 0;
                    for (h = l.length; f < h; f++)(g = i[l[f]].instance) && g instanceof z && j.push(g);
                    f = j
                }
                h = 0;
                for (g = f.length; h < g; h++) H.call(f[h], d, b)
            }
        }
    };
    ...
    var H = function(h, g) {
        var h = h.toLowerCase().replace(/^on/, ""),
            j = g && g.flashVersion && a(g.flashVersion) || null,
            k = e,
            l = !0;
        switch (h) {
            case "load":
        ...
        m = [this, g];
        if ((j = i[this.id] && i[this.id].handlers[h]) && j.length) {
            var p, q, r = k || this;
            n = 0;
...
(function(b) {
    ...
    b.cwUI.addWidget = function(f, g, i, n) {
        b[f] = new k(f, g);
        if (n != void 0)
        ...
        close: function(d, e) {
            ...
            if (i > 0) {
                if (d) {
                    ...
                    for (i -= 1; i >= 0; i--) {
                        for (var l = !1, n = 0, o = m.length; n < o; n++)
                            if (m[n][0] == a[i].obj[0]) {
                                l = !0;
                                break
                            }
...
(function(b) {
    ...
    b.cwResize = {
        setHandle: function(g, i) {
            ...
            g.addClass(k).on("mousedown.cwResize", function(h) {
                a = !0;
    ...
    b.cwUI.addWidget("cwDatePicker", {
        ...
        _build: function() {
            ...
            for (var u = 1; u <= 6; u++) {
                o += "<tr>";
                for (var w = 0; w < 7; w++) {
                    u == 1 ? w < f ? (n = new Date(a, b - 1, w - f + 1), m = n.getFullYear(), l = n.getMonth() +
                        1, n = n.getDate()) : w == f ? (m = a, l = b, n = 1, s = !0) : n++ : n >= d ? (s = !1, l = new Date(a, b, 1), m = l.getFullYear(), l = l.getMonth() + 1, n = 1) : n++;
                    var r = "";
                    s ? m == this.now_year && l == this.now_month && n == this.now_day && (r = "datePickerToday") : r = "datePickerOtherMonth";
                    m == this.val_year && l == this.val_month && n == this.val_day && (r.length > 0 && (r += " "), r += "datePickerSelected");
                    o += '<td data-cwui-dp-date="' + m + "-" + l + "-" + n + '" class="' + r + '">' + n + "</td>"
                }
                o += "</tr>"
            }
    ...
    b.cwUI.addWidget("cwToolTip", {
        ...
        move: function(a) {
            ...
            var i = b(document.body),
                ...
                l = parseInt(m / 2, 10),
                n = "",
                n = this.option.direction == "vertical" ? h.top - m < 0 ? "bottom" : "top" : this.option.direction == "horizontal" ? h.left > parseInt(j / 2, 10) ? "left" : "right" : this.option.direction,
            ...
            if (this.option.noTriangle) var o = null,
                s = 0, u = 0;
            else o = d.find("._cwTTTriangle"), s = o.outerHeight(), u = o.outerWidth();
            var w = a.outerWidth(),
                r = parseInt(w / 2, 10),
                A = a.outerHeight(),
                x = parseInt(A / 2, 10);
            ...
            switch (n) {
                ...
                case "bottom":
                    switch (this.option.showPosition) {
                        case "left":
                            q = this.option.noTriangle ? h.left + g : h.left - parseInt(i / 2, 10) + g;
                            break;
                        case "right":
                            q = this.option.noTriangle ? h.left - i + w + g : h.left - parseInt(i / 2, 10) + w + g;
                            break;
                        default:
                            q = h.left - parseInt(i / 2, 10) + r + g
                    }
                    break;
                case "left":
                case "right":
            ...
            q + i > j && (q = j - this.option.windowMargin - i);
            if (q < this.option.windowMargin) q = this.option.windowMargin;
            p + m > k && (p = k - this.option.windowMargin - m);
            if (p < this.option.windowMargin) p = this.option.windowMargin;
            if (o) switch (j = parseInt(s / 2, 10), k = parseInt(u / 2, 10), n) {
                case "top":
                case "bottom":
                    switch (this.option.showPosition) {
                        case "left":
                        ...
                        case "right":
                            f = h.left - q + w - k + g;
                            g = i - u - this.option.triangleMargin;
                            f > g && (tip_p_left = g);
                            break;
                        default:
                            f = h.left - q + r - k + g
                ...
                case "right":
                    switch (this.option.showPosition) {
                        case "top":
                            ...
                            break;
                        case "bottom":
                            f = h.top - p + m - s - this.option.triangleMargin + f;
                            break;
                        default:
                            f = h.top - p + l - j + f
                    }
